...
- YashanDB JDBC驱动：用于JDBC方式连接数据库，建议1.6.1及以上版本，安装操作请查阅[安装YashanDB JDBC驱动](../../开发手册/JDBC驱动/安装JDBC驱动)。
...
jpype.addClassPath('./lib/yasdb-jdbc-{version_number}.jar') # 替换路径为真实的JDBC驱动路径
