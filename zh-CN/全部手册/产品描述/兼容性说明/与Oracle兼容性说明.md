...
YashanDB支持Oracle数据库中主流的SQL语法，其他少数因功能性缺失导致的不兼容将报语法不支持错误，此时应联系我们的技术支持提供变通方案，SQL语法详细说明请查阅[SQL语句](../../开发手册/SQL参考手册/SQL语句/00SQL语句)。
...
YashanDB目前实现了超过120个内置函数，具体清单及说明请查阅[内置函数](../../开发手册/SQL参考手册/内置函数/00内置函数)。
