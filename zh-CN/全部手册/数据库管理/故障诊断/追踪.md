...
- 会话级追踪：执行[ALTER SESSION](../../开发手册/SQL参考手册/SQL语句/ALTER SESSION)语句为当前会话可以开启追踪。
- 全局追踪：执行[ALTER SYSTEM](../../开发手册/SQL参考手册/SQL语句/ALTER SYSTEM)为全局开启追踪。追踪事件会对系统性能产生一定影响，非必要**不建议**开启全局追踪。
