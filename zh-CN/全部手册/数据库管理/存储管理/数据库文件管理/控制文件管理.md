...
| 控制文件名称 | 单机部署、存算一体分布式部署：ctrl1、ctrl2、ctrl3<br/>共享集群/分布式集群部署：ctrlfile0、ctrlfile1、ctrlfile2 |
| 控制文件存储路径 | 单机部署、存算一体分布式部署：$YASDB_DATA/dbfiles<br/>共享集群/分布式集群部署：+DG0/dbfiles |
