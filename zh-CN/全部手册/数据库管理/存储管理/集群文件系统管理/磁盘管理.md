...
4. 执行[ALTER DISKGROUP](../../../工具手册/yfscmd/磁盘管理命令.html#ALTERDG)命令，为数据磁盘组添加磁盘。
...
4. 执行[ALTER DISKGROUP](../../../工具手册/yfscmd/磁盘管理命令.html#ALTERDG)命令，为数据磁盘组添加故障组。
...
4. 执行[CREATE DISKGROUP](../../../工具手册/yfscmd/磁盘管理命令)命令，添加新的数据磁盘组。
    ```shell
...
6. 为新的业务数据合理规划存储路径，详情请查阅[逻辑空间管理](../逻辑空间管理/00逻辑空间管理)。
...
4. 执行[ALTER DISKGROUP](../../../工具手册/yfscmd/磁盘管理命令.html#ALTERDG)命令，使用新磁盘替换故障磁盘。
...
3. 执行[ALTER DISKGROUP](../../../工具手册/yfscmd/磁盘管理命令.html#ALTERDG)命令，重新上线目标磁盘。
