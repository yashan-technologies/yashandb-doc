...
如上述例子所示，通过比较实际select出来的值与explain出来的值判断行记录数评估是否准确，具体使用请查阅[EXPLAIN](../../../开发手册/SQL参考手册/SQL语句/EXPLAIN)。

#### autotrace

直接开启autotrace可以替代上述比较过程，具体使用请查阅[SET AUTOTRACE](../../../开发手册/SQL参考手册/SQL语句/SET AUTOTRACE)。
