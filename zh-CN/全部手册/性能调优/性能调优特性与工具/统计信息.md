...
单机部署/共享集群部署中使用[DBMS_STATS](../../开发手册/PL参考手册/内置高级包/DBMS_STATS)高级包，存算一体分布式集群部署中使用[DBMS_STATS](../../开发手册/PL参考手册/内置高级包/DBMS_STATS)高级包或[ANALYZE TABLE](../../开发手册/SQL参考手册/SQL语句（yashan模式）/ANALYZE TABLE)语句，让用户对统计信息进行管理和手动触发指定的收集动作。
