...
| BEGIN_TIME | TIMESTAMP(6) | 实例恢复开始的时间 |
| GLOBAL_RESOURCE_AVAILABLE_TIME | TIMESTAMP(6) | 全局资源可用时间 |
| COMPLETE_RECOVERY_TIME | TIMESTAMP(6) | 实例恢复完全可用的时间 |
| END_TIME | TIMESTAMP(6) | 实例恢复结束的时间 |
