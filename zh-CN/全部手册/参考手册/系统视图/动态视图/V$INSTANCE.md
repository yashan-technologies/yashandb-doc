...
| STARTUP_TIME | TIMESTAMP(6)    | 数据库实例启动时间 |
...
| INSTANCE_ROLE | VARCHAR(64)  | 当前实例角色 <br/>* MASTER_ROLE：当前实例为MASTER <br/>* NORMAL_ROLE：当前实例为NORMAL <br/> 该字段仅在共享集群/分布式集群部署下有意义，其它部署模式下该字段值恒为MASTER_ROLE |
