...
| SEGMENT_TYPE    | VARCHAR(18) | segment类型<br>\*   TABLE<br>\*   INDEX<br>\*   LOB<br>\*   AC<br>\*  TABLE PARTITION<br>\*   INDEX PARTITION<br>*   LOB PARTITION<br>\*  AC PARTITION<br>*  TABLE SUBPARTITION <br>*  INDEX SUBPARTITION<br>*  LOB SUBPARTITION |
| TABLESPACE_NAME | VARCHAR(64) | extent所在的表空间名                                         |
