...
请参考[YashanDB软件包清单](../../安装和升级/安装部署/安装前准备/下载软件包)获取YashanDB的YStream客户端安装包Ystream-{版本号}.jar，例如前往[下载中心（https://download.yashandb.com/download）](https://download.yashandb.com/download)直接下载。
