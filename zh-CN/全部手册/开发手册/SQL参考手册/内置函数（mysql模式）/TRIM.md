...
```sql
SELECT TRIM('a!cd' FROM 'a!cdgklla?cd');

trim('a!cd' from 'a!cdgklla?cd')
-------------------------------------------------
gklla?cd                                            


SELECT TRIM(LEADING 'a!cd' FROM 'a!cdgklla?cd');

trim(leading 'a!cd' from 'a!cdgklla?cd')
-------------------------------------------------
gklla?cd                                       


SELECT TRIM(trailing 'a!cd' FROM 'a!cdgklla?cd');

trim(trailing 'a!cd' from 'a!cdgklla?cd')
-------------------------------------------------
a!cdgklla?cd                                      
