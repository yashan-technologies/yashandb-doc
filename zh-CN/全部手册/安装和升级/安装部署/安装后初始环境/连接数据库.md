...
连接模式（多IP场景）仅在使用驱动连接YashanDB服务端时可以进行配置，例如[JDBC驱动](../../../开发手册/JDBC驱动/JDBC驱动使用介绍/00JDBC驱动使用介绍)、[C驱动](../../../开发手册/C语言系驱动/C驱动/C驱动接口说明/连接、授权和初始化函数/yacConnect)、[OCI驱动](../../../开发手册/C语言系驱动/OCI驱动/OCI连接配置说明)、[ODBC驱动](../../../开发手册/C语言系驱动/ODBC驱动/ODBC安装说明/00ODBC安装说明)，且要求YashanDB服务端存在多个节点。
