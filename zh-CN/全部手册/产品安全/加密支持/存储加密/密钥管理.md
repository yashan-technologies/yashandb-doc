...
1. 为数据库的某个节点（例如单机高可用部署的主库、共享集群/分布式集群部署的任一实例）配置钱包的根目录[WALLET_ROOT](../../../参考手册/配置参数.html#wallet)参数。
...
4. 执行如下语句创建钱包，语法详情可查阅ADMINISTER KEY MANAGEMENT语句的[create_keystore](../../../开发手册/SQL参考手册/SQL语句/ADMINISTER KEY MANAGEMENT.html#createkeystore)子句。
...
5. 执行如下语句开启钱包，语法详情可查阅ADMINISTER KEY MANAGEMENT语句的[open_keystore](../../../开发手册/SQL参考手册/SQL语句/ADMINISTER KEY MANAGEMENT.html#openkeystore)子句。

    ```sql
    ADMINISTER KEY MANAGEMENT SET KEYSTORE OPEN IDENTIFIED BY Your_keystore_password;
    ```

6. 执行如下语句创建并激活主密钥，语法详情可查阅ADMINISTER KEY MANAGEMENT语句的[set_key](../../../开发手册/SQL参考手册/SQL语句/ADMINISTER KEY MANAGEMENT.html#setkey)子句。
...
1. 为数据库的某个节点（例如单机高可用部署的主库、共享集群部署的任一实例）配置密钥管理方式[TDE_CONFIGURATION](../../../参考手册/配置参数.html#TDE_CONFIGURATION)参数和钱包的根目录[WALLET_ROOT](../../../参考手册/配置参数.html#wallet)参数。
...
执行ADMINISTER KEY MANAGEMENT语句的[backup_keystore](../../../开发手册/SQL参考手册/SQL语句/ADMINISTER KEY MANAGEMENT.html#backupkeystore)子句单独备份钱包。
