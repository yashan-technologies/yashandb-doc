...
- 执行审计策略创建操作的用户，需具备AUDIT_ADMIN审计管理员角色或AUDIT SYSTEM系统特权，授权操作请查阅[权限授予与收回](../数据访问控制/特权与角色管理（yashan模式）/权限授予与收回)。
...
2. 执行[CREATE AUDIT POLICY](../../开发手册/SQL参考手册/SQL语句（yashan模式）/CREATE AUDIT POLICY)语句创建审计策略。
...
- 执行审计策略使能操作的用户，需具备AUDIT_ADMIN审计管理员角色或AUDIT SYSTEM系统特权，授权操作请查阅[权限授予与收回](../数据访问控制/特权与角色管理（yashan模式）/权限授予与收回)。
...
2. 执行[AUDIT POLICY](../../开发手册/SQL参考手册/SQL语句（yashan模式）/AUDIT POLICY)语句使能审计策略。
...
- 执行审计策略修改操作的用户，需具备AUDIT_ADMIN审计管理员角色或AUDIT SYSTEM系统特权，授权操作请查阅[权限授予与收回](../数据访问控制/特权与角色管理（yashan模式）/权限授予与收回)。
...
2. 执行[ALTER AUDIT POLICY](../../开发手册/SQL参考手册/SQL语句（yashan模式）/ALTER AUDIT POLICY)语句修改审计策略。
...
执行取消审计策略使能操作的用户，需具备AUDIT_ADMIN审计管理员角色或AUDIT SYSTEM系统特权，授权操作请查阅[权限授予与收回](../数据访问控制/特权与角色管理（yashan模式）/权限授予与收回)。

## 操作步骤

1. 使用具备相应权限的用户登录YashanDB。

2. 执行[NOAUDIT POLICY](../../开发手册/SQL参考手册/SQL语句（yashan模式）/NOAUDIT POLICY)语句取消审计策略使能。
...
- 执行删除审计策略操作的用户，需具备AUDIT_ADMIN审计管理员角色或AUDIT SYSTEM系统特权，授权操作请查阅[权限授予与收回](../数据访问控制/特权与角色管理（yashan模式）/权限授予与收回)。
...
2. 执行[DROP AUDIT POLICY](../../开发手册/SQL参考手册/SQL语句（yashan模式）/NOAUDIT POLICY)语句删除审计策略。
