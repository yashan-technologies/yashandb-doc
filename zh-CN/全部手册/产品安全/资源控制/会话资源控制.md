...
- 执行[CREATE PROFILE](../../开发手册/SQL参考手册/SQL语句（yashan模式）/CREATE PROFILE.html# res)和[ALTER PROFILE](../../开发手册/SQL参考手册/SQL语句（yashan模式）/ALTER PROFILE.html# res)语句可以配置会话资源阈值。

- 执行[CREATE USER](../../开发手册/SQL参考手册/SQL语句（yashan模式）/CREATE USER.html#profile)或[ALTER USER](../../开发手册/SQL参考手册/SQL语句（yashan模式）/ALTER USER.html#profile)语句可以关联user与profile，即配置会话资源阈值的生效用户。
