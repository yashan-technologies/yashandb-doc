...
归档日志统计视图，包含日志成员、日志大小、日志号和完成时间等信息，详细字段介绍请查阅[GV$ARCHIVED_LOG](../参考手册/系统视图/动态视图/GV$ARCHIVED_LOG.md)/[V$ARCHIVED_LOG](../参考手册/系统视图/动态视图/V$ARCHIVED_LOG.md)。
...
自动选主视图，包含当前LEADER、任期、同步日志点、状态、最后心跳时间和节点组成员等信息，详细字段介绍请查阅[GV$ELECTION](../参考手册/系统视图/动态视图/GV$ELECTION.md)/[V$ELECTION](../参考手册/系统视图/动态视图/V$ELECTION.md)。
...
备库列表和状态视图，包含dest_id备库编号、connection连接状态、status备库状态、received_lfn备库接收点和applied_lfn备库回放点等信息，详细字段介绍请查阅[GV$ARCHIVE_DEST_STATUS](../参考手册/系统视图/动态视图/GV$ARCHIVE_DEST_STATUS.md)/[V$ARCHIVE_DEST_STATUS](../参考手册/系统视图/动态视图/V$ARCHIVE_DEST_STATUS.md)。

在单机部署中，该类视图也可以在级联备的父级备库中查询，用于获取其下属级联备列表信息。
...
备库同步状态视图，包含status连接状态、peer_point主库日志点、received_point备库接收点、applied_point备库回放点、transport_lag日志传输延迟时间和apply_lag日志回放延迟时间等信息，详细字段介绍请查阅[GV$REPLICATION_STATUS](../参考手册/系统视图/动态视图/GV$REPLICATION_STATUS.md)/[V$REPLICATION_STATUS](../参考手册/系统视图/动态视图/V$REPLICATION_STATUS.md)。
...
备库回放进度视图，包含Average Apply Rate、Redo Remain、Remain Time和Parallelism等信息，详细字段介绍请查阅[GV$RECOVERY_PROGRESS](../参考手册/系统视图/动态视图/GV$RECOVERY_PROGRESS.md)/[V$RECOVERY_PROGRESS](../参考手册/系统视图/动态视图/V$RECOVERY_PROGRESS.md)。
