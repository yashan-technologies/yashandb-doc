...
- 修改系统变量前，请查阅[系统变量参考](系统变量参考.md)了解系统变量及其值域：param和value分别为配置参数名称和参数值，参数值需符合取值范围和格式。
...
请参考[MySQL Client](https://doc.yashandb.com/ecosystem/23.4/zh/SQL-Tools/MySQL-Client.html)了解详细的SET命令用法。
