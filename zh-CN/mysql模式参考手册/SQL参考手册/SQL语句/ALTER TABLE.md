...
```
index_expr，index_type的含义及使用介绍同CREATE INDEX中的[index_expr](./CREATE INDEX.md#indexexpr)，[index_type](./CREATE INDEX.md#indextype)。
...
配置数据类型为YashanDB认可的[数据类型](../数据类型/数据类型.md)。
