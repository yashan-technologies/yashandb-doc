...
mysql模式仅支持基于列创建BTree索引，当基于列创建HASH索引或创建函数索引时，将按照yashan模式进行解析执行，数据库正常提供服务。详细的语法要求可参考[基于yashan模式CREATE INDEX](../../../开发手册/SQL参考手册/SQL语句/CREATE INDEX.md#indexexpr)。
