...
| FILE\_ID         | BIGINT        | xfmr任务生成slice的对应文件id                                                                                 |
| CREATE\_TIME     | TIMESTAMP(6)     | xfmr任务的创建时间                                                                                          |
| START\_TIME      | TIMESTAMP(6)     | xfmr任务的开始执行时间                                                                                        |
| FINISH\_TIME     | TIMESTAMP(6)     | xfmr任务的结束执行时间                                                                                        |
| EXECUTE\_COUNT   | INTEGER       | xfmr任务的执行次数                                                                                          |
| MAX\_MEM\_USE    | BIGINT        | xfmr任务执行中的最大内存大小                                                                                     |
| MAX\_MEM\_QUOTA  | BIGINT        | xfmr任务执行中的最大内存配额大小                                                                                   |
