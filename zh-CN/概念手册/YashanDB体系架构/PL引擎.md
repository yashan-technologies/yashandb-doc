...
- 自定义函数
  ...
  自定义函数（UDF，User Defined Function）是以函数形式组织的PL语言数据库对象，类似于Pascal（结构化编程语言）中的函数。自定义函数包括PL语言自定义函数、外置Java语言自定义函数和外置C语言自定义函数。
...
- 自定义高级包
  ...
  自定义高级包（PACKAGE）是数据库里的一种PL对象，是一组相关的过程、函数、变量、游标和类型等的集合。
