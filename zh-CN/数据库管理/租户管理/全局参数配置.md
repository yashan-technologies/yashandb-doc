...
通过[V$PARAMETER](../../参考手册/系统视图/动态视图/V$PARAMETER.md)视图中的ISPDB_MODIFIABLE和ISPDB_PRIVATE字段可以判断参数的作用域属性。
...
[yasboot cluster config set](../../工具手册/yasboot/yasboot命令介绍/yasboot cluster.md)命令等价于登录根容器执行ALTER SYSTEM SET … CONTAINER=CURRENT语句，使用场景包括：
