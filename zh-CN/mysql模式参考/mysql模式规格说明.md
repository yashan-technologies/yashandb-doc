...
- 完成ASCII、GBK、UTF8、UTF8MB4、GB18030等五项database级字符集兼容。

- 新增列级collate，支持latin1_bin、utf8mb4_bin、utf8mb4_general_ci等三项字符序。

- 支持MySQL大小写规则同步，SQL元数据获取和协议返回表名/database名大小写和MySQL一致，支持设置lower_case_table_name为1。
