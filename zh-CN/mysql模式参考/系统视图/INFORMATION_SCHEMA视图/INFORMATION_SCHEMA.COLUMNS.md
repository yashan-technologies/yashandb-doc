...
| COLUMN_DEFAULT | VARCHAR(32000) | 列的默认值 |
| IS_NULLABLE | VARCHAR(3) | 列是否允许为空 |
| DATA_TYPE | varchar(65534) | 列的数据类型 |
...
| COLUMN_TYPE | varchar(65534) | 列数据类型 |
...
| GENERATION_EXPRESSION | VARCHAR(1) | 存储生成列的计算表达式<br>仅语法兼容，无实际功能含义 |
