...
用户ID，必须是整数类型的数据，使用[USERENV](../../../全部手册/开发手册/SQL参考手册/内置函数/USERENV)函数或查询[DBA_USERS](../../../全部手册/参考手册/系统视图/DBA视图/DBA_USERS)视图获取。

**privilege_id**

权限ID，必须是整数类型的数据，查询[DBA_ROLES](../../../全部手册/参考手册/系统视图/DBA视图/DBA_ROLES)视图获取。
