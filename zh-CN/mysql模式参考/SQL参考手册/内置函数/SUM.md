...
当指定OVER关键字时，SUM将作为[窗口函数](../../../全部手册/开发手册/SQL参考手册/内置函数/00内置函数.html#WindowFunction)，并支持滑动窗口，返回多行的数值和。

**analytic_clause**

窗口函数通用语法，详情请查阅[窗口函数](../../../全部手册/开发手册/SQL参考手册/内置函数/00内置函数.html#WindowFunction)。
