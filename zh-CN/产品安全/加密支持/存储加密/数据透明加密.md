...
在单机/共享集群/分布式集群部署环境中，部分场景需要先[配置并开启钱包](密钥管理.md#configuringwallet)：
...
具体操作请查阅CREATE TABLESPACE的[encryption\_clause](../../../开发手册/SQL参考手册/SQL语句/CREATE TABLESPACE.md#encryptionclause)子句。
...
具体操作请查阅CREATE TABLE的[table\_encryption\_clause](../../../开发手册/SQL参考手册/SQL语句/CREATE TABLE.md#tableencryptionclause)子句。
...
具体操作请查阅CREATE TABLE的[column_encryption_clause](../../../开发手册/SQL参考手册/SQL语句/CREATE TABLE.md#columnencryptionclause)子句。
...
具体操作请查阅ALTER TABLE的[column_encryption_clause](../../../开发手册/SQL参考手册/SQL语句/ALTER TABLE.md#columnencryptionclause)子句。
