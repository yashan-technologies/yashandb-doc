...
- 执行[CREATE PROFILE](../../开发手册/SQL参考手册/SQL语句/CREATE PROFILE.md#ip)和[ALTER PROFILE](../../开发手册/SQL参考手册/SQL语句/ALTER PROFILE.md#ip)语句可以配置IP黑/白名单列表。

- 执行[CREATE USER](../../开发手册/SQL参考手册/SQL语句/CREATE USER.md#profile)或[ALTER USER](../../开发手册/SQL参考手册/SQL语句/ALTER USER.md#profile)语句可以关联user与profile，即配置IP黑/白名单的生效用户。
