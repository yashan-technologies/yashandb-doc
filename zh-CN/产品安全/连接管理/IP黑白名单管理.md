...
- 执行[CREATE PROFILE](../../开发手册/SQL参考手册/SQL语句（yashan模式）/CREATE PROFILE.html#ip)和[ALTER PROFILE](../../开发手册/SQL参考手册/SQL语句（yashan模式）/ALTER PROFILE.html#ip)语句可以配置IP黑/白名单列表。

- 执行[CREATE USER](../../开发手册/SQL参考手册/SQL语句（yashan模式）/CREATE USER.html#profile)或[ALTER USER](../../开发手册/SQL参考手册/SQL语句（yashan模式）/ALTER USER.html#profile)语句可以关联user与profile，即配置IP黑/白名单的生效用户。
