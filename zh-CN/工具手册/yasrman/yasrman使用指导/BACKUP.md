...
全量备份，规则与定义同[BACKUP DATABASE](../../../开发手册/SQL参考手册/SQL语句/BACKUP DATABASE.md#full)语句中相关描述。

### INCREMENTAL LEVEL

增量备份，规则与定义同[BACKUP DATABASE](../../../开发手册/SQL参考手册/SQL语句/BACKUP DATABASE.md#incremental)语句中相关描述。
