...
```text
    ...
    Nodes in cluster:
      Node name: host0001, yascs/yasfs inter connect URL: 192.168.1.2:1788, Node ID: 1
        yasdb instance name:yasdb, yasdb instance id:1
      Node name: host0002, yascs/yasfs inter connect URL: 192.168.1.2:1789, Node ID: 2
        yasdb instance name:yasdb, yasdb instance id:1
```
