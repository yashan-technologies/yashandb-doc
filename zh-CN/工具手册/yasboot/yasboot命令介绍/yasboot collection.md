...
| *-t,--toml*   | 使用toml文件内的配置项，格式请查阅[服务器检查配置文件](../配置文件/服务器检查配置文件.md)     |
...
可以根据[服务器检查配置文件](../配置文件/服务器检查配置文件.md)指定检查项是否开启，然后执行命令时指定配置文件。
...
| *\-o,--output*        | 服务器检查结果和报告的输出目录                                 |
| *\-n,--name*          | 服务器检查结果和报告的标识名称                                 |
| *\-y,--yascheck-toml* | 使用toml文件内的配置项，格式请查阅[服务器检查配置文件](../配置文件/服务器检查配置文件.md)                    |
