对某些特定的异常场景，YashanDB提供快速修复功能，保证高可用环境的平稳运行，相关语法定义及描述请参考[BUILD DATABASE](../../全部手册/开发手册/SQL参考手册/SQL语句/BUILD DATABASE)。
...
- 直连PDB执行BUILD DATABASE：仅构建对应的备PDB
  ...
  另外，构建备PDB还可以连接根容器执行[BUILD PLUGGABLE DATABASE](../../全部手册/开发手册/SQL参考手册/SQL语句/BUILD PLUGGABLE DATABASE)进行全局运维。
...
如果备PDB出现异常情况时，也可以通过根容器进行统一运维，通过执行[BUILD PLUGGABLE DATABASE](../../全部手册/开发手册/SQL参考手册/SQL语句/BUILD PLUGGABLE DATABASE)快速重建恢复单个或批量PDB。
