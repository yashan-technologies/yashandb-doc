...
1. 执行yasboot package ce gen命令生成配置文件，该命令的参数全集请查阅[yasboot文档](../../全部手册/工具手册/yasboot/yasboot命令介绍/yasboot package)。
...
| [group.ycsconfig]下各参数                     | 该类参数均为[YCS配置参数](../../全部手册/数据库管理/集群管理/集群参数配置)，可手工调整 |
| [group.yfsconfig]下各参数                     | 该类参数均为[YFS配置参数](../../全部手册/数据库管理/存储管理/集群文件系统管理/集群文件系统配置)，可手工调整 |
