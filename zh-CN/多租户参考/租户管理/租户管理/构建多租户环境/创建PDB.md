创建PDB需在OPEN状态的根容器上操作，可以通过[CREATE PLUGGABLE DATABASE](../../../../全部手册/开发手册/SQL参考手册/SQL语句/CREATE PLUGGABLE DATABASE)语句或[yasboot pdb add](../../../../全部手册/工具手册/yasboot/yasboot命令介绍/yasboot pdb)命令创建。
