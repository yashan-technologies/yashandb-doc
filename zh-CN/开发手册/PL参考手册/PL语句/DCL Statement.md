...
COMMIT/ROLLBACK语法可参考相应的SQL语句（[COMMIT](../../SQL参考手册/SQL语句/COMMIT.md)和[ROLLBACK](../../SQL参考手册/SQL语句/ROLLBACK.md)），但在PL语句中无法使用FORCE子句。
...
_BEGIN_  
_SAVEPOINT _savepoint\_name_;_  
_..._  
_ROLLBACK TO _savepoint\_name_;_  
_..._  
_END;_
