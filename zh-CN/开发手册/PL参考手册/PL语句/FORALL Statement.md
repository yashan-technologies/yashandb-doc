...
*   当lower\_bound < upper\_bound时，从lower\_bound开始循环赋值给index，一直到upper\_bound即结束循环语句。
*   当lower\_bound = upper\_bound时，lower\_bound赋值给index，循环语句只会执行一次。
*   当lower\_bound > upper\_bound时，直接结束FORALL语句。
