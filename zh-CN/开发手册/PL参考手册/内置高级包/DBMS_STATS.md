...
<span id="gathertablestats" name="gathertablestats"></span>
...
<span id="gatherschemastats" name="gatherschemastats"></span>
...
<span id="gatherdatabasestats" name="gatherdatabasestats"></span>
...
<span id="statoption" name="statoption"></span>
...
- 通过SET\_*\_PREFS程序进行通用设定，当未指定选项参数，或选项参数为NULL时，系统使用此通用设定值。
- 当未按上述两种方式指定值时，由系统给出默认值。

其中，某个选项一旦由SET\_*\_PREFS程序设定，即可通过ALL_TAB_STAT_PREFS、DBA_TAB_STAT_PREFS、USER_TAB_STAT_PREFS视图查看该选项在表上对应的值。
...
<span id="createstattable" name="createstattable"></span>
...
<span id="dropstattable" name="dropstattable"></span>
...
<span id="exporttablestats" name="exporttablestats"></span>
...
<span id="exportcolumnstats" name="exporttablestats"></span>
...
<span id="exportindexstats" name="exportindexstats"></span>
...
<span id="exportschemastats" name="exportschemastats"></span>
...
<span id="importtablestats" name="importtablestats"></span>
...
<span id="importcolumnstats" name="importcolumnstats"></span>
...
<span id="importindexstats" name="importindexstats"></span>
...
<span id="importschemastats" name="importschemastats"></span>
