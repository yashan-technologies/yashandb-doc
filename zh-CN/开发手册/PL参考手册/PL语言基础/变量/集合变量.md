...
- 可以通过数组相关内置函数对数组进行赋值，例如[STRING_TO_ARRAY](../../../SQL参考手册/内置函数（yashan模式）/STRING_TO_ARRAY)、[ARRAY_APPEND](../../../SQL参考手册/内置函数（yashan模式）/ARRAY_APPEND)、[ARRAY_REMOVE](../../../SQL参考手册/内置函数（yashan模式）/ARRAY_REMOVE)、[ARRAY_REPLACE](../../../SQL参考手册/内置函数（yashan模式）/ARRAY_REPLACE)等。
