...
* TIME型数据与DS\_INTERVAL型数据进行运算时，将会向DS\_INTERVAL型统一。
...
|  数据<br>类型| 数值型| 字符型| BOOLEAN| DATE| TIMESTAMP| TIMESTAMP WITH LOCAL TIME ZONE| TIMESTAMP WITH TIME ZONE| YM\_<br/>INTERVAL| DS\_<br/>INTERVAL| TIME|
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| **数值型** | （2） | （2） | （2） | \-- | \-- | \-- | \-- | \-- | \-- | \-- |
| **字符型** | （2） | （2） | （2） | DATE | TIMESTAMP | TIMESTAMP WITH LOCAL TIME ZONE | TIMESTAMP WITH TIME ZONE | YM\_<br/>INTERVAL | DS\_<br/>INTERVAL | TIME |
| **BOOLEAN** | (2) | (2) | (2) | \-- | \-- | \-- | \-- | \-- | \-- | \-- |
