...
- ROWSCN不能用于[多表条件插入](../SQL语句/INSERT.md#conditionalinsertclause)的WHEN条件子句、insert_values_clause以及子查询。
...
- ROWID不能用于[多表条件插入](../SQL语句/INSERT.md#conditionalinsertclause)的WHEN条件子句、insert_values_clause以及子查询。
