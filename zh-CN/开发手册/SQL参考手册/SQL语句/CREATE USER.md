...
CREATE USER用于新建一个数据库用户，YashanDB的用户管理体系请参考[用户管理](../../../产品安全/身份标识与鉴别/管理用户)。
...
*   区分大小写。
*   密码字符串长度不超过64。
*   遵循[密码强度](../../../产品安全/身份标识与鉴别/密码认证/密码策略.md#password_complexity)和[密码策略](../../../产品安全/身份标识与鉴别/密码认证/密码策略.md#password_policy)要求。
