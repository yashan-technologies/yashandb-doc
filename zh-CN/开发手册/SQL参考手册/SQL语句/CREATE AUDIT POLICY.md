...
审计策略被成功创建后，可通过[AUDIT_UNIFIED_POLICIES](../../../参考手册/系统视图/DBA视图/AUDIT_UNIFIED_POLICIES.md)视图查看其定义信息。
...
审计策略的名称，审计策略名称不可重复，不可省略，不可带模式名，且需符合YashanDB的[对象命名规范](../基本SQL元素/标识符.md)。
...
全局审计项目，具体项目可以通过[V$AUDITABLE_SYSTEM_ACTIONS](../../../参考手册/系统视图/动态视图/V$AUDITABLE_SYSTEM_ACTIONS)视图查看。

##### ALL

当全局审计项指定为ALL时，表示在V$AUDITABLE_SYSTEM_ACTIONS中列出的所有项目都将纳入审计策略。
...
针对对象的审计项目，具体项目可以通过[V$AUDITABLE_OBJECT_ACTIONS](../../../参考手册/系统视图/动态视图/V$AUDITABLE_OBJECT_ACTIONS)视图查看。
