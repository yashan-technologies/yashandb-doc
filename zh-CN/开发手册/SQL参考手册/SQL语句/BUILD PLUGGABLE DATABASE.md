...
```ebnf
= BUILD PLUGGABLE DATABASE ( pdb_name {',' pdb_name}|ALL) [SKIP VALIDATE] [OVERWRITE] [PARALLELISM integer].
```
...
通过[V$PDBS](../../../参考手册/系统视图/动态视图/V$PDBS.md)视图或yasql的`show pdbs`命令可以获取当前所有PDB信息。  
