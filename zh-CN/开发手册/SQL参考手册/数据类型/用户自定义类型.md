...
- 表函数table()，详细语法请查阅SELECT语句中的[table_collection_expression](../SQL语句/SELECT.md#tablecollectionexpression)。
...
对Nested Table数据的查询需使用table()方法，语法详见SELECT语句中的[table_collection_expression](../SQL语句/SELECT.md#tablecollectionexpression)描述。
