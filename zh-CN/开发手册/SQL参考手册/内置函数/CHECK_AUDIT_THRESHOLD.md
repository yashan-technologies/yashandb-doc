...
- 返回值 > 给定阈值（[AUDIT_RECORD_THRESHOLD](../../../参考手册/配置参数.md#auditthreshold)参数），记录1条ACTION为“AUDIT RECORD THRESHOLD”的审计日志。

- 返回值 > 80，在告警日志alert.log中记录“AuditRecordTableFull”并判断[AUDIT_RECORD_TABLE](../../../参考手册/配置参数.md#auditdest)参数的值：
