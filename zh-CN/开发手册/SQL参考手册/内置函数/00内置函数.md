...
地理信息处理函数是指对空间地理信息进行处理的一系列函数，更多详情请查阅[GIS Function](GIS Function/00GIS Function)。

XML数据处理函数（XML Function）
-------------------------

XML数据处理函数是指对XML相关数据进行处理的一系列函数，更多详情请查阅[XML Function](XML Function/00XML Function.md)。
...
AI函数是指以AI模型为底座进行信息处理的的函数，此类函数通过调用已注册的AI模型提供智能计算能力。

AI模型注册和管理请参考[DBMS_LLM](../../PL参考手册/内置高级包/DBMS_LLM.md)。
