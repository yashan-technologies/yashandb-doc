...
ROW_NUMBER为[窗口函数](00内置函数.md#WindowFunction)，其语法描述及约束与[DENSE\_RANK函数](./DENSE_RANK)、[RANK函数](./RANK)一致，区别在于排序时对并列值的处理：

*   本函数不列出并列值，而是根据返回的结果递增，不跳号，例如1，2，3，4，5，6，7，8……
*   DENSE\_RANK函数列出相同并列值，并对下一顺序值不跳号，例如1，2，3，3，3，4，5，6……
