...
LBAC标签策略名称，策略名称大小写不敏感，可查询[DBA_SA_POLICIES](../../../参考手册/系统视图/DBA视图/DBA_SA_POLICIES)视图获取。
...
- 可查看[DBA_SA_LABELS](../../../参考手册/系统视图/DBA视图/DBA_SA_LABELS)视图获取该策略下的已存在的标签。

- 可查看[DBA_SA_LEVELS](../../../参考手册/系统视图/DBA视图/DBA_SA_LEVELS)视图获取该策略下的等级信息。
- 可查看[DBA_SA_COMPARTMENTS](../../../参考手册/系统视图/DBA视图/DBA_SA_COMPARTMENTS)视图获取该策略下的范围信息。
