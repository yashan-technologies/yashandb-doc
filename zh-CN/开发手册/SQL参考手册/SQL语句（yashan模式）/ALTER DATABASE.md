...
在共享集群部署中，redo日志文件是各个实例独享的，仅支持各个实例给自己添加redo日志文件。
...
手动清理归档日志的筛选条件由ARCHIVELOG_DELETION_POLICY或ARCH_CLEAN_IGNORE_MODE参数决定，清理条件的具体描述见[归档管理](../../../数据库管理/基本数据库管理/归档管理)章节。 
