...
查看[YashanDB JDBC驱动使用介绍](JDBC驱动使用介绍/00JDBC驱动使用介绍)可以了解在Java应用程序里连接并操作YashanDB的简单的过程。
...
- 透明应用故障转移功能，在当前连接节点发生故障后，客户端能够自动重新连接到已配置的其他节点，具体见[JDBC透明应用故障转移](JDBC驱动使用介绍/透明应用故障转移)章节描述。
