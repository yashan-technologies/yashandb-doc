YashanDB JDBC驱动会对YashanDB数据类型和Java数据类型进行类型转换。
...
YashanDB JDBC驱动连接运行在yashan模式下的YashanDB时，**已适配**的数据类型如下表所示。

| yashan模式数据类型| YasTypes| JDBC类型| 标准Java数据类型|
|--------------------------------|------------------------|----------------------------------------------|--------------------------------------|
...
YashanDB JDBC驱动连接运行在mysql模式下的YashanDB时，**已适配**的数据类型如下表所示。

| mysql模式数据类型| YasTypes| JDBC类型| 标准Java数据类型|
|-----------------------------------|------------------------|----------------------------------------------|--------------------------------------|
| CHAR                              | YasTypes.CHAR          | java.sql.Types.CHAR                          | java.lang.String                     |
| VARCHAR                           | YasTypes.VARCHAR       | java.sql.Types.VARCHAR                       | java.lang.String                     |
| BOOLEAN                           | YasTypes.BOOLEAN       | java.sql.Types.BOOLEAN                       | java.lang.Boolean                    |
