...
2. 将YashanDB客户端安装包下载并解压到本地路径，例如/home/yasdb-driver-c/lib。
...
1. 从[Oracle官网](https://www.oracle.com/database/technologies/instant-client/downloads.html)下载Instant Client基础包，获取`oci.h`、`oratypes.h`及相关头文件。下载后解压到任意目录，例如`/home/yasdb-driver-c/lib`。
