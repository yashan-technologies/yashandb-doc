...
|  函数    | 说明      |
| ------------------------------------------------------------ | ------------------------------------------- |
| [yacLobDescAlloc2](../C驱动接口说明/LOB函数/yacLobDescAlloc2) | LOB协议中，为loblocator分配空间（推荐使用）             |
| [yacLobFreeTemporary](../C驱动接口说明/LOB函数/yacLobFreeTemporary) | LOB协议中，通知服务端释放临时LOB            |
| [yacLobDescFree2](../C驱动接口说明/LOB函数/yacLobDescFree2) | LOB协议中，为loblocator释放空间（推荐使用）             |
| [yacLobRead2](../C驱动接口说明/LOB函数/yacLobRead2)          | LOB协议中，从某个位置读取LOB数据（推荐使用）            |
| [yacLobWrite2](../C驱动接口说明/LOB函数/yacLobWrite2)        | LOB协议中，从某个位置将数据插入到LOB（推荐使用）        |
