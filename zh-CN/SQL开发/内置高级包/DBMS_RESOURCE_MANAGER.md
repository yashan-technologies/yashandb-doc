DBMS_RESOURCE_MANAGER包提供了一组[资源管理](../../全部手册/数据库管理/资源管理/00资源管理)的存储过程/函数，用于创建和删除资源计划、资源指令、资源映射及相关操作。
...
|  参数| 描述|
| --- | --- |
| PLAN | CDB资源计划名，名称唯一且符合YashanDB的[对象命名规范](../../全部手册/开发手册/SQL参考手册/基本SQL元素/标识符)，允许使用系统保留关键字，但不满足[双引号的通用规则](../../全部手册/开发手册/SQL参考手册/基本SQL元素/双引号)  |
| COMMENT | 注释 |
...
|  参数| 描述|
| :-------- | :----------------------------------------------------------- |
| CONSUMER_GROUP      | 资源使用组，名称唯一且符合YashanDB的[对象命名规范](../../全部手册/开发手册/SQL参考手册/基本SQL元素/标识符)，允许使用系统保留关键字，但不满足[双引号的通用规则](../../全部手册/开发手册/SQL参考手册/基本SQL元素/双引号)               |
| COMMENT      | 注释 |
