...
|  参数| 描述|
| :---- |:-----------|
|options| 清理选项。CLEANUP_ORPHANS：表示使用coalesce cleanup only。COALESCE：表示使用coalesce cleanup。详见[COALESCE](../../全部手册/开发手册/SQL参考手册/SQL语句（yashan模式）/ALTER INDEX.html#coalesce) |
