...
> - DBMS_DIN高级包仅支持存算一体分布式集群部署形态，在单机或共享集群形态下执行会报错。
...
- NODE_ID，LINK_LEVEL和LINK_ID可根据视图[V/$DIN_LINK](../../全部手册/参考手册/系统视图/动态视图/V$DIN_LINK)和[GV$DIN_LINK](../../全部手册/参考手册/系统视图/动态视图/GV$DIN_LINK)的查询结果进行参考。
