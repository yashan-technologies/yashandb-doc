...
对象所属OWNER用户ID，必须是整数类型的数据，使用[USERENV](./USERENV)函数或查询[DBA_USERS](../../全部手册/参考手册/系统视图/DBA视图/DBA_USERS)视图获取。

**object_type_id**

对象的类型ID，必须是整数类型的数据，可参考[DBA_OBJECTS](../../全部手册/参考手册/系统视图/DBA视图/DBA_OBJECTS)视图资料中OBJECT_TYPE字段描述，例如表的类型ID为1。
