...
POSITION函数在一个[expr](../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)2表示的字符串中从左向右查找[expr](../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)1表示的字符串，返回expr1第一次出现的位置，该结果为一个BIGINT类型的数字。若没有查找到匹配值，函数返回0。
