...
[通用表达式](../../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)，用于控制最短与最长边的长度比，从而影响凹包的凹度，类型为DOUBLE，有效范围为[0,1.0]。
...
[通用表达式](../../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)，该参数类型为bool，缺省值为false，表示是否允许返回的多边形中包含洞。
