...
使用本函数可能需要调用[YLS_ENFORCEMENT](../内置高级包/YLS_ENFORCEMENT)、[SA_SYSDBA](../内置高级包/SA_SYSDBA)、[SA_COMPONENTS](../内置高级包/SA_COMPONENTS)、[SA_LABEL_ADMIN](../内置高级包/SA_LABEL_ADMIN)等内置高级包，相关权限要求和使用约束还会受限于相应的内置高级包。
...
- 可参考[SA_LABEL_ADMIN](../内置高级包/SA_LABEL_ADMIN)查看标签格式要求。
