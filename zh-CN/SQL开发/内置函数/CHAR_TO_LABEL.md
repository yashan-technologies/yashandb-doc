...
使用本函数可能需要调用[YLS_ENFORCEMENT](../../全部手册/开发手册/PL参考手册/内置高级包/YLS_ENFORCEMENT)、[SA_SYSDBA](../../全部手册/开发手册/PL参考手册/内置高级包/SA_SYSDBA)、[SA_COMPONENTS](../../全部手册/开发手册/PL参考手册/内置高级包/SA_COMPONENTS)、[SA_LABEL_ADMIN](../../全部手册/开发手册/PL参考手册/内置高级包/SA_LABEL_ADMIN)等内置高级包，相关权限要求和使用约束还会受限于相应的内置高级包。

**policy_name**

LBAC安全策略名称，策略名称大小写不敏感，可查询[DBA_SA_POLICIES](../../全部手册/参考手册/系统视图/DBA视图/DBA_SA_POLICIES)视图获取。

**label_string**

标签内容，必须符合标签格式要求且对应的组件均存在，标签内容大小写不敏感。
- 可参考[SA_LABEL_ADMIN](../../全部手册/开发手册/PL参考手册/内置高级包/SA_LABEL_ADMIN)查看标签格式要求。
- 可参考[DBA_SA_LEVELS](../../全部手册/参考手册/系统视图/DBA视图/DBA_SA_LEVELS)查看该策略下的级别名。
- 可参考[DBA_SA_COMPARTMENTS](../../全部手册/参考手册/系统视图/DBA视图/DBA_SA_COMPARTMENTS)查看该策略下的范围名。
- 可参考[DBA_SA_LABELS](../../全部手册/参考手册/系统视图/DBA视图/DBA_SA_LABELS)查看该策略下的已存在的标签。
