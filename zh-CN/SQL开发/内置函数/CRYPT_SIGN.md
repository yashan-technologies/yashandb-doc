...
CRYPT_SIGN函数以[expr2](../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)为签名者需要提供的私钥、以[expr3](../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)为签名私钥的算法类型、以[expr4](../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)为签名者的签名ID对[expr1](../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)的数据进行签名，返回一个HEX格式的VARCHAR类型的签名串。
