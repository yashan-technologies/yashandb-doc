...
CRYPT_HMAC函数以[expr3](../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)为key、以[expr2](../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)为算法类型对[expr1](../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)进行HMAC计算，返回一个HEX格式的VARCHAR类型的HMAC摘要。
