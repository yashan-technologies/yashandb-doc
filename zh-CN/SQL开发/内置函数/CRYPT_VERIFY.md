...
CRYPT_VERIFY函数以[expr3](../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)为签名者需要提供的公钥、以[expr4](../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)为签名公钥的算法类型、以[expr5](../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)为签名者的签名ID对[expr1](../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)的数据和[expr2](../../全部手册/开发手册/SQL参考手册/通用SQL语法/expr)的签名进行验签，返回验签的结果TRUE或FALSE。
