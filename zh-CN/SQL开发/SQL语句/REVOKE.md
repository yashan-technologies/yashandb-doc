...
REVOKE用于对某一用户或角色收回授予其的权限，可收回的内容包括[系统特权SYSTEM PRIVILEGE](../../全部手册/产品安全/数据访问控制/特权与角色管理/系统特权)、[对象特权OBJECT PRIVILEGE](../../全部手册/产品安全/数据访问控制/特权与角色管理/对象特权)和[角色ROLE](../../全部手册/产品安全/数据访问控制/特权与角色管理/角色)。
...
对象的名称，需指定为已创建的表或[自定义类型](../../全部手册/开发手册/PL参考手册/PL对象/自定义类型)。
