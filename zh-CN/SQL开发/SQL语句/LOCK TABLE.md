...
```ebnf+diagram
syntax::= LOCK TABLE ([ schema"." ](../../全部手册/开发手册/SQL参考手册/SQL语句（yashan模式）/table | view)){","([ schema"." ](../../全部手册/开发手册/SQL参考手册/SQL语句（yashan模式）/table | view))} IN lockmode MODE[NOWAIT|(WAIT integer)]";"
```
