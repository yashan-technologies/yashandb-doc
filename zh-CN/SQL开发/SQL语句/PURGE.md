...
- 原表名（[DBA_RECYCLEBIN](../../全部手册/参考手册/系统视图/DBA视图/DBA_RECYCLEBIN)视图的ORIGINAL_NAME字段）

- 目标表进入回收站时系统生成的BIN开头对象名（[DBA_RECYCLEBIN](../../全部手册/参考手册/系统视图/DBA视图/DBA_RECYCLEBIN)视图的OBJECT_NAME字段）
...
- 原索引名（[DBA_RECYCLEBIN](../../全部手册/参考手册/系统视图/DBA视图/DBA_RECYCLEBIN)视图的ORIGINAL_NAME字段）

- 目标索引进入回收站时系统生成的BIN开头对象名（[DBA_RECYCLEBIN](../../全部手册/参考手册/系统视图/DBA视图/DBA_RECYCLEBIN)视图的OBJECT_NAME字段）
