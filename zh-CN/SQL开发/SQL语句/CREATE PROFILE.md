...
CREATE PROFILE用于创建一个profile，profile为系统对用户的一组资源限制的集合。在YashanDB中，profile可用于定义[密码使用策略](../../全部手册/产品安全/身份标识与鉴别/密码认证/密码策略.html#password_policy)相关、[会话资源](../../全部手册/产品安全/连接管理/管控会话资源)相关以及[连接请求IP](../../全部手册/产品安全/连接管理/管理IP黑白名单)相关限制。
...
定义[会话资源](../../全部手册/产品安全/连接管理/管控会话资源)相关的配置，同时定义多个参数以空格分隔。
...
定义[连接请求IP](../../全部手册/产品安全/连接管理/管理IP黑白名单)相关的配置，同时定义多个参数以空格分隔。
