...
- 异构数据库链接：YashanDB与Oracle的数据库链接，需要进行[dblink配置管理](../../全部手册/开发手册/SQL参考手册/通用SQL语法/dblink/dblink配置管理)
...
该语句用于指定创建的数据库链接的名称，不可省略，且需符合YashanDB的[对象命名规范](../../全部手册/开发手册/SQL参考手册/基本SQL元素/标识符)。
