...
通过[GV$PDBS](../../全部手册/参考手册/系统视图/动态视图/GV$PDBS)/[V$PDBS](../../全部手册/参考手册/系统视图/动态视图/V$PDBS)视图或yasql的`show pdbs`命令可以获取当前所有PDB信息。  
...
在共享集群/分布式集群部署中，无法将种子容器启动至MOUNT阶段。  

#### 2.3. OPEN

启动目标PDB至OPEN阶段。

在共享集群/分布式集群部署中，无法将种子容器启动至OPEN阶段。
