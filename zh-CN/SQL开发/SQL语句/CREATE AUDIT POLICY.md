...
对于审计管理更具体的描述请查阅[安全审计](../../全部手册/产品安全/安全审计/00安全审计)。
...
审计策略的名称，审计策略名称不可重复，不可省略，不可带模式名，且需符合YashanDB的[对象命名规范](../../全部手册/开发手册/SQL参考手册/基本SQL元素/标识符)。
...
指定具体的系统权限名称，具体权限项请查阅[系统特权](../../全部手册/产品安全/数据访问控制/特权与角色管理（yashan模式）/系统特权)中查看。
