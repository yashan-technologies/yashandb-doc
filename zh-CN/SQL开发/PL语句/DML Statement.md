...
在此种用法中，INSERT语句只能为[insert_values_clause](../../全部手册/开发手册/SQL参考手册/SQL语句/INSERT)语法，不可以为多行或者子查询插入。

在此种用法中，[returning_clause](../../全部手册/开发手册/SQL参考手册/SQL语句/INSERT)语法，不可返回变量。
...
在此种用法中，[returning_clause](../../全部手册/开发手册/SQL参考手册/SQL语句/UPDATE.html#returningclause)语法，不可返回变量。
