...
|  函数| 说明|
| ------------------------------------------------------------ | ---------------------- |
| [yacAllocHandle](../../全部手册/开发手册/C语言系驱动/C驱动/C驱动接口说明/句柄和描述符函数/yacAllocHandle) | 为句柄分配空间         |
| [yacFreeHandle](../../全部手册/开发手册/C语言系驱动/C驱动/C驱动接口说明/句柄和描述符函数/yacFreeHandle) | 释放句柄空间           |
| [yacConnect](../../全部手册/开发手册/C语言系驱动/C驱动/C驱动接口说明/连接、授权和初始化函数/yacConnect) | 客户端发起连接请求     |
| [yacDisconnect](../../全部手册/开发手册/C语言系驱动/C驱动/C驱动接口说明/连接、授权和初始化函数/yacDisconnect) | 客户端发起断开连接请求 |
...
如需了解更多的C接口信息以及应用示例，可参考[C驱动说明](../../全部手册/开发手册/C语言系驱动/C驱动/00C驱动)。
