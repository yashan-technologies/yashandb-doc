本章节将介绍YashanDB数据库中相关的基本语法和示例，更多SQL语法介绍请参考[SQL参考手册](../全部手册/开发手册/SQL参考手册/00SQL参考手册)。
...
YashanDB客户端工具还支持部署在Linux服务器上，请参考[YashanDB客户端安装](../全部手册/安装和升级/安装部署/YashanDB客户端安装/00YashanDB客户端安装)进行操作。
...
详细的事务管理请参考[事务管理](../全部手册/概念手册/事务机制/事务管理)。
