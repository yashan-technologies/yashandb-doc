...
| GV$MEX_AREA<br />V$MEX_AREA    | 新增     | 显示MEX内存池AREA部分的信息                          | 单机部署、共享集群部署、存算一体分布式集群部署  |
| GV$MEX_BASE<br />V$MEX_BASE    | 新增     | 显示MEX内存池BASE部分的信息                          | 单机部署、共享集群部署、存算一体分布式集群部署  |
| GV$MEX_EDEN<br />V$MEX_EDEN    | 新增     | 显示MEX内存池EDEN部分的信息                          | 单机部署、共享集群部署、存算一体分布式集群部署  |
| GV$MEX_POOL_MODULE<br />V$MEX_POOL_MODULE | 新增     | 显示MEX内存池各个功能模块的信息                      | 单机部署、共享集群部署、存算一体分布式集群部署  |
| GV$MEX_SESSION<br />V$MEX_SESSION | 新增     | 显示各个会话中MEX内存池的使用情况                  | 单机部署、共享集群部署、存算一体分布式集群部署  |
| GV$MEX_SESSION_MODULE<br />V$MEX_SESSION_MODULE | 新增     | 显示各个会话中MEX内存池各个功能模块的使用情况      | 单机部署、共享集群部署、存算一体分布式集群部署  |
