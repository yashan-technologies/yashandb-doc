...
10. 若为顺利执行扩容而临时调整过某些配置（例如关闭yasom仲裁选主），在扩容完成后应按需还原配置（例如重新[开启yasom仲裁选主](../../../高可用/自动选主配置/一主一备yasom仲裁选主.md)）。
...
7. 若为顺利执行缩容而临时调整过某些配置（例如关闭yasom仲裁选主），在缩容完成后应按需还原配置（例如重新[开启yasom仲裁选主](../../../高可用/自动选主配置/一主一备yasom仲裁选主.md)）。
