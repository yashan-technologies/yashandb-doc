...
- Database environment preparation before backup:
    ...
    - The catalog path must be created; please refer to [CREATE CATALOG](../../../All Manuals/Tools Guide/yasrman/User Guide for yasrman/CREATE CATALOG) for specific operations.
