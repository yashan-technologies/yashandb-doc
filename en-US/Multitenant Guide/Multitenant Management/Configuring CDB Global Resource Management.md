This chapter will introduce global resource management in CDBs. For PDB local resource management, please refer to [Configure Resource Management](../../All Manuals/Database Administration/Resource Management/Configuring Resource Management).
...
Call [DBMS_RESOURCE_MANAGER](../../All Manuals/Development Guide/PL Reference Manual/Built-in Advanced PL Packages/DBMS_RESOURCE_MANAGER).CREATE_CDB_PLAN to create a resource plan.
...
Call [DBMS_RESOURCE_MANAGER](../../All Manuals/Development Guide/PL Reference Manual/Built-in Advanced PL Packages/DBMS_RESOURCE_MANAGER).CREATE_CDB_PLAN_DIRECTIVE to create a resource plan directive.
...
1. Call [DBMS_RESOURCE_MANAGER](../../All Manuals/Development Guide/PL Reference Manual/Built-in Advanced PL Packages/DBMS_RESOURCE_MANAGER).CREATE_CDB_PROFILE_DIRECTIVE to create CDB resource template directives.
...
2. Call [DBMS_RESOURCE_MANAGER](../../All Manuals/Development Guide/PL Reference Manual/Built-in Advanced PL Packages/DBMS_RESOURCE_MANAGER).SET_PDB_PROFILE to set the mapping relationship between PDB and CDB resource template directives.
...
After successfully enabling the CDB global resource management function through the above example, [local resource management configuration](../../All Manuals/Database Administration/Resource Management/Configuring Resource Management) can also be performed by directly connecting to PDBs as needed.

## View CDB Resource Configuration

All CDB resource plans can be queried through the [DBA_CDB_RSRC_PLANS](../../All Manuals/Reference Manual/System Views/DBA Views/DBA_CDB_RSRC_PLANS) view.
...
All CDB resource plan directives can be viewed through the [DBA_CDB_RSRC_PLAN_DIRECTIVES](../../All Manuals/Reference Manual/System Views/DBA Views/DBA_CDB_RSRC_PLAN_DIRECTIVES) view.
...
The resource usage of all PDBs can be viewed through [V$RSRC_PDB](../../All Manuals/Reference Manual/System Views/Dynamic Performance Views/V$RSRC_PDB).
