...
| MAX_PDBS                  | Specify the maximum number of PDBs that can be created. | [0,8190], default is 256 | Adjust as needed |
...
- PDB syntax mode
    ...
    According to SQL syntax compatibility preferences, PDBs can be configured as yashan mode (more compatible with Oracle) or mysql mode (more compatible with MySQL) as needed. For detailed compatibility introductions, please refer to [Compatibility Description](../../../../All Manuals/Product Overview/Compatibility/00Compatibility).