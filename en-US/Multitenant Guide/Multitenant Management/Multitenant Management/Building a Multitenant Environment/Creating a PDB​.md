Creating a PDB requires operating on the CDB root in OPEN state. PDBs can be created through the [CREATE PLUGGABLE DATABASE](../../../../All Manuals/Development Guide/SQL Reference Manual/SQL Statements/CREATE PLUGGABLE DATABASE) statement or the [yasboot pdb add](../../../../All Manuals/Tools Guide/yasboot/Introduction to yasboot Command/yasboot pdb) command.
