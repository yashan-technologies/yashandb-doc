The CREATE_PGR_CREATETOPOLOGY package provides built-in stored procedures for processing GIS data.
...
This procedure is used to create the built-in procedure `pgr_createTopology`, which takes no input parameters.
