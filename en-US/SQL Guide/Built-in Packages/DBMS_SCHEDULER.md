The DBMS_SCHEDULER package provides a set of built-in stored procedures for creating and managing [scheduled jobs](../../All Manuals/Development Guide/PL Reference Manual/PL Objects/Scheduled Jobs).
...
| :------------------ | :----------------------------------------------------------- |
| job_name            | The name of the scheduled job, which can be in the schema.job_name format and must comply with YashanDB's [object naming conventions](../../All Manuals/Development Guide/SQL Reference Manual/Basic SQL Elements/Identifiers). |
