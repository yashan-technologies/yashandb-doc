...
- NUMBER_TABLE type: Represents a datatype of NUMBER type + index_datatype of INTEGER type [associative array](../../All Manuals/Development Guide/PL Reference Manual/PL Language Fundamentals/Variables/Collection Variables) (INDEX-BY TABLE).
