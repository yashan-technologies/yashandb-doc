...
| :---- |:-----------|
| options | Cleanup options. CLEANUP_ORPHANS: indicates using coalesce cleanup only. COALESCE: indicates using coalesce cleanup. For details, refer to [COALESCE](../SQL Statements/ALTER INDEX.html#coalesce) |
