The DBMS_ROWID package provides a set of built-in functions to obtain the data block number (blockId), relative file number (fileId), and row directory information of a [ROWID](../../All Manuals/Development Guide/SQL Reference Manual/Data Types (yashan Mode)/ROWID and UROWID Types).
