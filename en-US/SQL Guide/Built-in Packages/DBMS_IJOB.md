The DBMS_IJOB package provides a set of built-in stored procedures for creating and managing [scheduled jobs](../../All Manuals/Development Guide/PL Reference Manual/PL Objects/Scheduled Jobs) for a specified user. It is important to note that all operations performed on scheduled jobs by invoking these stored procedures will take effect only after executing COMMIT.
