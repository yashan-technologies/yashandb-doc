...
CREATE PROFILE is used to create a profile, which is a collection of resource limits imposed by the system on users. In YashanDB, profiles can define limitations related to [password usage policies](../../All Manuals/Product Security/Identity Identification and Authentication/Password Authentication/Password Policy (yashan Mode).html#password_policy), [session resources](../../All Manuals/Product Security/Resource Control/Session Resource Control), and [connection request IPs](../../All Manuals/Product Security/Connection Management/IP Blacklist and Whitelist Management).
...
Defines configurations related to [password usage policies](../../All Manuals/Product Security/Identity Identification and Authentication/Password Authentication/Password Policy (yashan Mode).html#password_policy), including password policy parameters and their values, with multiple parameters defined separated by spaces.
