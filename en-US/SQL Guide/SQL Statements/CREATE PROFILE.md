...
CREATE PROFILE is used to create a profile, which is a collection of resource limits imposed by the system on users. In YashanDB, profiles can define limitations related to [password usage policies](../../All Manuals/Product Security/Identity Identification and Authentication/Password Authentication/Password Policy.html#password_policy), [session resources](../../All Manuals/Product Security/Resource Control/Session Resource Control), and [connection request IPs](../../All Manuals/Product Security/Connection Management/IP Blacklist and Whitelist Management).
...
```ebnf+diagram
syntax::= CREATE PROFILE profile_name LIMIT (password_parameters | resource_parameters | tcp_ip_parameters) {" " (password_parameters | resource_parameters | tcp_ip_parameters)} [CONTAINER "=" (CURRENT|ALL)]
```
...
The profile name is mandatory and must comply with YashanDB's [object naming specifications](../../All Manuals/Development Guide/SQL Reference Manual/Basic SQL Elements/Identifiers).
...
Defines configurations related to [password usage policies](../../All Manuals/Product Security/Identity Identification and Authentication/Password Authentication/Password Policy.html#password_policy), including password policy parameters and their values, with multiple parameters defined separated by spaces.
...
Defines configurations related to [session resources](../../All Manuals/Product Security/Resource Control/Session Resource Control), with multiple parameters defined separated by spaces.
...
Defines configurations related to [connection request IPs](../../All Manuals/Product Security/Connection Management/IP Blacklist and Whitelist Management), with multiple parameters defined separated by spaces.
