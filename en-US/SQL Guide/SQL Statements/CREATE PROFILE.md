...
CREATE PROFILE is used to create a profile, which is a collection of resource limits imposed by the system on users. In YashanDB, profiles can define limitations related to [password usage policies](../../All Manuals/产品安全/身份标识与鉴别/密码认证/密码策略.html#password_policy), [session resources](../../All Manuals/产品安全/连接管理/管控会话资源), and [connection request IPs](../../All Manuals/产品安全/连接管理/管理IP黑白名单).
...
Defines configurations related to [session resources](../../All Manuals/产品安全/连接管理/管控会话资源), with multiple parameters defined separated by spaces.
...
Defines configurations related to [connection request IPs](../../All Manuals/产品安全/连接管理/管理IP黑白名单), with multiple parameters defined separated by spaces.
