...
- The original table name (the ORIGINAL_NAME column in the [DBA_RECYCLEBIN](../../All Manuals/参考手册/系统视图/DBA视图/DBA_RECYCLEBIN) view)

- The BIN$-prefixed system-generated object name (the OBJECT_NAME column in the [DBA_RECYCLEBIN](../../All Manuals/参考手册/系统视图/DBA视图/DBA_RECYCLEBIN) view) when the target table entered the recycle bin
