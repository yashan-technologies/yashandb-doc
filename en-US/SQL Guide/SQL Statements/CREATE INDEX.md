...
- Columns of type [LOB](../../All Manuals/Development Guide/SQL Reference Manual/数据类型/大对象型) or [UDT](../../All Manuals/Development Guide/SQL Reference Manual/数据类型/用户自定义类型) cannot be used as index columns.

- Columns of type [RAW](../../All Manuals/Development Guide/SQL Reference Manual/数据类型/RAW) cannot be used as columnar index columns.
