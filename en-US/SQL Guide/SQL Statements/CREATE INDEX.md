...
- RTree indexes can only be created for columns of [ST_Geometry type](../../All Manuals/Development Guide/SQL Reference Manual/Data Types/ST_GEOMETRY Type), and each RTree index can only specify one column.
...
- [LOB type](../../All Manuals/Development Guide/SQL Reference Manual/Data Types/Large Object Types) columns cannot be used as index columns.

- Only RTree indexes can be created on columns of [ST_Geometry type](../../All Manuals/Development Guide/SQL Reference Manual/Data Types/ST_GEOMETRY Type), and each RTree index can only specify one column.
