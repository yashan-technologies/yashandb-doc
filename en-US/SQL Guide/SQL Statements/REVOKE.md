...
REVOKE is used to revoke privileges granted to a user or role. The revocable items include [system privilege SYSTEM PRIVILEGE](../../All Manuals/Product Security/Data Access Control/Privilege and Role Management (yashan Mode)/System Privileges), [object privilege OBJECT PRIVILEGE](../../All Manuals/Product Security/Data Access Control/Privilege and Role Management (yashan Mode)/Object Privileges), and [role ROLE](../../All Manuals/Product Security/Data Access Control/Privilege and Role Management (yashan Mode)/Roles).
...
YashanDB supports revoking roles granted to roles in standalone and YAC Deployment; attempting this in ISC Distributed Cluster Deployment will result in an error.
...
For specific details on the privilege management system in YashanDB, please refer to [Privilege and Role Management](../../All Manuals/Product Security/Data Access Control/Privilege and Role Management (yashan Mode)/00Privilege and Role Management (yashan Mode)).
