...
This statement specifies the name of the restore point to be created, which is mandatory. The name must be globally unique and comply with YashanDB's [naming conventions](../../All Manuals/Development Guide/SQL Reference Manual/Basic SQL Elements/Identifiers).
