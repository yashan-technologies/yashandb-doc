...
DROP PROCEDURE is used to delete an existing [stored procedure](../../All Manuals/Development Guide/PL Reference Manual/PL Objects/Stored Procedures).

Regular users can only delete stored procedures they have created.
