...
- Heterogeneous database link: Database link between YashanDB and Oracle, which requires [heterogeneous database link configuration](../../All Manuals/Development Guide/SQL Reference Manual/通用SQL语法/dblink/dblink配置管理)
