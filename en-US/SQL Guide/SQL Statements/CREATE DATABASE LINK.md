...
- Heterogeneous database link: Database link between YashanDB and Oracle, which requires [heterogeneous database link configuration](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/dblink/Example of DBLINK)
