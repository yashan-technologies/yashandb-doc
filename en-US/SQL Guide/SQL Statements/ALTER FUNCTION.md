...
For the meaning and limitations of UDF, please refer to the [UDF](../../All Manuals/Development Guide/PL Reference Manual/PL Objects/User-Defined Functions) section.  
...
Specifies the recompilation options; see the [compile_clause](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/compile_clause) description for details.  
