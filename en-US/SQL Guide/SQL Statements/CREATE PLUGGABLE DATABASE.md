...
Specifies the name of the PDB to be created, which cannot be omitted and must comply with YashanDB's [object naming conventions](../../All Manuals/Development Guide/SQL Reference Manual/Basic SQL Elements/Identifiers).
...
| YAC/Distributed Cluster Deployment | +DG0/containers/{pdb_name}        |  Must be a [YFS](../../All Manuals/Database Administration/Storage Management/YFS Management/00YFS Management) path    |
...
- [mysql mode](../../All Manuals/Reference Manual of mysql Mode/Overview of mysql Mode): SQL statements input by users will be parsed according to MySQL's syntax system first, suitable for usage scenarios that require close adaptation to MySQL databases.  
