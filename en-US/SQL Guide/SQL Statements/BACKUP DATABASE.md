...
In YAC Deployment, specifying a [YFS](../../All Manuals/YashanDB for Cluster/Yashan File System/00Yashan File System) path allows data to be backed up to shared storage; specifying a regular disk path backs data up to the server where the instance resides.
