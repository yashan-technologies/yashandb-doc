...
```ebnf+diagram
syntax::= ALTER PROFILE profile_name LIMIT  (password_parameters | resource_parameters | tcp_ip_parameters) {" " (password_parameters | resource_parameters | tcp_ip_parameters)} [CONTAINER "=" (CURRENT|ALL)]
```
