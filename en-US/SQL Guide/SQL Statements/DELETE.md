...
This statement indicates that the table to be deleted is a remote table; for detailed explanation, see [dblink](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/dblink/Syntax Definition of DBLINK).
