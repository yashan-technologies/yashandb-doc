...
This statement is used to specify the object from which records will be deleted, which may include table names (including local database tables or [remote tables](../../All Manuals/Development Guide/SQL Reference Manual/通用SQL语法/dblink/dblink语法说明)), partition names of tables, or view names.
...
This statement indicates that the table to be deleted is a remote table; for detailed explanation, see [dblink](../../All Manuals/Development Guide/SQL Reference Manual/通用SQL语法/dblink/dblink语法说明).
