...
Current PDB information can be obtained through the [GV$PDBS](../../All Manuals/Reference Manual/System Views/Dynamic Performance Views/GV$PDBS)/[V$PDBS](../../All Manuals/Reference Manual/System Views/Dynamic Performance Views/V$PDBS) views or the `show pdbs` command in *yasql*.  
