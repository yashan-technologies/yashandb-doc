...
The name of the SQL mapping to be created. This name must be globally unique, cannot duplicate existing SQL mapping names, cannot include a schema name specification, and must comply with YashanDB's [object naming conventions](../../All Manuals/Development Guide/SQL Reference Manual/Basic SQL Elements/Identifiers).
