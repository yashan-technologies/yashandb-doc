...
In the event of node failures while deleting a tablespace in ISC Distributed Cluster Deployment, recovery measures can be found in the [User Tablespace Management](../../All Manuals/数据库管理/存储管理/逻辑空间管理/表空间管理/用户表空间管理) chapter.
