...
This statement is used to specify the location of the directory to be created. It supports specifying local file paths and YFS file paths (refer to [YFS File Management](../../All Manuals/YashanDB for Cluster/Yashan File System/File Management) for YFS file paths).
