...
This statement is used to specify the location of the directory to be created. It supports specifying local file paths and YFS file paths (refer to [YFS File Management](../../All Manuals/数据库管理/存储管理/集群文件系统管理/文件管理) for YFS file paths).
