...
- The original index name (the ORIGINAL_NAME column in the [DBA_RECYCLEBIN](../../All Manuals/Reference Manual/System Views/DBA Views/DBA_RECYCLEBIN) view)

- The BIN$-prefixed system-generated object name (the OBJECT_NAME column in the [DBA_RECYCLEBIN](../../All Manuals/Reference Manual/System Views/DBA Views/DBA_RECYCLEBIN) view) when the target index entered the recycle bin
