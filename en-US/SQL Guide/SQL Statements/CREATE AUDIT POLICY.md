...
For a more specific description of audit management, please refer to [Security Audit](../../All Manuals/Product Security/Security Audit/00Security Audit).
...
The name of the audit policy. The audit policy name must be unique, cannot be omitted, cannot include a schema name, and must conform to YashanDB's [object naming conventions](../../All Manuals/Development Guide/SQL Reference Manual/Basic SQL Elements/Identifiers).
...
Specifies specific system privilege names. For details on specific privilege items, please refer to [System Privileges](../../All Manuals/Product Security/Data Access Control/Privilege and Role Management (yashan Mode)/System Privileges).
