...
- In YAC/Distributed Cluster Deployment, this statement must be executed on the master instance (where INSTANCE_ROLE = MASTER_ROLE in the [GV$INSTANCE](../../All Manuals/Reference Manual/System Views/Dynamic Performance Views/GV$INSTANCE) view).
