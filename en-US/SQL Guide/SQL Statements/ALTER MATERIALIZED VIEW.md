...
- ON DEMAND: Manual refresh, i.e., refresh via the [DBMS_MVIEW](../../All Manuals/Development Guide/PL Reference Manual/Built-in Advanced PL Packages/DBMS_MVIEW) advanced package
