...
```ebnf+diagram
syntax::= LOCK TABLE ([ schema"." ](../../All Manuals/Development Guide/SQL Reference Manual/SQL Statements/table | view)){","([ schema"." ](../../All Manuals/Development Guide/SQL Reference Manual/SQL Statements/table | view))} IN lockmode MODE[NOWAIT|(WAIT integer)]";"
```
