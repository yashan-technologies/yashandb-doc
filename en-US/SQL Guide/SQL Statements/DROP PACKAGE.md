...
The DROP PACKAGE command is used to delete an existing [package](../../All Manuals/Development Guide/PL Reference Manual/PL Objects/Packages).

Regular users can only delete the advanced packages they have created.
