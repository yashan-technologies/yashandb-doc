General Description
----
CREATE ACCESS CONSTRAINT is used to create an [AC object](../../All Manuals/Development Guide/SQL Reference Manual/Basic SQL Elements/Schema Objects) on a specified table. This statement can only create AC objects based on LSC tables, and the LSC table cannot be a composite partition table or an INTERVAL type partition table.
...
This statement is used to specify the name of the created AC, which is mandatory and must comply with YashanDB's [object naming convention](../../All Manuals/Development Guide/SQL Reference Manual/Basic SQL Elements/Identifiers).
