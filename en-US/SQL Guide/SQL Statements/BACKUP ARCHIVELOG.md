...
For detailed operational descriptions on backup recovery, please refer to [Backup and Recovery](../../All Manuals/Database Administration/Backup and Recovery/00Backup and Recovery).
...
In YAC/Distributed Cluster Deployment, by specifying the [YFS](../../All Manuals/Database Administration/Storage Management/YFS Management/00YFS Management) path, data can be backed up to shared storage; when specified as a regular disk path, the data is backed up to the server where the instance is located.
