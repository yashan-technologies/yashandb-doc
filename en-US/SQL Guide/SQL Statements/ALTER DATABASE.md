...
If you wish to use the [Ystream service](../../All Manuals/Development Guide/PL Reference Manual/Built-in Advanced PL Packages/DBMS_YSTREAM_ADM), you must first enable supplemental logging (either at the library or table level) before creating the Ystream service; otherwise, it will result in an error.
