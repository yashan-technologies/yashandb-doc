...
CREATE USER is used to create a new database user. For the user management system of YashanDB, please refer to [User Management](../../All Manuals/Product Security/Identity Identification and Authentication/Managing Users).
