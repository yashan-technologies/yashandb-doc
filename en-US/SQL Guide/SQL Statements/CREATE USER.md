...
CREATE USER is used to create a new database user. The system by default creates a regular user. For the user management system of YashanDB, please refer to the Product Security Manual [User Management](../../All Manuals/Product Security/Identity Identification and Authentication/Managing Users).
...
* Must comply with the [password strength](../../All Manuals/Product Security/Identity Identification and Authentication/Password Authentication/Password Policy.html#password_complexity) and [password policy](../../All Manuals/Product Security/Identity Identification and Authentication/Password Authentication/Password Policy.html#password_policy) requirements.
