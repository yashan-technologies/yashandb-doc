...
CREATE USER is used to create a new database user. The system by default creates a regular user. For the user management system of YashanDB, please refer to the Product Security Manual [User Management](../../All Manuals/Product Security/Identity Identification and Authentication/User/00User).
...
This statement is used to specify the name of the user to be created. It is mandatory and must comply with YashanDB's [object naming conventions](../../All Manuals/Development Guide/SQL Reference Manual/Basic SQL Elements/Identifiers).
...
* Must comply with the [password strength](../../All Manuals/Product Security/Identity Identification and Authentication/Password Authentication/Password Policy (yashan Mode).html#password_complexity) and [password policy](../../All Manuals/Product Security/Identity Identification and Authentication/Password Authentication/Password Policy (yashan Mode).html#password_policy) requirements.
