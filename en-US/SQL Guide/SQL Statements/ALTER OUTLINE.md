...
Renames the OUTLINE. The new OUTLINE name cannot include a schema name and must comply with YashanDB's [object naming conventions](../../All Manuals/Development Guide/SQL Reference Manual/Basic SQL Elements/Identifiers).

### 5. CHANGE CATEGORY TO category\_name

Changes the category of the OUTLINE. The category name can be either an existing one or a new one, cannot include a schema name, and must comply with YashanDB's [object naming conventions](../../All Manuals/Development Guide/SQL Reference Manual/Basic SQL Elements/Identifiers).
