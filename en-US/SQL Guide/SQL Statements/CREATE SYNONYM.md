...
This clause is used to specify the name of the synonym to be created. It is mandatory and must comply with YashanDB's [Object Naming Conventions](../../All Manuals/Development Guide/SQL Reference Manual/Basic SQL Elements/Identifiers).
