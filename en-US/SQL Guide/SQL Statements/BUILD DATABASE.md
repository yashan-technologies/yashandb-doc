...
- Directly connecting to PDB and executing BUILD DATABASE: Only construct the corresponding standby PDB
  ...
  Additionally, standby PDB(s) construction can also be performed by connecting to the CDB root and executing [BUILD PLUGGABLE DATABASE](../../All Manuals/Development Guide/SQL Reference Manual/Development Guide/SQL Reference Manual/SQL Statements/BUILD PLUGGABLE DATABASE) for global operations.
