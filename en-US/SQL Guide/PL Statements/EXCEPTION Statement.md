...
The exception name may be a system-defined exception name or a user-defined exception name. For specific descriptions, see [Exception Handling](../../All Manuals/Development Guide/PL Reference Manual/PL Exception Handling) documentation.
