...
Where v_result can be a variable, constant, or expression.

This statement cannot be omitted, meaning that every execution path in the procedure (branches of control statements, branches of exception handling units) must include at least one RETURN Statement, and v_result cannot be omitted, but the value of v_result can be NULL.
