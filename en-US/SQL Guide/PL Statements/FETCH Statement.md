The FETCH Statement is a value retrieval statement for [cursors](../../All Manuals/Development Guide/PL Reference Manual/PL Language Fundamentals/Variables/Cursors). The method for retrieving values for explicit cursors and dynamic cursors is consistent, and the format is as follows:
