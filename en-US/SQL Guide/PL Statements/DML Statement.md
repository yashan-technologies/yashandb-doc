...
Under this usage, the INSERT statement can only use the [insert_values_clause](../../All Manuals/Development Guide/SQL Reference Manual/SQL Statements (yashan Mode)/INSERT) syntax, not for multi-row or subquery inserts.

In this usage, the [returning_clause](../../All Manuals/Development Guide/SQL Reference Manual/SQL Statements (yashan Mode)/INSERT) syntax cannot return variables.
...
In this usage, the [returning_clause](../../All Manuals/Development Guide/SQL Reference Manual/SQL Statements (yashan Mode)/UPDATE.html#returningclause) syntax cannot return variables.
