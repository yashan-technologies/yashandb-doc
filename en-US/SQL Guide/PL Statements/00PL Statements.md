...
An expression in PL is a combination of one or more values, operators, and SQL functions, resulting in a single value. For more details, see [Expressions](../../All Manuals/Development Guide/PL Reference Manual/PL Language Fundamentals/Expressions).
