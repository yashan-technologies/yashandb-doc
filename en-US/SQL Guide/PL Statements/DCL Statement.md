...
The syntax for COMMIT/ROLLBACK can be referenced in the corresponding SQL statements ([COMMIT](../SQL Statements/COMMIT) and [ROLLBACK](../SQL Statements/ROLLBACK)), but the FORCE clause cannot be used in PL statements.
