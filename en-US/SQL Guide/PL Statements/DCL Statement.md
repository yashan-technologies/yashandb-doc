...
The syntax for COMMIT/ROLLBACK can be referenced in the corresponding SQL statements ([COMMIT](../../All Manuals/Development Guide/SQL Reference Manual/SQL Statements/COMMIT) and [ROLLBACK](../../All Manuals/Development Guide/SQL Reference Manual/SQL Statements/ROLLBACK)), but the FORCE clause cannot be used in PL statements.
