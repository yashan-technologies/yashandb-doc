...
a1,a2... are variables or constants as [bind parameters](../../All Manuals/Development Guide/PL Reference Manual/Parameters/Binding Parameters).
...
For the RETURING syntax, please refer to [UPDATE](../../All Manuals/Development Guide/SQL参考手册/SQL语句（yashan模式）/UPDATE.html#returningclause).
