...
The TO_BASE64 function encodes the string represented by [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) using BASE64 and returns the encoded VARCHAR type string data.
