...
The VARIANCE function calculates the sample variance of [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr).
...
The syntax for the KEEP aggregate function is generic; for details refer to [KEEP aggregate function](../../All Manuals/Development Guide/SQL Reference Manual/Built-in Functions (yashan Mode)/00Built-in Functions (yashan Mode).html#KeepAggregateFunction).
