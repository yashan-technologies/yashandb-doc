...
The SUBSTRING_INDEX function is used to extract the substring from the source string [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) before the delim separator appears for the count-th time.
