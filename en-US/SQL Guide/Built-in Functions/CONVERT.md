...
```
The CONVERT function is used to convert the expression [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) from the source_char_set character set to the dest_char_set character set.
...
- It must be a character set supported by YashanDB [Character Set Configuration](../../All Manuals/Database Administration/Instance Management/Database Character Set Configuration); otherwise, an error will be raised.
