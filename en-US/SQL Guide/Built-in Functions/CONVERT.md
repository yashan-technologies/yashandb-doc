...
- It must be a character set supported by YashanDB [Character Set Configuration](../../All Manuals/Database Administration/Basic Database Management/Character Set Configuration); otherwise, an error will be raised.
