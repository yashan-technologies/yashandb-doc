...
The NLSSORT function sorts the values of [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) according to the specified collation, generating a VARCHAR type sorting key.
