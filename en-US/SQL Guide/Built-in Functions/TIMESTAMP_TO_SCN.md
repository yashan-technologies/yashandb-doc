...
The TIMESTAMP_TO_SCN function converts the SCN data represented by [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) into an SCN number.
