...
LEAST finds the smallest value from multiple [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) parameter values and returns the result according to the data type of the first parameter. The rules are as follows:
