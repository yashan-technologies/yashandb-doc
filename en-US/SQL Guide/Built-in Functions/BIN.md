...
The BIN function converts a data represented by [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) into a BIT binary and returns that BIT value as a VARCHAR type.
