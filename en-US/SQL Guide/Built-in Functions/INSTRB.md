...
```
The INSTRB function starts searching for the target string sub_character from the position byte of the source string [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) and returns the position value of the occurrence of sub_character for the occurrence-th time. The return value is of BIGINT type. If not found, it returns 0.
