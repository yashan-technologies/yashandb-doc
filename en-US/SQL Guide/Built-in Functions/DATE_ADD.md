...
The DATE_ADD function is used to perform date calculations by adding the value of [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) to a given interval value, resulting in a time advancement or regression.
