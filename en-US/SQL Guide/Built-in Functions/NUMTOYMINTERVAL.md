...
The NUMTOYMINTERVAL function converts numeric data represented by [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) to an INTERVAL YEAR TO MONTH type value, excluding BIT data type.
