...
The SCN_TO_TIMESTAMP function converts the SCN number represented by [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) into SCN data.
