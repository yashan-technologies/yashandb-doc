...
The LAST_INSERT_ID function is used to obtain the latest auto-increment value in the current session or to convert the parameter [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) to BIGINT type.
