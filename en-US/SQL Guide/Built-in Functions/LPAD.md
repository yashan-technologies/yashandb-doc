...
The LPAD function pads the value of [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) from the left with a specified character and a specified length, resulting in a new string.
