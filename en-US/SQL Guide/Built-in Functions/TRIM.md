...
The TRIM function is used to remove the prefix or suffix from the source string [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) and returns a new substring.
