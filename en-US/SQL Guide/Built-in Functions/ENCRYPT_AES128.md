...
The ENCRYPT_AES128 function encrypts the plaintext [expr1](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) using [expr2](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) as the key and returns an encrypted value of type VARCHAR.
