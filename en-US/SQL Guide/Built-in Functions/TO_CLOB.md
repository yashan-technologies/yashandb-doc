...
The TO_CLOB function converts the character set of the [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) data source to the database character set and returns it as a CLOB value.
