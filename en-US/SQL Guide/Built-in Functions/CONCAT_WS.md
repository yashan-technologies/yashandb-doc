...
The CONCAT_WS function concatenates the values of multiple [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) using the separator, returning a concatenated string.
