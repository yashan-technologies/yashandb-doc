...
The INITCAP function splits the string represented by [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) into words and converts the initial letters of the separated words to uppercase, while the other letters are converted to lowercase.
