...
The RTRIM function removes content that matches trim_character from the string represented by [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) from right to left, resulting in a new substring.
