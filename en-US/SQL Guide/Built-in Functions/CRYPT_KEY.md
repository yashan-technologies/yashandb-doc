...
The CRYPT_KEY function creates a corresponding algorithm key based on the algorithm type specified by [expr1](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) and returns a key or key pair in HEX format as VARCHAR type.
