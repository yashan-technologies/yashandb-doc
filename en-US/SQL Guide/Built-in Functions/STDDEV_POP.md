...
The STDDEV_POP function calculates the population standard deviation of the value of [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr).
