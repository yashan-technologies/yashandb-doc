...
The TRUNC function truncates the value of [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) of a date value to a specified format, or truncates a numeric value to a specified number of digits, returning a DATE type date value or a NUMBER type numeric value.
