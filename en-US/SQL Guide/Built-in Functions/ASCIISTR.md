...
The ASCIISTR function converts the string represented by [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) to its ASCII-encoded version in the database character set and returns it. Non-ASCII characters will be converted to the form \xxxx, where xxxx represents the UTF-16 code unit.
