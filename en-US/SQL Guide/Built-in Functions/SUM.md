...
The SUM function calculates the numerical sum of the given parameter [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr), with the following return value types:
...
When the OVER keyword is specified, SUM will function as a [window function](../../All Manuals/Development Guide/SQL Reference Manual/Built-in Functions (yashan Mode)/00Built-in Functions (yashan Mode).html#WindowFunction), supporting sliding windows and returning the numerical sum for multiple rows.
...
General syntax for KEEP aggregate functions. For details, please refer to [KEEP aggregate function](../../All Manuals/Development Guide/SQL Reference Manual/Built-in Functions (yashan Mode)/00Built-in Functions (yashan Mode).html#KeepAggregateFunction).
