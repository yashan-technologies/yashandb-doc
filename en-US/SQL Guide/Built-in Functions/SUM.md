...
When the OVER keyword is specified, SUM will function as a [window function](00Built-in Functions.html#WindowFunction), supporting sliding windows and returning the numerical sum for multiple rows.
...
General syntax for KEEP aggregate functions. For details, please refer to [KEEP aggregate function](00Built-in Functions.html#KeepAggregateFunction).
