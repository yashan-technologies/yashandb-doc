...
The MEDIAN function calculates the median of the given parameter [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr). It only supports expr types of [numeric](../../All Manuals/Development Guide/SQL Reference Manual/数据类型/数值型) or [date-time](../../All Manuals/Development Guide/SQL Reference Manual/数据类型/日期时间型). Using other data types will result in an error.
