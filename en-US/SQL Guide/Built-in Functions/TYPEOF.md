...
The TYPEOF function retrieves the data type of the [expr1](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) parameter and returns it as a VARCHAR type string.
