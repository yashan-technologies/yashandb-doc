...
The UPPER function is used to convert lowercase letters in the source string [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) to uppercase letters, returning a new string that has been converted.
