...
When the OVER keyword is specified, AVG functions as a [window function](../../All Manuals/Development Guide/SQL Reference Manual/Built-in Functions (yashan Mode)/00Built-in Functions (yashan Mode).html#WindowFunction) and supports sliding windows, returning the average values of multiple rows.

**analytic_clause**

General syntax for window functions, for details see [window function](../../All Manuals/Development Guide/SQL Reference Manual/Built-in Functions (yashan Mode)/00Built-in Functions (yashan Mode).html#WindowFunction).
...
The general syntax for KEEP aggregate functions can be found in [KEEP aggregate function](../../All Manuals/Development Guide/SQL Reference Manual/Built-in Functions (yashan Mode)/00Built-in Functions (yashan Mode).html#KeepAggregateFunction).
