...
The RIGHT function extracts a substring from the right side of the string represented by [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) for the specified length and returns it.
