...
```
The GROUPING function is used to mark whether the field [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) is the key value of the group for each row in a grouped aggregate result.
...
This function must be used in conjunction with the GROUP BY [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr)/ROLLUP/CUBE/GROUPING SETS statements, and DISTINCT cannot be used within the function.
