...
The CRYPT_SIGN function uses [expr2](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) as the private key to be provided by the signer, [expr3](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) as the algorithm type for the signing private key, and [expr4](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) as the signature ID of the signer to sign the data [expr1](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr), returning a signature string in HEX format of VARCHAR type.
...
>
> If you need to use this function and OpenSSL tools, please refer to [Dependencies Preparation](../../All Manuals/Installation and Upgrade/Installation and Deployment/Pre-Installation Preparation/Preparing Dependencies) to check and ensure that the required tools are installed on the server system.
>
