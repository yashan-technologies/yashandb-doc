...
ORA_HASH is a function that computes the hash value of a given expression [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) and returns a result of type NUMBER.
