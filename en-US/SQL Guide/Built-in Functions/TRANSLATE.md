...
- Usage 1: It is used to replace each character in the from_string with the corresponding character in the to_string, one-to-one, from the source string [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr), returning a new string.
