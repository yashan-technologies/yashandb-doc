...
The ROWIDTOCHAR function converts the ROWID type data represented by [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) to a VARCHAR type string data.
