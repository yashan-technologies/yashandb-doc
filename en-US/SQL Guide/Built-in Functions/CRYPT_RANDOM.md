...
The CRYPT_RANDOM function generates a secure random number of a specified bit length using [expr1](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) as the parameter for the bit length, and returns a random number sequence in HEX format as a VARCHAR type.
