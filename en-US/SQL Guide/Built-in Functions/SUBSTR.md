...
The SUBSTR function is used to extract a substring of length len from the source string [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) starting at the position pos.
