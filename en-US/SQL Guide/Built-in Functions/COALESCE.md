...
The COALESCE function finds the first non-null expr value among multiple [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) values and returns it. If none is found, it returns NULL. The minimum number of expr values is 2, and the maximum is 100.
