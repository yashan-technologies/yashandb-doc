...
This function will only take effect when the [character set](../../All Manuals/Database Administration/Instance Management/Database Character Set Configuration) configured for the database simultaneously includes both single-byte and multi-byte characters.
