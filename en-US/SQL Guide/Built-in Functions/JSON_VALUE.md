...
The path expression is a constant string, and its format definition can be referred to in the [json](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/json) documentation.
