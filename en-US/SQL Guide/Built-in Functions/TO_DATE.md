...
The TO_DATE function converts the value of [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) to a DATE type data, and the return value is in the default format of DATE type data.
...
Indicates that when the conversion of expr fails, use the value of replace_expr for conversion, where replace_expr is a string literal that must conform to the format.
