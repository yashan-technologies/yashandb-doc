...
[General Expression](../../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr), the value must be valid ST_GEOMETRY type data, and must follow the rules below:
