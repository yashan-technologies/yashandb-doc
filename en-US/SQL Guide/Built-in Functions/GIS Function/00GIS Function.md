...
- Except for the ST_DISTANCE_SPHERE function, which is applicable to all deployment forms and all table types, other functions are only applicable to HEAP tables in Standalone Deployment and YAC Deployment.
