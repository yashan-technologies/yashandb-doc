...
[General Expression](../../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr), which must be a valid DOUBLE type value, represents longitude, with a valid range of [-180,180]; otherwise, it returns NULL.

**lat**

[General Expression](../../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr), which must be a valid DOUBLE type value, represents latitude, with a valid range of [-90,90]; otherwise, it returns NULL.
