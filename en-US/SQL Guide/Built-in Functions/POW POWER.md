...
The POW/POWER function calculates the *exp* power of the parameter value of [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr), and its return type is as follows:
