...
The MIN function calculates the minimum value of the given parameter [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr).
...
When the OVER keyword is specified, MIN will act as a [window function](../../All Manuals/Development Guide/SQL Reference Manual/Built-in Functions (yashan Mode)/00Built-in Functions (yashan Mode).html#WindowFunction) and supports sliding windows, returning the minimum value across multiple rows.
...
KEEP aggregate function general syntax, please refer to [KEEP aggregate function](../../All Manuals/Development Guide/SQL Reference Manual/Built-in Functions (yashan Mode)/00Built-in Functions (yashan Mode).html#KeepAggregateFunction).
