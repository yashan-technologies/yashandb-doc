...
The NULLIF function is used to compare the values of [expr1](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) and [expr2](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr). It returns NULL when they are equal, and returns the value of expr1 when they are not equal.
