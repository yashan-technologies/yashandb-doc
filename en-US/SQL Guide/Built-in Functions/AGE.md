...
expr1 and expr2 are [general expressions](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr), and their values must be of DATE, TIMESTAMP type, or character types that can be converted to DATE, TIMESTAMP.
