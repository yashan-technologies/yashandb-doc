...
A [generic expression](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) recognized by YashanDB, which must be of DATE/TIMESTAMP/time zone type or a string that can be converted to TIMESTAMP type.
...
A [generic expression](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) recognized by YashanDB, which must be numeric or character type. For numeric data that is not an integer, the function will round down.
