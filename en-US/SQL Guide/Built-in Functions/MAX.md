...
When the OVER keyword is specified, MAX acts as a [window function](00Built-in Functions.html#WindowFunction) and supports sliding windows, returning the maximum value of multiple rows.
...
KEEP aggregate function general syntax, for details please refer to [KEEP aggregate function](00Built-in Functions.html#KeepAggregateFunction).
