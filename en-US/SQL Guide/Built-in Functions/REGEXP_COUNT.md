...
REGEXP_COUNT is a regex function that counts the number of matches of the target string `regexp` in the source string `[expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr)`, returning the count as a BIGINT type. If no matches are found, the function returns 0.
...
<span id="match_para" name="match_para" class="yaslink"></span>
