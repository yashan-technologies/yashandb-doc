...
dir_expr is a character type data, and its specification refers to [DIRECTORY](../../All Manuals/Development Guide/SQL Reference Manual/SQL Statements (yashan Mode)/CREATE DIRECTORY), with a maximum length of 64 bytes.
