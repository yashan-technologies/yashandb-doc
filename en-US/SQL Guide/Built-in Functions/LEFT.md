...
The LEFT function returns a substring with capturring the value of [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) according to the length specified from the left.
