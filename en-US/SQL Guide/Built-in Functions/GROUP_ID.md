...
This function must be used in conjunction with the GROUP BY [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr)/ROLLUP/CUBE/GROUPING SETS statements.
