...
The UNISTR function is used to convert the Unicode encoded parts of the source string [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) into corresponding characters, and returns a string of NVARCHAR type.
