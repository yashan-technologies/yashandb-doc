...
The SQRT function calculates the square root of the value represented by [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr). Its return type is:
