...
Using this function may require calling built-in advanced packages such as [YLS_ENFORCEMENT](../Built-in Packages/YLS_ENFORCEMENT), [SA_SYSDBA](../Built-in Packages/SA_SYSDBA), [SA_COMPONENTS](../Built-in Packages/SA_COMPONENTS), and [SA_LABEL_ADMIN](../Built-in Packages/SA_LABEL_ADMIN). The related privilege requirements and usage constraints are also subject to the respective built-in advanced packages.
...
- Refer to [SA_LABEL_ADMIN](../Built-in Packages/SA_LABEL_ADMIN) for label format requirements.
- Refer to [DBA_SA_LEVELS](../../All Manuals/Reference Manual/System Views/DBA Views/DBA_SA_LEVELS) for level names under this policy.
- Refer to [DBA_SA_COMPARTMENTS](../../All Manuals/Reference Manual/System Views/DBA Views/DBA_SA_COMPARTMENTS) for compartment names under this policy.
- Refer to [DBA_SA_LABELS](../../All Manuals/Reference Manual/System Views/DBA Views/DBA_SA_LABELS) for existing labels under this policy.
