```ebnf+diagram
xmlagg::= XMLAGG "(" xml [order_by_clause]")"
```
...
[General Expression](../../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) for the XML data to be aggregated, which follows these rules:
