...
json_value is a binary [json](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/json) data that can be obtained using the [JSON](./JSON JSON_PARSE) function. When json_value is NULL, the function returns NULL.

**json_path**

The path expression is a constant string, and its format definition can be found in the [json](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/json) documentation.
