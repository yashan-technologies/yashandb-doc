...
The array dimension, which is the depth of array nesting, is a [general expression](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) whose value type must be INT (an error occurs if it exceeds the INT value range).
