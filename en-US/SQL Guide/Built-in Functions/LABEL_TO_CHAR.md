...
Using this function may require invoking built-in advanced packages such as [YLS_ENFORCEMENT](../Built-in Packages/YLS_ENFORCEMENT), [SA_SYSDBA](../Built-in Packages/SA_SYSDBA), [SA_COMPONENTS](../Built-in Packages/SA_COMPONENTS), and [SA_LABEL_ADMIN](../Built-in Packages/SA_LABEL_ADMIN). The relevant privilege requirements and usage constraints will also be subject to the corresponding built-in advanced packages.
