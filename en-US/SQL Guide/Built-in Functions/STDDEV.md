...
The STDDEV function calculates the sample standard deviation of the value of [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr).
...
The general syntax of the KEEP aggregate function, detailed information can be found in [KEEP aggregate function](../../All Manuals/Development Guide/SQL Reference Manual/Built-in Functions (yashan Mode)/00Built-in Functions (yashan Mode).html#KeepAggregateFunction).
