...
The general syntax of the KEEP aggregate function, detailed information can be found in [KEEP aggregate function](00Built-in Functions.html#KeepAggregateFunction).
