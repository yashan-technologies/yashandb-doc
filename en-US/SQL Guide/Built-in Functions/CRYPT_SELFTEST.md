...
The CRYPT_SELFTEST function performs a self-test based on [expr1](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) as the test type and [expr2](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) as the data length.
