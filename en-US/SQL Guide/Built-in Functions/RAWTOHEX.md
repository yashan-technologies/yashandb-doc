...
The RAWTOHEX function is used to convert the binary data expressed by [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) into a hexadecimal string, returning a result of VARCHAR type.
