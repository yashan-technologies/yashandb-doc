...
The TO_CHAR function converts the value of [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) to a CHAR/VARCHAR type string data in the format specified by format.
