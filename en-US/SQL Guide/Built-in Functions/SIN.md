...
The value of [expr](../../All Manuals/Development Guide/SQL Reference Manual/General SQL Syntax/expr) can be numeric or a character type that can be converted to NUMBER type (a conversion failure results in an Invalid number error). For other types, the function returns a type not supported error.
