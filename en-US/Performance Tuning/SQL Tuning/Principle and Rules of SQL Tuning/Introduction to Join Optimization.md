...
Enabling autotrace directly can substitute for the above comparison process. For specific usage, please refer to [SET AUTOTRACE](../../Performance Tuning Features and Tools/AUTOTRACE).
