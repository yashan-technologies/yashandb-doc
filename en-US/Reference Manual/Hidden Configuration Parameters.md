...
| VM_BUFFER_PARTS                              | The number of partitions in VM space.                                               |
| VM_BUFFER_SWAP_TIMES                         | The multiple for swapping VM to SWAP tablespace.                                       |
...
| _RCY_DATA_BUFFER_SIZE                        | In YAC/Distributed Cluster Deployment, the size of the data buffer during the online recovery of an instance. |
...
| _DB_UPGRADE_PHASE                            |  Specifies the default startup stage option of the database, with the default value being OPEN. <br/>**Modification is not recommended**. |
