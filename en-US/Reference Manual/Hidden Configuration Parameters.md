...
| THREAD_STACK_SIZE                            | The system stack size for the thread, specified when creating the thread.                             |
...
| SQL_POOL_SIZE                                | The proportion of memory size used by the SQL execution plan buffer.                                |
| SQL_POOL_PARTS                               | The number of memory pool SQL POOL partitions.     |
...
| _HOT_CACHE_SIZE                              | The size of the buffer for hot pages in column segments.                                           |
...
| _PL_POOL_MEMORY_PERCENT                      | Specify the percentage of memory allocated to PL_POOL.                                               |
...
| DB_FLASHBACK_FILE_DEST                       | The path for related files generated by full database flashbacks; dynamic modification is currently not supported. |
