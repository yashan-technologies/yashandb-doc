This view displays a summary of the internal network link status of the current node in a distributed deployment. The standalone deployment query returns empty.
