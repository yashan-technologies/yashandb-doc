This view displays information about all containers (including the CDB root and all PDBs) in the current instance.
...
| CON_UID       | VARCHAR(33)  | Unique identifier associated with the container       |
