...
In a ISC Distributed Cluster Deployment, this view is always empty.
...
| CREATOR_INSTANCE_NUMBER   | INTEGER      | Instance number of the instance that created the key, always 0 in standalone or distributed deployment, instance ID in YAC deployment. |
