...
| RUNTIME_MEM              | INTEGER    | Total memory required at runtime for this SQL and all versions of the execution plans |
...
| LOADS                    | BIGINT     | Number of times execution plans were loaded (reserved field) |
...
| OUTLINE_SID              | INTEGER    | This field determines whether the plan uses a public outline (NULL) or a private outline (corresponding session sid) |
