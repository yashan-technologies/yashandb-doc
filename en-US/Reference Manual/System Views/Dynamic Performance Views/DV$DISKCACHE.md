This view shows the status information of disk buffers on each node in an ISC distributed cluster.
...
| REGION_LOAD_TIMESTAMP | TIMESTAMP(6) | SCN where the disk buffer domain starts loading |