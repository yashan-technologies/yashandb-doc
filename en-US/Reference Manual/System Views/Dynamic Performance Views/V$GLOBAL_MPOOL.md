...
| POOL\_EXTEND\_TIMES | INTEGER | Number of times the space in the memory pool has been extended |
| POOL\_RECYCLE\_TIMES | INTEGER | Number of times the space in the memory pool has been recycled |