This view displays the summary information of SQL statements currently being executed in sessions across all nodes in an ISC distributed cluster.
...
| SQL_TEXT          | VARCHAR(1000) | Split the SQL text into valid text segments by 1000 bytes, and refer to the PIECE field for the sequence number of each text segment                |