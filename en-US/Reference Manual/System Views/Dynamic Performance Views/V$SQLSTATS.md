...
| DIRECT\_WRITES             | BIGINT       | Number of times the cursor wrote directly (reserved field)                    |
...
| PX\_SERVERS\_EXECUTIONS     | BIGINT  |   Number of times the parallel execution engine executed (reserved field)               |
