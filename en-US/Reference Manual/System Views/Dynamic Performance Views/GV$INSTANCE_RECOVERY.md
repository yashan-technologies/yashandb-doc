...
| TARGET\_MTTR | INTEGER | The expected recovery time for the database, from the parameter FAST_START_MTTR_TARGET, unit: seconds |
| ESTIMATED\_MTTR | INTEGER | The estimated time needed to perform database recovery, unit: seconds |