...
| Latest Redo Merge Time      | Millisecond | Time taken for the last log merge (If the logs contain DDL operations, replaying them during the merge will significantly increase the duration)  |
