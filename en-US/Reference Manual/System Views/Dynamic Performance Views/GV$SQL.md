...
| PHYSICAL\_WRITE\_REQUESTS | BIGINT | The number of physical write I/O requests issued by SQL |
| PHYSICAL\_WRITE\_BYTES | BIGINT | The number of bytes written to disk by SQL |
