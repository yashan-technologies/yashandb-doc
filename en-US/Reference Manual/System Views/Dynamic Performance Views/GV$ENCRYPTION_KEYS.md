...
| CREATION_TIME             | TIMESTAMP(6)    | Master key creation time                |
| ACTIVATION_TIME           | TIMESTAMP(6)    | Time when the master key was put into use |
...
| CREATOR_INSTANCE_NUMBER   | INTEGER      | Instance number of the instance that created the key; always 0 for standalone or distributed, instance ID in cluster mode |
