...
| LOW\_SEQUENCE# | INTEGER | The first sequence number (ASN) of the current archive gap interval |
| HIGH\_SEQUENCE# | INTEGER | The last sequence number (ASN) of the current archive gap interval |