...
| DATAFILES_COUNT         | NUMBER(38)       | Total number of data files in this tablespace set    |
...
| DATABUCKETS_COUNT       | NUMBER(38)       | Total number of DATABUCKET files in this tablespace set |
