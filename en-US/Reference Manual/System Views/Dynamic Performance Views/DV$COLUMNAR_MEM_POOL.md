This view displays detailed information about the memory pool during the vectorization calculation process across all nodes in the ISC distributed cluster.
