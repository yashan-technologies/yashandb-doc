...
| START_TIME | TIMESTAMP | Start time of backup or restore, in the server's local time |
| END_TIME | TIMESTAMP | End time of backup or restore, in the server's local time |
