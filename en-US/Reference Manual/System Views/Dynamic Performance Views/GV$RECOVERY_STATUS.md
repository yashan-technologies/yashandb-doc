...
| STATUS         | VARCHAR(16) | Database's apply status<br>\* NONE: No log apply required currently<br>\* RUNNING: Currently applying logs<br>\* PAUSED: Log apply has been paused<br>\* IDLE: The current database replay thread is in idle state |
