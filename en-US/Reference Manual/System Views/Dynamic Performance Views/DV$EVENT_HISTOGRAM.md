...
| LAST_UPDATE_TIME  | TIMESTAMP(6) | The last time the current view data was retrieved, i.e., the last SCN when the corresponding event's wait time distribution ended in the current time period |