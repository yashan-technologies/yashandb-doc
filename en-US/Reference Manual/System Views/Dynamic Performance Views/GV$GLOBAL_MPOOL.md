This view mainly describes the statistics of instance-level public heap memory pools/SQL buffer pools/dictionary buffer pools. 
...
| POOL_EXTEND_TIMES | INTEGER | Number of times space in the memory pool has been extended |
| POOL_RECYCLE_TIMES | INTEGER | Number of times space in the memory pool has been recycled |