...
| LOADS                       | BIGINT    | Number of times the SQL enters the SQL buffer pool |
...
| SHARABLE_MEM                | INTEGER   | Size of shared memory used in the SQL buffer pool (units: bytes) |
| TOTAL_SHARABLE_MEM          | INTEGER   | Total size of shared memory used in the SQL buffer pool (units: bytes), equivalent to SHARABLE_MEM |
