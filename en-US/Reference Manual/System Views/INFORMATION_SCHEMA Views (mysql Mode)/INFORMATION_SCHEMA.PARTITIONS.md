...
| DATA_LENGTH                   | VARCHAR(1)  | The data length                                |
| MAX_DATA_LENGTH               | VARCHAR(1)  | The maximum data length                        |
| INDEX_LENGTH                  | VARCHAR(1)  | The index length                               |
| DATA_FREE                     | VARCHAR(1)  | The unused space                               |
| CREATE_TIME                   | TIMESTAMP   | The creation time                              |
| UPDATE_TIME                   | DATE        | The update time                                |
| CHECK_TIME                    | DATE        | The check time                                 |
| CHECKSUM                      | VARCHAR(1)  | The checksum                                   |
| PARTITION_COMMENT             | VARCHAR(1)  | Partition comment                              |
| NODEGROUP                     | VARCHAR(1)  | Node group                                     |
