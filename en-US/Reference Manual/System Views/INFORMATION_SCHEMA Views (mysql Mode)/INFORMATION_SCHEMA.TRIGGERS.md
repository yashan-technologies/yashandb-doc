...
| ACTION_ORDER               | VARCHAR(20)   | The position in the list of triggers with the same EVENT_MANIPULATION and ACTION_TIMING values on the same table |
...
| CREATED                    | VARCHAR(20)   | The creation date and time of the trigger                     |
| SQL_MODE                   | VARCHAR(20)   | The SQL_MODE in effect when the trigger was created, the trigger will execute under this mode |
| DEFINER                    | VARCHAR(64)   | The account named in the DEFINER clause (usually the user who created the trigger), formatted as 'user_name'@'host_name' |
| CHARACTER_SET_CLIENT       | VARCHAR(20)   | The session value of the system variable CHARACTER_SET_CLIENT when the trigger was created |
| COLLATION_CONNECTION       | VARCHAR(20)   | The session value of the system variable COLLATION_CONNECTION when the trigger was created |
| DATABASE_COLLATION         | VARCHAR(20)   | The collation of the database associated with the trigger     |
