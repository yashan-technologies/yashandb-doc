...
| BLEVEL                      | INTEGER       | Number of levels in the BTree<br/>It has a value only after the statistics of the object have been collected                    |
| LEAF\_BLOCKS                | BIGINT        | Number of leaf nodes in the BTree<br/>It has a value only after the statistics of the object have been collected                |
| DISTINCT\_KEYS              | BIGINT        | Number of distinct key values<br/>It has a value only after the statistics of the object have been collected                     |
| AVG\_LEAF\_BLOCKS\_PER\_KEY | BIGINT        | Average number of leaf blocks per key<br/>It has a value only after the statistics of the object have been collected            |
| AVG\_DATA\_BLOCKS\_PER\_KEY | BIGINT        | Average number of blocks per key<br/>It has a value only after the statistics of the object have been collected                  |
| NUM\_ROWS                   | BIGINT        | Number of rows in the index<br/>It has a value only after the statistics of the object have been collected                        |
| SAMPLE\_SIZE                | BIGINT        | Number of sample rows for index partition statistics<br/>It has a value only after the statistics of the object have been collected  |
