...
| USER\_BYTES     | BIGINT      | User-data available space in the file, equal to the actual file size minus metadata space (unit: bytes) |
| USER\_BLOCKS    | INTEGER     | Number of blocks in the file available for storing user data |
...
| AUTOEXTENSIBLE   | VARCHAR(3)  | Whether the file can auto-extend<br>\*   YES: Can auto-extend<br>\*   NO: Cannot auto-extend |