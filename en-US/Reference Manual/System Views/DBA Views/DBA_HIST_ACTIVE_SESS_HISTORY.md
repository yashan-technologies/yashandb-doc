This view displays persisted ASH records.

|  Field  | Type           | Description                                                                                 |
| --- |--------------|------------------------------------------------------------------------------------|
| SNAP_ID | NUMBER       | Snapshot ID |
| DBID | NUMBER       | Database ID |
| INSTANCE_NUMBER | NUMBER       | Instance ID |
...
| BLOCKING_SESSION | NUMBER   | (Reserved field) |
| BLOCKING_SESSION_SERIAL# | NUMBER   | (Reserved field) |
| BLOCKING_INST_ID | NUMBER   | (Reserved field) |
...
| DBOP_NAME | VARCHAR(64)  | (Reserved field) |
| DBOP_EXEC_ID | INTEGER      | (Reserved field) |
| CON_DBID | NUMBER       | (Reserved field) |
| CON_ID | NUMBER       | (Reserved field) |