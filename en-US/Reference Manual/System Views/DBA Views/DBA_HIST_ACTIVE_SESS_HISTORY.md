This view displays the persisted ASH records.

|Field |Type |Description |
| --- | --- | --- |
| SNAP\_ID | NUMBER       | Snapshot ID (reserved field) |
| DBID | NUMBER       | Database ID |
| INSTANCE\_NUMBER | NUMBER       | Instance ID |
| SAMPLE\_ID | BIGINT       | Sample ID |
| SAMPLE\_TIME | TIMESTAMP(6) | Sample time |
| SAMPLE\_TIME\_UTC | TIMESTAMP(6) | Sample UTC time |
| USECS\_PER\_ROW | BIGINT       | Time consumed for sampling |
...
| PARAMETER1 | VARCHAR(64)  | (Reserved field) |
| P1 | NUMBER       | (Reserved field) |
| PARAMETER2 | VARCHAR(64)  | (Reserved field) |
| P2 | NUMBER       | (Reserved field) |
| PARAMETER3 | VARCHAR(64)  | (Reserved field) |
...
| BLOCKING\_SESSION | NUMBER(10)   | (Reserved field) |
| BLOCKING\_SESSION\_SERIAL# | NUMBER(10)   | (Reserved field) |
| BLOCKING\_INST\_ID | NUMBER(10)   | (Reserved field) |
...
| DBOP\_NAME | VARCHAR(64)  | (Reserved field) |
| DBOP\_EXEC\_ID | INTEGER      | (Reserved field) |
| CON\_DBID | NUMBER       | (Reserved field) |
| CON\_ID | NUMBER       | (Reserved field) |