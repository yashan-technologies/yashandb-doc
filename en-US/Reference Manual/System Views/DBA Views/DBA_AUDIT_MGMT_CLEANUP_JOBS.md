...
| END_DATE            | TIMESTAMP(6) WITH TIME ZONE      | The time when the JOB finishes executing                                                |
...
| LAST_START_DATE     | TIMESTAMP(6) WITH TIME ZONE      | The time when the JOB last started executing                                             |
| LAST_RUN_DURATION   | INTERVAL DAY(9) TO SECOND(6) | The duration of the last execution of the JOB (in seconds)                              |
| NEXT_RUN_DATE       | TIMESTAMP(6) WITH TIME ZONE      | The time when the JOB is scheduled to run next                                          |
