...
| ANSI_NULL | VARCHAR(1)    | Whether the index handles NULL values according to the ANSI standard<br/>\*   Y: Yes<br/>\*   N: No |
| NULL_FIRST | VARCHAR(1)    | Whether the index handles NULL values so that NULL values are at the front<br/>\*   Y: Yes<br/>\*   N: No |