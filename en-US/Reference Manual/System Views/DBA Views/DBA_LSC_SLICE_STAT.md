...
| STABLE_ROWGROUP_NUM | NUMBER(38)     | The number of row groups already converted |
| STABLE_ROW_NUM      | NUMBER(38)     | The number of rows converted to slices    |
| STABLE_FILE_SIZE    | NUMBER(38)     | The total size of slices already converted |
