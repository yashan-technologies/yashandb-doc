...
| BLEVEL                | INTEGER       | The number of layers in the BTree<br/>It has a value only after the statistics of the object have been collected                          |
| LEAF\_BLOCKS          | BIGINT        | The number of leaf nodes in the BTree<br/>It has a value only after the statistics of the object have been collected                       |
| DISTINCT\_KEYS        | BIGINT        | The number of unique key values<br/>It has a value only after the statistics of the object have been collected                             |
| AVG\_LEAF\_BLOCKS\_PER\_KEY | BIGINT | The average number of leaf blocks occupied by each key value<br/>It has a value only after the statistics of the object have been collected |
| AVG\_DATA\_BLOCKS\_PER\_KEY | BIGINT | The average number of blocks occupied by each key value<br/>It has a value only after the statistics of the object have been collected     |
| NUM\_ROWS             | BIGINT        | The number of rows in the index<br/>It has a value only after the statistics of the object have been collected                             |
| SAMPLE\_SIZE          | BIGINT        | The number of sampled rows for index partition statistics<br/>It has a value only after the statistics of the object have been collected    |
| LAST\_ANALYZED       | DATE          | The time of the last execution of statistics collection<br/>It has a value only after the statistics of the object have been collected      |
