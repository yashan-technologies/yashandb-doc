...
| STALE_STATS         | CHAR(1)     | Whether statistics are stale; in the current YAC/Distributed Cluster Deployment mode, the staleness judgment is based solely on the modifications of the current instance<br/>* Y: Stale<br/>* N: Not stale<br/>* Empty: Statistics not collected |
