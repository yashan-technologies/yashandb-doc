...
| ORIGINAL\_SIZE           | NUMBER(38)      | The original input data size   |
| DATA\_ENCODED\_SIZE      | NUMBER(38)      | The size of the data before encoding and compression (excluding metadata) |
| DATA\_COMPRESSED\_SIZE   | NUMBER(38)      | The size of the data file after encoding and compression (excluding metadata file) |
| META\_COMPRESSED\_SIZE   | NUMBER(38)      | The size of the metadata file after encoding and compression (excluding data file) |
| COMPRESSED\_SIZE         | NUMBER(38)      | The size of the data after encoding and compression (including data file and metadata file) |
