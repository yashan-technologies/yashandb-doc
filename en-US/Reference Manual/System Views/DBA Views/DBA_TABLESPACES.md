...
| MAX\_SIZE | NUMBER(38) | Maximum capacity that this tablespace can reach (unit: bytes) |
| TOTAL\_BYTES | NUMBER(38) | Actual capacity of this tablespace (unit: bytes) |
| USER\_BYTES | NUMBER | Currently available free space in this tablespace (unit: bytes) |
| USER\_BLOCKS | NUMBER(38) | Current number of available free blocks in this tablespace |
