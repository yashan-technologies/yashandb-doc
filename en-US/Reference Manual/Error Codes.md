...
### YAS-00233:ERR_CMM_INVALID_CHARSET_MAPPING

**Message**: invalid charset id mapping parameter

**Action**: Please enter valid character set mapping parameters.
...
**Message**: tcp listener count exceeds %u
...
**Action**: URL format is incorrect. Please check.

### YAS-00435:ERR_CMM_ABORT_LINK

**Message**: link aborted, need to disconnect immediately

**Action**: Internal error. Please contact our technical support for assistance.
...
### YAS-00522:ERR_CMM_KILL_FAILED

**Message**: failed to kill process, error: %s

**Action**: Please check the system logs to confirm if there are any anomalies or resource bottlenecks.

### YAS-00523:ERR_CMM_PROCESS_EXITED

**Message**: process has exited abnormally or no longer exists, pid %lu, errno %d
...
### YAS-00901:ERR_CMM_VECTOR_INVALID_ELEMENT_FORMAT
 
**Message**: invalid vector element format
 
**Action**: The format of the vector element is incorrect. Please check whether the format of the vector element is valid.
 
### YAS-00902:ERR_CMM_VECTOR_INVALID_METRIC
 
**Message**: invalid vector metric
 
**Action**: The vector metric type is incorrect. Please check if the vector metric type is valid.
 
### YAS-00903:ERR_CMM_VECTOR_INVALID_DIMENSION
 
**Message**: invalid vector dimension
 
**Action**: The parameter for the number of vector dimensions is incorrect. Please check if the input parameter is valid.
 
### YAS-00904:ERR_CMM_VECTOR_INVALID_STRING
 
**Message**: invalid vector string
 
**Action**: Illegal vector string.
 
### YAS-00905:ERR_CMM_VECTOR_DIMENSION_COUNT_MISMATCH
 
**Message**: vector dimension count mismatch (%d, %d)
 
**Action**: The dimensions of the two vectors do not match. Please check the input parameters.
 
### YAS-00906:ERR_CMM_VECTOR_DIMENSION_FORMAT_NOT_EQUAL
 
**Message**: requires all input vectors to have the same dimension format : encountered dimension formats (%s, %s)
 
**Action**: The types of the two vectors are not equal. Please check the input parameters.
...
### YAS-01365:ERR_DSTB_ROUTE_VERSION_MISMATCH

**Message**: route version mismatch

**Action**: Please update the route and retry.
...
**Action**: The tablespace is out of space; please enable auto-extend for the tablespace or add free data files to the tablespace.
...
**Message**: the database is busy, try again later. current status: %s
...
If the last PITR recovery or database flashback was not completed or failed and you continue to use the database, this error may occur; this situation can only be resolved by cleaning the environment and re-executing PITR or the database flashback operation.
...
**Message**: maximum number of online extending data buffer is reached

**Action**: The Buffer Cache has already reached its upper limit and cannot perform online extension operations using the `ALTER SYSTEM EXTEND DATA_BUFFER ...` or `ALTER SYSTEM SET DATA_BUFFER_SIZE ... SCOPE=MEMORY|BOTH` statements.
...
**Action**: Please enter a valid username and password combination in the correct format. If the username and password are confirmed to be correct, the login may fail due to the current database having [the separation of duties](../Product Security/Data Access Control/Separation of Duties) enabled and requiring management users to declare a role upon login ([as role_name](../Tools Guide/yasql/User Guide for yasql.md#role_name); if omitted, the default is `NORMAL`) but the role was not correctly declared.
...
**Action**: Specify a DATA BUCKET belonging to that tablespace for operation.
...
- flashback database: Under the database flashback functionality, the guarantee point depends on this archive. If you want to delete this archive, please remove the guarantee point first.
...
**Action**: Adding foreign keys to columns stored as LOB types is not allowed, nor is referencing such columns by foreign keys.
...
**Message**: yasrman version mismatch with database version.yasrman: %u.%u.%u, database: %u.%u.%u

**Action**: The current *yasrman* version and database version do not match. Please check the version information and use the correct version to execute the operation command.
...
**Action**: *yasrman* exited abnormally. For the specific reason, please refer to the detailed error messages of *yasrman*.
...
### YAS-02581:ERR_RMAN_INVALID_ARCH_RANGE

**Message**: invalid archive file range define, %s

**Action**: The specified archive interval definition is invalid. Please enter a valid archive interval according to the prompt information. In multitenant mode, the CDB root only supports specifying ALL, UNTIL SCN, or UNTIL TIME archive intervals.

### YAS-02582:ERR_RMAN_BAK_EXEC_FAILED

**Message**: yasrman failed to perform %s on container %s

**Action**: *yasrman* failed to execute the specified operation. Please correct the issue according to the error code instructions and retry the operation.

### YAS-02583:ERR_RMAN_CURR_HAS_NO_PDB

**Message**: pluggable database qualifier not allowed when connected to a pluggable Database

**Action**: Specifying a PDB definition when connecting to a PDB is not allowed. Please check and correct the command.

### YAS-02584:ERR_RMAN_DELETE_SET_FAILED

**Message**: failed to delete backup set, reason: %s

**Action**: Failed to delete the backup set. Please follow the error code reason prompt and select the appropriate deletion command.

- If the prompt "this backup set must be deleted on the PDB it belongs to" appears: the specified backup set was generated by a single PDB. You must connect to the PDB that generated the backup set to execute the deletion command.

- If the prompt "this backup set must be deleted on ROOT" appears: the specified backup set was generated by the CDB root. You must connect to the CDB root to execute the deletion command.

### YAS-02585:ERR_RMAN_CMD_ALLOWED_CDB

**Message**: command only allowed in a container database

**Action**: This command is only allowed to be executed in a CDB. Please check the execution command and the deployment mode of the target database.

### YAS-02586:ERR_RMAN_CATALOG_INCOMPLETE

**Message**: the catalog file collection is incomplete

**Action**: The specified catalog file set is incomplete — please confirm and use the correct catalog file set to re-execute the operation command.
...
**Action**: Database flashback can only be executed on the master instance.

### YAS-02803: ERR_ANK_FB_IS_NOT_ENABLE

**Message**: flashback database is not enabled

**Action**: The database flashback functionality is not enabled yet; please enable it and retry.

### YAS-02804: ERR_ANK_FB_IS_ENABLE

**Message**: flashback database is already turned on

**Action**: Database flashback is currently on; please turn it off and retry.
...
**Action**: Unable to create the database flashback file directory; please check the server situation and retry.
...
**Action**: The database flashback log file is damaged; please check the file.

### YAS-02812: ERR_ANK_FB_PACK_CORRUPTED

**Message**: the flashback logfile %s pack is corrupted, offset %lu

**Action**: The pack of the database flashback log file is damaged; please check the file.
...
**Action**: Database flashback is in progress; please continue the unfinished database flashback before retrying.
...
**Action**: The directory space for the database flashback log file has reached the limit; please adjust the DB_FLASHBACK_FILE_DEST_SIZE configuration parameter.
...
### YAS-02826:ERR_ANK_DURING_ADD_INSTANCE_FORBID
...
### YAS-02827:ERR_ANK_ADD_INSTANCE_FAILED
...
**Action**: Database flashback execution failed; the arch or redo it depends on cannot be accessed. Please adjust the flashback time point.
...
### YAS-02844: ERR_ANK_ADD_INSTANCE_REFORM_CLEAN
...
**Message**: cannot %s a system-generated sequence

**Action**: Operations on system-generated sequences are prohibited.
...
**Action**: It is not possible to perform key backup operations based on an external PKCS#11 module.
...
**Action**: Database flashback encountered an error while rolling back the database to the specified snapshot point.
...
### YAS-02879: ERR_ANK_TOO_MANY_CONTAINERS

**Message**:  number of existing containers is %u, maximum number of containers is %u

**Action**: The number of PDBs has reached the upper limit. Please increase the MAX_PDBS parameter configuration or delete unnecessary PDBs and retry.

### YAS-02880: ERR_ANK_CONTAINER_ALREADY_EXISTS

**Message**: container '%s' already exists

**Action**: Please specify a different container name and retry.

### YAS-02881: ERR_ANK_CONTAINER_NOT_FOUND

**Message**: container '%s' is not found

**Action**: Please specify an existing container for the operation.

### YAS-02882: ERR_ANK_CONTAINER_ALREADY_OPEN

**Message**: container '%s' is already open

**Action**: Please check the STATUS column in the V$PDBS view.

### YAS-02883: ERR_ANK_CONTAINER_ALREADY_MOUNTED

**Message**: container '%s' is already mounted

**Action**: Please check the STATUS column in the V$PDBS view.

### YAS-02884: ERR_ANK_CONTAINER_ALREADY_STARTED

**Message**: container '%s' is already started

**Action**: Please check the STATUS column in the V$PDBS view.

### YAS-02885: ERR_ANK_CONTAINER_ALREADY_CLOSED

**Message**: container '%s' is already closed

**Action**: Please check the STATUS column in the V$PDBS view.

### YAS-02886: ERR_ANK_CONTAINER_NOT_CLOSED

**Message**: container '%s' is not closed

**Action**: Please ensure that the PDB is closed on all nodes and retry the operation.

### YAS-02887: ERR_ANK_CONTAINER_PROCESS_REQ

**Message**: container '%s' failed to process request, errcode: %u, errmsg: %s

**Action**: The request fails when the remote database on the container executes a local request. Please check the underlying error code or review the logs on the remote database to analyze the failure.

### YAS-02888: ERR_ANK_CONTAINER_OPERATION_NOT_ALLOWED

**Message**: container operation is not allowed on the database: %s

**Action**: Please switch to the CDB root to perform the operation.

### YAS-02889: ERR_ANK_CONTAINER_FILE_INVALID

**Message**: missing or invalid file name pattern for file or directory: %s

**Action**: Please correct the FILE_NAME_CONVERT clause and retry the statement.

### YAS-02890: ERR_ANK_CONTAINER_NAME_INVALID

**Message**: invalid pluggable database name: the first character of a PDB name must be an alphabet character, the remaining characters can be alphanumeric or the underscore character (_)

**Action**: Please correct the pluggable database name and retry the statement.

### YAS-02891: ERR_ANK_CONTAINER_START_FAILED

**Message**: starting container '%s' failed, %s

**Action**: Please check system resources or check the pluggable database parameter configuration and retry the statement.

### YAS-02892: ERR_ANK_CONTAINER_COMMUNICATE_FAILED

**Message**: failed to send request to or receive acknowledgement from container '%s'

**Action**: Communication error occurred while sending a request to the container or receiving a reply from the container. Please check the underlying error codes in the local and remote database logs or review system resources to analyze the failure reason.

### YAS-02893: ERR_ANK_DROP_INTERNAL_DBLINK

**Message**: cann't drop internal database link

**Action**: Please do not delete the internal database link.

### YAS-02894: ERR_ANK_ROOT_CHANGE_PRIVATE_PARAM

**Message**: cannot change private parameter on root container with CONTAINER=ALL

**Action**: Please use CONTAINER=CURRENT and retry.

### YAS-02895: ERR_ANK_CONTAINER_TASK_FAILED

**Message**: %s failed to %s, the reason for the failure can be queried as v$container_task

**Action**: Query the view to identify the cause of task failure. If a database restart occurred, check the operation logs to determine the failure reason.

### YAS-02896: ERR_ANK_CONTAINER_NO_STDBY

**Message**: there is no standby database in the specified container

**Action**: The PDBs involved in this operation are all primary databases; this operation is not required. Verify the correctness of the SQL statement.

### YAS-02897: ERR_ANK_CONTAINER_INVALID_COMMON_NAME

**Message**: invalid common user or role name

**Action**: The name of a global user or role must have a global prefix. The default global prefix is C##.

### YAS-02898: ERR_ANK_CONTAINER_INVALID_LOCAL_NAME

**Message**: invalid local user or role name

**Action**: The name of a local user or role cannot have a global prefix. The default global prefix is C##. Even if C## is not the global prefix, it cannot be used as a prefix for local user or role names.


### YAS-02899: ERR_ANK_CONTAINER_COMMON_DDL_IN_PDB

**Message**: Common DDLs only allowed in root

**Action**: CONTAINER=ALL can only be used in the CDB root.

### YAS-02900: ERR_ANK_CONTAINER_LOCAL_USER_IN_ROOT

**Message**: Creation of local user or role is not allowed in this container

**Action**: Cannot create local users or roles in the CDB root.

### YAS-02901: ERR_ANK_CONTAINER_PDB_FORBIDDEN

**Message**: operation not allowed from within a pluggable database

**Action**: PDB cannot perform global modifications.

### YAS-02902: ERR_ANK_CONTAINER_CHANGES_NOT_GLOBAL

**Message**: The specified changes must apply to all containers

**Action**: Please use CONTAINER=ALL and then retry.

### YAS-02903: ERR_ANK_CONTAINER_INVALID_COM_PROF_NAME

**Message**: invalid common profile name

**Action**: The name of a global configuration must have a global prefix. The default global prefix is C##.

### YAS-02904: ERR_ANK_CONTAINER_INVALID_LOC_PROF_NAME

**Message**: invalid local profile name

**Action**: The name of a local configuration cannot have a global prefix. The default global prefix is C##. Even if C## is not the global prefix, it cannot be used as a prefix for local configuration names.

### YAS-02905: ERR_ANK_CONTAINER_LOCAL_PROF_IN_ROOT

**Message**: Creation of local profile is not allowed in this container

**Action**: Cannot create local configurations in the CDB root.

### YAS-02906: ERR_ANK_CONTAINER_COMMON_GRANT

**Message**: A common privilege cannot be granted or revoked on a local object

**Action**: Permissions for local objects cannot be globally granted or revoked.

### YAS-02907: ERR_ANK_ENABLE_PLUGGABLE_MISMATCH

**Message**: parameter ENABLE_PLUGGABLE_DATABASE does not match the database type, expect %s

**Action**: Check whether the configuration parameter ENABLE_PLUGGABLE_DATABASE matches the actual database.

### YAS-02908: ERR_ANK_INVALID_ADMIN_USER

**Message**: invalid admin user name

**Action**: The administrative username conflicts with other usernames, or the name contains a global prefix.

### YAS-02909: ERR_ANK_USE_CONTAINER_IN_NON_CDB

**Message**: CONTAINER clause may only be specified when connected to a container database

**Action**: Do not use the CONTAINER clause in non-CDB environments.

### YAS-02910: ERR_ANK_MAX_PDBS_TOO_SMALL

**Message**: cannot set MAX_PDBS smaller than current number of PDBs

**Action**: Please execute `show pdbs` to view the number of PDBs created by the user (excluding PDB$SEED), then set MAX_PDBS to be greater than or equal to this value.

### YAS-02911: ERR_ANK_CONTAINER_ALREADY_CLOSING

**Message**: container '%s' is already closing

**Action**: The PDB for this operation is already shutting down and does not need to be executed repeatedly.  

### YAS-02912: ERR_ANK_CONTAINER_TASK_RUNNING

**Message**: %s task in progress, waiting for completion before retrying

**Action**: Container tasks are executed serially and need to wait for the previous task to complete before executing. The task execution status can be viewed by querying the [V$CONTAINER_TASK](./System Views/Dynamic Performance Views/V$CONTAINER_TASK) view.

### YAS-02913: ERR_ANK_COMMON_DDL_NOT_EXECUTE

**Message**: common ddl is not executed, internal error

**Action**: Internal error. Please contact our technical support for assistance.

### YAS-02914: ERR_ANK_CONTAINER_MISMATCH

**Message**: the current CTRL metadata information is inconsistent with the deployment type

**Action**: The target PDB of the current DROP operation does not match the actual metadata content being operated on. Please check whether the HOME path of the target PDB recorded in the control file is consistent with the actual HOME path. The specific locations to check are:

- In Standalone Deployment, please check the CONTROL_FILES configuration item in the $YASDB_DATA/config/yasdb.ini file.

- In YAC/Distributed Cluster Deployment, please check the $PDB_DATA/config file in YFS.

### YAS-02915: ERR_ANK_CONTAINER_INCOMPLETE

**Message**: not allow to open incomplete container '%s', please drop and create again

**Action**: The target container database is not fully created and cannot be started. Please delete it and recreate it correctly before starting.

### YAS-02916: ERR_ANK_BUILD_LOGSTBY_TIMEOUT
...
### YAS-02917: ERR_ANK_TOO_MANY_VM_CHUNKS

**Message**: maximum number of online extending vm buffer is reached

**Action**: The VM Buffer online extension count has reached its upper limit, and online extension operations using the `ALTER SYSTEM SET VM_BUFFER_SIZE ... SCOPE=MEMORY|BOTH` statement cannot be performed.

### YAS-02918: ERR_ANK_INVALID_ALTER_TABLE_NAME
...
### YAS-02919: ERR_ANK_TIME_INTERVAL_PART
...
### YAS-02920: ERR_ANK_YSTREAM_SHRINK_WL
...
**Action**: Offline operations on the default SWAP tablespace are not allowed.

### YAS-02922: ERR_ANK_OPERATE_FUNC_INDEX
...
### YAS-02924: ERR_ANK_INVALID_SEQ_PRIV

**Message**: only SELECT privileges are valid for sequence

**Action**: Only SELECT permissions are valid for sequences.

### YAS-02925: ERR_ANK_SPFILE_IN_USE

**Message**: cannot create SPFILE already being used by the instance

**Action**: Manually delete yasdb.spfile, restart the database, and then re - execute this operation.

### YAS-02926: ERR_ANK_SPFILE_CHECK

**Message**: unauthorized modification of the SPFILE has been detected

**Action**: The yasdb.spfile has been illegally tampered with. Please delete it and restart the database using yasdb.ini.

### YAS-02927: ERR_ANK_SPFILE_SSL_CHECK

**Message**: unauthorized modification of the SSL conifg in SPFILE has been detected

**Action**: The content of the files corresponding to the SSL - related configuration parameters in yasdb.spfile has been illegally tampered with. Please delete yasdb.spfile, restart the database using yasdb.ini, and configure the paths of the SSL - related configuration parameters with the correct file content.

### YAS-02928: ERR_ANK_BITMAP_INDEX_GLOBAL
...
### YAS-03651:ERR_HNSW_BUILD_MEM_NOT_ENOUGH

**Message**: hnsw index build memory is not enough

**Action**: There is insufficient memory for building the HNSW vector index. The index building will automatically switch to the mode based on tablespace storage, which will affect the building performance. Please analyze, according to the actual situation, whether there is insufficient memory in the MEX POOL or the value configured for HNSW_BUILD_MEM_SIZE is too small, and make corresponding adjustments accordingly.
...
**Message**: %s size exceeding limit % PRIu64
...
### YAS-04016:ERR_ANS_EXEC_NEST_AGGR_NO_GROUP_BY

**Message**: nested group function without GROUP BY

**Action**：Nested aggregate functions are missing GROUP BY fields.

### YAS-04017:ERR_ANS_EXEC_NEST_TOO_DEEPLY

**Message**: group function is nested too deeply

**Action**：Nested aggregate functions are too deep. Please check and ensure that the nesting level does not exceed one layer.
...
### YAS-04614:ERR_ANL_CTAS_ROWID_PESUDO

**Message**: mysql compatibility error, creating with __ysmy_rowid pseudo column is not allowed

**Action**: An error occurred in compatibility mode. Creating views/tables with the __ysmy_rowid pseudo column is not allowed.

### YAS-04701:ERR_ANS_PARSER_INVALID_VECTOR_DIMENSION

**Message**: invalid vector dimension, it should be a number in (0, 65535]

**Action**: The number of vector dimensions is incorrect. Please modify the vector dimension value.

### YAS-04702:ERR_ANS_PARSER_INVALID_VECTOR_ELEM_FORMAT

**Message**: invalid vector element format %s

**Action**: The format of the vector dimension is incorrect.

### YAS-04703:ERR_ANS_VERIFY_INVALID_ARG

**Message**: invalid argument: %s

**Action**: There are invalid function parameters. Please check if the function parameters are correct.
...
### YAS-04913:ERR_ANS_VERIFY_INDEX_COLUMN_COUNT

**Message**: cannot create %s index on more than one column

**Action**: Change the index column to one column and try again.

### YAS-04914:ERR_ANS_VERIFY_INDEX_COLUMN_TYPE

**Message**: unsupported data type for %s index

**Action**: Please modify the specified index columns and retry.

### YAS-04915:ERR_ANS_VERIFY_INDEX_REVERSE

**Message**: cannot build %s with option reverse
...
**Action**: Please grant ALTER SESSION privilege to the *yasldr* connection user.

### YAS-04974:ERR_ANL_SQLLDR2_INVALID_FVECS_FILE_SIZE

**Message**: invalid fvecs file size %ld(expected %ld)

**Action**: Please check the data content of the fvecs file and re-import after correcting the data.
...
**Action**: There should be no conflicting declarations and definitions in the package head and body.
...
**Message**: instance join timeout for MASTER_ROLE instance is not open
...
**Message**: CDB Root instance %u must be opened
...
### YAS-05435:ERR_AXC_INST_FAILED

**Message**: instance %u failure

**Action**: During the execution of a multi-instance task, one of the instances fails to execute. You can accurately locate and analyze the cause of failure by checking the error code returned from the underlying system.

### YAS-05436:ERR_AXC_PARAM_VALUE_NOT_MATCH
...
**Action**: Abnormal network communication occurred between instances. Please check the running status of each instance process and the network connectivity.
...
**Message**: the minimum size of disk %s is %lu bytes  
...
**Action**: In the same DiskGroup, the number of disks in different fail groups is inconsistent, please configure the same number of disks.

### YAS-05550:ERR_YFS_INVALID_DISK_SIZE

**Message**: the size of disk %s must be between [%lu , %lu] bytes

**Action**: The disk size exceeds the legal range. Please modify it and try again. The size parameter can be omitted. When omitted, YFS will use the entire disk space.

### YAS-05551:ERR_YFS_END_OF_FILE

**Message**: read or write offset exceeds the file size
...
**Message**: disks in diskgroup %s do not have equal size
...
### YAS-05593:ERR_YFS_DISK_NOT_FOUND

**Message**: disk %s not found under diskgroup %s

**Action**: Disks under this DiskGroup were not found. Please first check whether the disks on primary and standby nodes are correctly mounted and can read/write normally. If the issue cannot be resolved, please contact our technical support for assistance.

### YAS-05594:ERR_YFS_VALUE_OUT_OF_RANGE
...
### YAS-05595: ERR_YFS_DISK_ALREADY_ONLINE
...
### YAS-05596: ERR_YFS_RBL_CANCELED
...
### YAS-05598: ERR_YFS_RBL_TERM

**Message**: "rebalance job %s terminated, it will be automatically restarted later"
...
**Action**：Please troubleshoot the failure reason according to the prompts. If you still cannot resolve the issue, please contact our technical support for assistance.
...
### YAS-05776:ERR_YCS_ADD_DATABASE

**Message**: failed to add database/pdb, reason: %s

**Action**: Failed to add database/PDB resources. Please troubleshoot according to the prompts.

### YAS-05777:ERR_YCS_REMOVE_DATABASE

**Message**: failed to remove database/pdb %s, reason: %s

**Action**: Failed to remove database/PDB resources. Please troubleshoot according to the prompts.

### YAS-05778:ERR_YCS_DB_INSTANCE_ADDED

**Message**: an instance has already been added to node %s for database %s

**Action**: The same database resource can only have one instance added per cluster node at most.  

### YAS-05779:ERR_YCS_DATABASE_NOT_EXIST

**Message**: database '%s' is not configured for cluster

**Action**: No database resources have been added to the cluster. Related operations cannot be performed.  

### YAS-05780:ERR_YCS_DB_INSTANCE_NOT_EXIST

**Message**: no instance configured to node %s for database %s

**Action**: No instances of database resources have been added to the cluster node. Related operations cannot be performed.  

### YAS-05781:ERR_YCS_DB_NAME_INVALID

**Message**: database unique name '%s' is invalid

**Action**: Invalid database resource name.
...
### YAS-06032:ERR_ANS_INVALID_PDB_OPER

**Message**: operation not allowed in a pluggable database

**Action**: The statement cannot be executed under PDB. Modify the statement and re-execute it.

### YAS-06033:ERR_ANS_LISTENER_STOPPED

**Message**: connection closed due to listener stopped

**Action**: The connection was disconnected due to the listener being closed. Please start the listener.

### YAS-06034:ERR_ANS_CONNECTION_UNAVAILABLE

**Message**: the database is currently executing switchover and cannot accept connections. Please try again later

**Action**: The database is in the process of primary-standby switchover, and connection establishment is temporarily unavailable. After the switchover is completed, the client will automatically retry the connection. You can also choose to manually initiate a connection request later.
...
### YAS-06701:ERR_AUDIT_PARSE_CONDITION

**Message**: policy %s has invalid condition

**Action**: The audit policy's condition is invalid. Please check whether the condition specified when creating the audit policy is correct.
...
### YAS-06942:ERR_PL_SESSION_CTX_CACHE_EXCEEDED

**Message**: exceeded the maximum allowed size for context information in a session

**Action**: The total amount of context information set exceeds the maximum allowed value in a session.
...
### YAS-06948:ERR_PL_INVALID_DATA_TYPE

**Message**: invalid data type %s

**Action**: An invalid data type has occurred in PL.
...
**Action**: Please check whether the input parameter types and count of the function are correct.
...
### YAS-08078:ERR_YAC_URL_INVALID

**Message**: invalid url

**Action**: Please enter the correct URL.

### YAS-08079:ERR_YAC_VECTOR_DESC_INVALID

**Message**: invalid vector descriptor

**Action**: The VECTOR description is invalid. Please create a valid VECTOR description.

### YAS-08080:ERR_YAC_VECTOR_DATA_INVALID

**Message**: invalid vector data

**Action**: The VECTOR data is invalid. Please create or obtain valid VECTOR data.
...
### YAS-08421:ERR_RES_NOT_ALLOWED_OP_FOR_PDB

**Message**: %s operation is not allowed from within a pluggable database

**Action**: Please switch to the CDB root before performing this operation.

### YAS-08422:ERR_RES_NOT_ALLOWED_OP_FOR_CDB

**Message**: %s operation is not allowed from outside a pluggable database

**Action**: Please switch to a non-CDB root before performing this operation.

### YAS-08423:ERR_RES_NOT_ALLOWED_OP_FOR_NON_CONTAINER

**Message**: %s operation is not allowed on the database

**Action**: This operation can only be performed in a multitenant database.

### YAS-08424:ERR_RES_GET_DEVICE_NUMBER_FAIL

**Message**: unable get device number from %s

**Action**: Please verify if the device where the path resides is functioning properly.

### YAS-08425:ERR_RES_CGROUP_DROP_DIRECTIVE

**Message**: directive is being used and cannot be deleted

**Action**: The directive is currently in use. Please confirm whether any objects are still using this command before deleting it.

### YAS-08426:ERR_RES_CGROUP_CDB_UNSUPPORT

**Message**: cgroup version v2 is not supported within a pluggable database

**Action**: Multitenant databases do not support CGROUP v2. Please change the **CGROUP** version to v1.

### YAS-08427:ERR_RES_PDB_MEM_NOT_ENOUGH

**Message**: failed to %s, because the requested memory size % PRIu64 (Byte) cannot be satisfied

**Action**: Insufficient remaining memory. Please close other containers or increase the parameter of CDB_MAX_MEMORY_SIZE.

### YAS-08428:ERR_RES_PDB_MEM_EXCEEDS_LIMIT

**Message**: failed to open container %s, because the requested memory size % PRIu64 (Byte) exceeds the memory_limit % PRIu64 (Byte)

**Action**: Please increase the memory limit for the container.

### YAS-08429:ERR_RES_PDB_MEM_BELOW_MIN

**Message**: failed to open container %s, because the requested memory size % PRIu64 (Byte) is below the memory_min % PRIu64 (Byte)

**Action**: Please reduce the memory lower limit of the container.

### YAS-08430:ERR_RES_NOT_ALLOWED_DECEASE_MAX_MEMORY

**Message**: failed to alter parameter CDB_MAX_MEMORY_SIZE, because the parameter not allow to decrease online, current size is % PRIu64 (Byte)

**Action**: The CDB_MAX_MEMORY_SIZE parameter cannot be adjusted online. Please turn off the resource management function and try again, or set it to take effect after restarting.
...
**Message**: Default value specification not supported for %s column %s

**Action**: A default value cannot be specified for a column of this type.
...
### YAS-10005:ERR_ANS_DATAMASK_COL_NOT_SUPPORT

**Message**: %s column not support datamask

**Action**: The current column does not support creating a data masking policy.

### YAS-10006:ERR_ANS_ILLEGAL_FUNC_ARGUMENT
...
### YAS-10007:ERR_ANS_VERIFY_DATAMASK_REGEXP_PARAM_VALUES

**Message**: invalid %s format

**Action**: Please check whether the regular expression parameter is correct according to the error message.

### YAS-10008:ERR_ANS_VERIFY_DATAMASK_REGEXP_PARAM_TOO_LONG

**Message**: parameter exceeding limit %u

**Action**: Please check according to the error message whether the parameters of the regular expression desensitization strategy do not exceed the maximum length.
...
**Message**: the action is invalid, must be "UPGRADE"

**Action**: The type of the current operation is invalid — it must be `UPGRADE`.
