...
**Action**: Please remove the DISTINCT or UNIQUE clause.
...
**Action**: Abnormal network communication between instances. Please check the running status of each instance process and network connectivity.
...
**Action**: The lock operation in the pipelined function should be placed in an autonomous transaction.
