...
Description: Minimum Arch Data LFN for the node and its standby database and cascade backup.
...
Description: Number of times the dictionary buffer was loaded from disk.
