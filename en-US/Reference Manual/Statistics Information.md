...
### DBWR OBJECT REQUESTS

Description: Number of object-level checkpoints executed by the database writer.

### DBWR OBJECT WRITES

Description: Number of blocks flushed by the database writer during object-level checkpoints.
...
### REDO TRAFFIC CONTROL CHECKPOINTS

Description: Number of checkpoints triggered by redo traffic control.
