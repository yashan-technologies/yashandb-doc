...
| UPDATE\_RULE                 | VARCHAR(8) | The cascade update rule for the foreign key constraint (RESTRICT, CASCADE, SET NULL) |
| DELETE\_RULE                 | VARCHAR(8) | The cascade delete rule for the foreign key constraint (RESTRICT, CASCADE, SET NULL) |
