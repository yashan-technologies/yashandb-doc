...
- This pseudocolumn cannot be used in the WHEN clauses, insert_values_clause, or subquery for [multi-table conditional inserts](../../../Development Guide/SQL Reference Manual/SQL Statements/INSERT.md#conditionalinsertclause).
