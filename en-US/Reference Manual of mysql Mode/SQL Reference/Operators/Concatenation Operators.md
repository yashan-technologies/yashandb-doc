...
In YashanDB (mysql mode), in addition to the concatenation operator, you can also use [CONCAT](../Built-in Functions/CONCAT) to implement concatenation operations.
...
SQL> SELECT 'abc'||'nnk'||123||null FROM DUAL;
