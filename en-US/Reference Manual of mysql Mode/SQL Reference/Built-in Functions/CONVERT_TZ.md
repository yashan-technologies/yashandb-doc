...
The echo and printing mechanisms for time formats in *yasql* and the MySQL client are different, but this does not affect the use of business applications.
