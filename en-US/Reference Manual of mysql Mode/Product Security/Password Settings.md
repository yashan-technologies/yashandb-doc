...
In YashanDB (mysql mode), the password policy and strength are controlled by the following [system variables](../System Variables/List of System Variables In mysql Mode):
...
| VALIDATE_PASSWORD_SPECIAL_CHAR_COUNT | Specifies the minimum number of special characters required in the password. |
