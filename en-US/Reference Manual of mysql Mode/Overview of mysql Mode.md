...
- Supports over 80 MySQL-specific functions, covering multiple areas such as date and time, string handling, mathematical operations, JSON, control flow, system information, and password verification;
