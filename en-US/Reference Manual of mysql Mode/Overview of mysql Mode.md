...
| ----------------------- |-------------------------------------------|
| Deployment Mode          | The mysql mode can only be selected for standalone (primary/standby) deployment and YAC deployment.                                     |
| Table Type               | Only HEAP tables can be created be used in mysql mode.         |
