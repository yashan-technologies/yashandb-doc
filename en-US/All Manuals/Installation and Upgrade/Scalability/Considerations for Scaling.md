...
- It is recommended to [back up](../../数据库管理/备份与恢复/00备份与恢复) the database before performing scaling operations to ensure that there is a backup set available for recovery.
