...
1. (Optional) Backup the database.
    ...
    It is recommended to perform a [backup](../../../Database Administration/Backup and Recovery/00Backup and Recovery) of the database to ensure that there is a baseline backup set available for recovery after the expansion.
