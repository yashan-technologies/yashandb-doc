...
5. (Optional) Backup the database.
    ...
    It is recommended to perform a [backup](../../../数据库管理/备份恢复/00备份恢复) of the database to ensure that a baseline backup set is available for recovery after scaling.
...
4. (Optional) Backup the database.
    ...
    It is recommended to perform a [backup](../../../数据库管理/备份恢复/00备份恢复) of the database to ensure that a baseline backup set is available for recovery after scaling down.
