In Distributed Deployment, users can scale cluster nodes as needed in a running environment, including two scenarios: CN node expansion and DN node expansion.
