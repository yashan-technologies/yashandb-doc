...
On the [DB creation parameters] page, refer to [YAC Deployment Configuration File](../../../Tools Guide/yasboot/Configuration Files/YAC Deployment Configuration File) to add/delete/edit creation parameters as needed, refer to [YFS Configuration](../../../Database Administration/Storage Management/YFS Management/YFS Configuration) to add/delete/edit YFS parameters as needed, refer to [YAC Configuration](../../../Database Administration/Cluster Management/Cluster Parameter Configuration) to add/delete/edit YCS parameters as needed, and after confirming the information is correct, click [Next step].
