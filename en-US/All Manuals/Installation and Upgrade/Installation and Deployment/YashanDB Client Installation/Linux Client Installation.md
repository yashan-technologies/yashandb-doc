...
- Character Set Configuration: The default character set for Linux client is UTF8. To adjust this, please refer to [Modifying Client Character Set](../../../数据库管理/实例管理/数据库字符集配置.html#Client).
