...
The client supports installation on both Windows and Linux platforms. For specific installation procedures, please refer to [Windows Client Installation](./Windows客户端安装) and [Linux Client Installation](./Linux客户端安装).