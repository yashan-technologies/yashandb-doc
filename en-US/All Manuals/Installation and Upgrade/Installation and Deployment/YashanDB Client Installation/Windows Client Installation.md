...
- Character Set Configuration: The default character set for Windows client is GBK. To adjust this, please refer to [Modifying Client Character Set](../../../数据库管理/实例管理/数据库字符集配置.html#Client).

- Trusted Channel: Database client \<-> server trusted channel is disabled by default. If encrypted communication is required, please refer to [Trusted Channel](../../../产品安全/加密支持/可信信道/00可信信道).
