...
3. (Optional) Configure the installation user for passwordless sudo.
	...
	Certain specific functions (such as creating resource groups and YAC SCAN) require the database user to have sudo permissions. If you do not expect to use these functions, you can skip this operation.
...
<span id="HOMEDirectory" name="HOMEDirectory" class="yaslink"></span>
