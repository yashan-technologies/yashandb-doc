...
Some features require additional environment variables. If you need to use [External UDF (Java)](../../../开发手册/PL参考手册/PL对象/自定义函数.html#ext_udf), the following environment variables also need to be configured and take effect.
