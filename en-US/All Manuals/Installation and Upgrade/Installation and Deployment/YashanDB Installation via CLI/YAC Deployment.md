...
| Parameters under [group.yfsconfig]            | These parameters are all [YFS configuration parameters](../../../Database Administration/Storage Management/YFS Management/YFS Configuration) and can be manually adjusted. |
