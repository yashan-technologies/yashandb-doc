...
Cascaded standbys can be established for different standby databases, as well as multi-layer cascaded standbys. However, during the installation and deployment process, only one layer of cascaded standby deployment can be performed for one standby database. After completion, other cascaded standbys can be added to this database cluster by referring to the operational instructions described in the [Cascading Standbys Scaling](../../Scalability/Scalability of Standalone Deployment/Cascading Standbys Scaling).
