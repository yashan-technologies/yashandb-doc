...
1. Plan the system disk on shared storage. For specific operations, please refer to [Disk Partitioning](../Installation and Deployment/Pre-Installation Preparation/Configuring the Storage Devices.html#DiskPartitioning).
