...
The BIT_AND/BIT_OR/BIT_XOR aggregate functions perform bitwise calculations on [expr](../通用SQL语法/expr) using 64-bit BIGINT UNSIGNED data type and return a 64-bit BIGINT UNSIGNED value.
