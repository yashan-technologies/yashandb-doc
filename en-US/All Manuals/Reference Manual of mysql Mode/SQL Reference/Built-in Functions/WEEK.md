...
If the mode parameter is not specified, the default value is the DEFAULT_WEEK_FORMAT system variable. Please refer to [System Variables in mysql mode](../../系统变量/系统变量参考).
