...
* Whether the value of expr allows zero in the year, month, or day depends on whether NO_ZERO_DATE and NO_ZERO_IN_DATE are included in [SQL_MODE](../../系统变量/系统变量参考.html#sql_mode).
