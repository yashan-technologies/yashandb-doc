...
When the OVER keyword is specified, MIN will act as a [window function](../../../Development Guide/SQL Reference Manual/Built-in Functions/00Built-in Functions.html#WindowFunction) and supports sliding windows, returning the minimum value across multiple rows.

**analytic_clause**

The general syntax for window functions; please refer to [window function](../../../Development Guide/SQL Reference Manual/Built-in Functions/00Built-in Functions.html#WindowFunction) for more details.
