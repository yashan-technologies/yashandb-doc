...
CREATE USER is used to create a new database user. The default created is a regular user. For YashanDB's user management system, please refer to the Product Security Manual [User Management](../../产品安全/管理用户).
...
*   It must comply with [Password Strength](../../产品安全/密码策略) requirements.
