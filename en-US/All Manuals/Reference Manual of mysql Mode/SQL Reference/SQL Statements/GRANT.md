...
GRANT is used to grant privileges to a user. The grantable content includes [system privilege SYSTEM PRIVILEGE](../../产品安全/特权管理/系统特权), [schema privilege SCHEMA PRIVILEGE](../../产品安全/特权管理/模式特权), and [object privilege OBJECT PRIVILEGE](../../产品安全/特权管理/对象特权).
...
The name of the system privileges to be granted, separated by commas. Please refer to the list of system privileges in [System Privileges](../../产品安全/特权管理/系统特权).
...
The name of the schema privileges to be granted, separated by commas. Please refer to the list of schema privileges in [Schema Privileges](../../产品安全/特权管理/模式特权).
...
The name of the object privileges to be granted, separated by commas. Please refer to the list of object privileges in [OBJECT PRIVILEGE](../../产品安全/特权管理/对象特权).
