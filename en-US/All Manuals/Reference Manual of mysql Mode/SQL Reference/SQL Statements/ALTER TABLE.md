...
This modifies the data type of the column field to one recognized by YashanDB [data types](../数据类型/数据类型).
...
This statement is used to define the columns of the table, including data types, default values,  [inline_constraint](../通用SQL语法/constraint), and various column attributes such as CHARACTER SET, COLLATE, COMMENT, and AUTO_INCREMENT.
