...
- High availability deployments, such as standalone primary-standby deployment or primary-standby YAC deployment.
...
- The REPLICATION_ADDR parameter has been confirmed empty.  
    ...
    ALTER SYSTEM SET REPLICATION_ADDR ='' SCOPE=BOTH;
    ```
