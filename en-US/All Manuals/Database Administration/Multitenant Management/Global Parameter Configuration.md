...
The scope attributes of parameters can be determined through the ISPDB_MODIFIABLE and ISPDB_PRIVATE fields in the [V$PARAMETER](../../Reference Manual/System Views/Dynamic Performance Views/V$PARAMETER) view.
...
The [yasboot cluster config set](../../Tools Guide/yasboot/Introduction to yasboot Command/yasboot cluster) command is equivalent to executing ALTER SYSTEM SET … CONTAINER=CURRENT statement after logging into the CDB root. Use cases include:
