...
The SQL statement is FLASHBACK DATABASE TO ……, detailed syntax can be found in [FLASHBACK](../../../../开发手册/SQL参考手册/SQL语句/FLASHBACK.html#databaseclauses).
...
<span id="DataScope" name="DataScope" class="yaslink"></span>
...
<span id="TimeRange" name="TimeRange" class="yaslink"></span>
...
- The earliest SCN stored in existing flashback log files, obtainable via the [V$FLASHBACK_DATABASE_LOG](../../../../参考手册/系统视图/动态视图/V$FLASHBACK_DATABASE_LOG) view.

- The SCN or TIMESTAMP of the most recent execution of the following tablespace DDL operations, obtainable from [run.log](../../../运行监控/日志管理/运行日志管理).
...
- The SCN or TIMESTAMP of the most recent execution of the following file-related DDL operation, obtainable from [run.log](../../../运行监控/日志管理/运行日志管理).
