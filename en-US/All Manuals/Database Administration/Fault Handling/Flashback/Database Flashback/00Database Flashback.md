...
The SQL statement is FLASHBACK DATABASE TO ……, detailed syntax can be found in [FLASHBACK](../../../../Development Guide/SQL Reference Manual/SQL Statements/FLASHBACK.html#databaseclauses).
