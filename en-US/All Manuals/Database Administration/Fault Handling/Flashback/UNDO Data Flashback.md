...
Therefore, DBAs should comprehensively consider actual business requirements for flashback duration and disk configurations to properly plan [UNDO tablespace](../../存储管理/逻辑空间管理/表空间管理/UNDO表空间管理) configurations.
...
For syntax details, refer to the [flashback_query_clause](../../../开发手册/SQL参考手册/SQL语句/SELECT.html#flashbackqueryclause) in the SELECT statement documentation.
