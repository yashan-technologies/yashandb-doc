...
For syntax details, refer to the [flashback_query_clause](../../../Development Guide/SQL Reference Manual/SQL Statements/SELECT.html#flashbackqueryclause) in the SELECT statement documentation.
