For tables that cannot be quickly restored via [Flashback](./闪回/00闪回), you can use YashanDB's physical [Backup and Recovery](../备份与恢复/00备份与恢复) functionality and the [Import](../../Tools Guide/imp/00imp) and [Export](../../Tools Guide/exp/00exp) functionality for emergency recovery.
