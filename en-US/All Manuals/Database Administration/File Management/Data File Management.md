...
In Standalone Deployment and YAC Deployment, you can directly use the [ALTER DATABASE](../../Development Guide/SQL Reference Manual/SQL Statements/ALTER DATABASE) statement. In ISC Distributed Cluster Deployment, it is recommended to use the [yasboot](../../Tools Guide/yasboot/Introduction to yasboot Command/00Introduction to yasboot Command) operation and maintenance tool.
