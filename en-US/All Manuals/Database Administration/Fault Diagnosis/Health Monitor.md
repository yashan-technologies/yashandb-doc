...
* **[Reactive](Patrol.html#AUTO_HM_TEST)**: The fault diagnosis architecture automatically runs health checks in response to severe errors.
...
<span id="HM_TEST" name="HM_TEST" class="yaslink"></span>
...
> **Note**: 
>
> For detailed usage information, please refer to the development guide [DBMS_HM](../../开发手册/PL参考手册/内置高级包/DBMS_HM) for definitions and parameter descriptions.
>
