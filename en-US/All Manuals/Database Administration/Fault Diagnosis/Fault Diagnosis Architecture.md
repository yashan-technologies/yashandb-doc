The fault diagnosis architecture consists of multiple components, including the automatic diagnosis repository, runtime logs, and alarm logs. For runtime logs and alarm logs, please refer to the relevant descriptions in [Log Management](../运行监控/日志管理/00日志管理).
