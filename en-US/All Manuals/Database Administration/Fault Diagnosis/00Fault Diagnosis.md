...
* **[Automatic Data Capture](Dump.html#blackbox) — "Black Box"**: Automatically collects process running stack information before the database process experiences a fault crash.
