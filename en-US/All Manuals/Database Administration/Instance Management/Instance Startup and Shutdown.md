...
This document mainly introduces the instances of starting Standalone Deployment and ISC Distributed Cluster Deployment. For information on starting YAC/Distributed Cluster instances, please refer to [YAC/Distributed Cluster Startup and Shutdown](../../数据库管理/集群管理/集群启停).
...
This document mainly introduces the closing operations of Standalone Deployment and ISC Distributed Cluster Deployment instances. For information about closing YAC/Distributed Cluster instances, refer to [YAC/Distributed Cluster Startup and Shutdown](../../数据库管理/集群管理/集群启停).
