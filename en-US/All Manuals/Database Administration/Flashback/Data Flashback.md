...
Therefore, DBAs should comprehensively consider actual business requirements for flashback duration and disk configurations to properly plan [UNDO tablespace](../表空间管理/UNDO表空间管理) configurations.
