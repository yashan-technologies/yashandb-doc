...
- The SCN or TIMESTAMP of the most recent execution of the following tablespace DDL operations, obtainable from [run.log](../../日志管理/运行日志管理).
...
- The SCN or TIMESTAMP of the most recent execution of the following file-related DDL operation, obtainable from [run.log](../../日志管理/运行日志管理).
