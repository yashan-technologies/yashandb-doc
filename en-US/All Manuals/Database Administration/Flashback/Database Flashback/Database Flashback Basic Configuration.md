...
- The database must be in [archivelog mode](../../基本数据库管理/归档管理).
...
Flashback log files are backed up as part of full database backups. For detailed steps, refer to [Backup and Recovery](../../../数据库管理/备份恢复/00备份恢复).
