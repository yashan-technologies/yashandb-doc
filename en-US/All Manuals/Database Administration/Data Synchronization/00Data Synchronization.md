Data synchronization, also known as replication, refers to the real-time synchronization of data from the primary database/primary cluster to the standby database/standby cluster.
