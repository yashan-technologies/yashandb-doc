YashanDB resource management provides the ability to configure physical resources using the built-in advanced package [DBMS_RESOURCE_MANAGER](../../开发手册/PL参考手册/内置高级包/DBMS_RESOURCE_MANAGER) and related configuration parameters.

## Enable Resource Management

### Create Resource Consumer Groups

Call [DBMS_RESOURCE_MANAGER](../../开发手册/PL参考手册/内置高级包/DBMS_RESOURCE_MANAGER).CREATE_CONSUMER_GROUP to create a resource consumer group.
...
Call [DBMS_RESOURCE_MANAGER](../../开发手册/PL参考手册/内置高级包/DBMS_RESOURCE_MANAGER).CREATE_PLAN to create a resource plan.
...
Call [DBMS_RESOURCE_MANAGER](../../开发手册/PL参考手册/内置高级包/DBMS_RESOURCE_MANAGER).CREATE_PLAN_DIRECTIVE to create a resource plan directive.
...
Call [DBMS_RESOURCE_MANAGER](../../开发手册/PL参考手册/内置高级包/DBMS_RESOURCE_MANAGER).SET_CONSUMER_GROUP_MAPPING to create user mapping.

If the corresponding user does not exist, please create the user first. Refer to [Create User](../../产品安全/身份标识与鉴别/管理用户) for specific operations.
...
### Modify Related Configuration Parameters
...
If you need to change the resource consumer group mapped to a specific user, ensure that the new resource consumer group already exists. The following statement is just an example; refer to [DBMS_RESOURCE_MANAGER](../../开发手册/PL参考手册/内置高级包/DBMS_RESOURCE_MANAGER) for specific parameters.
...
Call [DBMS_RESOURCE_MANAGER](../../开发手册/PL参考手册/内置高级包/DBMS_RESOURCE_MANAGER).DELETE_CONSUMER_GROUP_MAPPING to delete user mapping relationships.

>**Note**:
>
>- When [deleting users](../../产品安全/身份标识与鉴别/管理用户), the user's mapping relationships will be deleted.
...
Call [DBMS_RESOURCE_MANAGER](../../开发手册/PL参考手册/内置高级包/DBMS_RESOURCE_MANAGER).DELETE_PLAN_DIRECTIVE to delete resource plan directives.
...
Call [DBMS_RESOURCE_MANAGER](../../开发手册/PL参考手册/内置高级包/DBMS_RESOURCE_MANAGER).DELETE_PLAN to delete a resource plan.
...
Call [DBMS_RESOURCE_MANAGER](../../开发手册/PL参考手册/内置高级包/DBMS_RESOURCE_MANAGER).DELETE_CONSUMER_GROUP to delete resource consumer groups.
