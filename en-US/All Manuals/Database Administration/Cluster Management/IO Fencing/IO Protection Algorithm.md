The in-flight I/O protection algorithm is a hardware-independent, general-purpose I/O fencing method provided by YCS. If the [shared storage device](../../../Installation and Upgrade/Installation and Deployment/Pre-Installation Preparation/Preparing the Servers.html#Storage) used for deploying the YAC does not meet the requirements for SCSI persistent reservation-based I/O fencing, the in-flight I/O protection algorithm is used by default.
