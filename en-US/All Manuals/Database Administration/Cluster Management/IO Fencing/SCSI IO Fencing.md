...
- Notes: If shared storage is mounted via multipath, please [modify the multipath configuration file](../../../Installation and Upgrade/Installation and Deployment/Pre-Installation Preparation/Configuring the Storage Devices.html#modify_multipath_conf) before configuring this method.
