...
- Notes: If shared storage is mounted via multipath, please [modify the multipath configuration file](../../../安装和升级/安装部署/安装前准备/配置存储设备.html#modify_multipath_conf) before configuring this method.
