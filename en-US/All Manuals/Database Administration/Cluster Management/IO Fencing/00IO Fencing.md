...
- [In-Flight I/O Protection Algorithm](IO Protection Algorithm): Does not rely on hardware capabilities of SAN-based shared storage, has strong compatibility, but slightly lower safety and RTO. Type code: 0.

- [SCSI Persistent Reservation-Based I/O Fencing](SCSI IO Fencing): Requires the SAN-based shared storage device to support SCSI persistent reservation commands, providing optimal safety and RTO. Type code: 1.
