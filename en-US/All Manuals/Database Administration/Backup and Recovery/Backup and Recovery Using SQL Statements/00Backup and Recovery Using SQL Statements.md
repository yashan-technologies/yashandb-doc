...
1. Check and enable the database's archiving mode.
      ...
      LOG_MODE being ARCHIVELOG indicates archiving mode, and you can directly execute the subsequent operations. If LOG_MODE is NOARCHIVELOG, it indicates non-archiving mode, and you need to first switch the database to [archiving mode](../../实例管理/归档管理).
