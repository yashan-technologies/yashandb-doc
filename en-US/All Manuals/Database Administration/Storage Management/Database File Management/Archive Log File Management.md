...
4. To avoid accidental deletion of archive log files, it is recommended to back them up first.
    ...
    In Standalone/YAC/Distributed Cluster Deployment, you can back up archive log files individually. For specific operation steps, please refer to [Backup archive log files](../../Backup and Recovery/Backup and Recovery Using SQL Statements/Backup.html#backup_arch).
