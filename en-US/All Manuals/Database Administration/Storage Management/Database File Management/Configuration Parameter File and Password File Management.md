...
> **Caution**: 
>
>In general, it is not recommended to edit the database configuration file directly to modify configuration parameters, as this may lead to unpredictable anomalies. If modification is necessary, please use SQL commands. For detailed operations, refer to [ALTER SYSTEM](../../../开发手册/SQL参考手册/SQL语句/ALTER SYSTEM).
...
> **Note**: 
>
>A new password file can only be generated when the yasdb.pwd file does not exist. Therefore, before modifying the password, you should first delete or rename yasdb.pwd. For detailed operations, refer to the tool manual [yaspwd](../../../工具手册/yaspwd).
