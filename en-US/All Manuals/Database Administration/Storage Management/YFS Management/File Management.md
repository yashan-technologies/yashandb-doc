YFS provides the following file management interfaces:
...
Use the `ls` command to view the file list. For detailed usage, please refer to the [yfscmd](../../../工具手册/yfscmd/00yfscmd) documentation.
