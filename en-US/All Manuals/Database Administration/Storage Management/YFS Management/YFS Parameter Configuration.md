...
Generally, you can adjust parameter configurations by modifying the parameter file and then restart the YFS service for the configurations to take effect. You can also use the [`exec` command](../../../工具手册/yfscmd/修改参数命令) of *yfscmd* to adjust some parameters that support online modification (i.e., Immediate Effect of Changes = Yes).
