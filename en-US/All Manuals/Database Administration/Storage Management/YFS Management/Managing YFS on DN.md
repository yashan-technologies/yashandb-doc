...
DN and CN use the unified file service terminal yfscmd, which can be started in either interactive or non-interactive mode (refer to [yfscmd command guide](../../../工具手册/yfscmd/00yfscmd)).
