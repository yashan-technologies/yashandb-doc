...
When creating table objects using [CREATE TABLE](../../../开发手册/SQL参考手册/SQL语句/CREATE TABLE) without specifying a TABLESPACE, the default is the user's associated tablespace. Table data will enter the planned storage space, while temporary table data will enter the system's temporary tablespace.
...
>
> Especially in scenarios with many table partitions and columns, inserting data may lead to insufficient tablespace errors. Reference error code [YAS-02007](../../../参考手册/错误码) for handling methods.

## Space Optimization

Database administrators can manage table storage space through SQL statements. For detailed syntax descriptions, please refer to the development manual [CREATE TABLE](../../../开发手册/SQL参考手册/SQL语句/CREATE TABLE) and [ALTER TABLE](../../../开发手册/SQL参考手册/SQL语句/ALTER TABLE).
