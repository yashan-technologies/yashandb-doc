...
The initial size of the USERS_AIM tablespace set is defined by the parameter mms_tablespace_set_size in the [Database Creation Parameters](../../../../工具手册/yasboot/建库参数). Users can configure the value of this parameter during installation based on resource requirements.
