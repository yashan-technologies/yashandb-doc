In daily use, database administrators can customize tablespaces as needed by adding, deleting, or modifying them. For detailed syntax descriptions regarding tablespace management, please refer to the development manual [CREATE TABLESPACE](../../../../开发手册/SQL参考手册/SQL语句/CREATE TABLESPACE), [ALTER TABLESPACE](../../../../开发手册/SQL参考手册/SQL语句/ALTER TABLESPACE), and [DROP TABLESPACE](../../../../开发手册/SQL参考手册/SQL语句/DROP TABLESPACE).
