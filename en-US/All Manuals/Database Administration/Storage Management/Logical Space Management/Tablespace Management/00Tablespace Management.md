...
The calculation method for tablespace capacity is as follows: the initial database tablespace capacity (i.e., data file size and number) created during installation can be specified through the [Database Creation Parameters](../../../../工具手册/yasboot/建库参数).
