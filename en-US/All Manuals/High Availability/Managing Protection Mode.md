...
Execute the [ALTER DATABASE SET STANDBY DATABASE TO](../Development Guide/SQL Reference Manual/SQL Statements/ALTER DATABASE.html#set_standby_clause) statement to switch the database protection mode as needed.
