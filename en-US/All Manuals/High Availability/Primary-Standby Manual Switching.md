...
HA_ELECTION_ENABLED = TRUE indicates that leader election is enabled. You need to [disable leader election](Configuring Leader Election/Configuring Leader Election for One Primary and Multi-Standby.html#close_election) before proceeding with subsequent operations.
