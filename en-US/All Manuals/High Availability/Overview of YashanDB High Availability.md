...
- [Backup and Recovery](../数据库管理/备份与恢复/00备份与恢复): As a routine measure for database management, backup and recovery ensure the security of the database data, which is the most fundamental capability for high availability.
