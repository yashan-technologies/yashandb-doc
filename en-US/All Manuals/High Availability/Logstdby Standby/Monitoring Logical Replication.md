After configuring a logical standby database, DBAs should monitor and manage the daily usage, logical replication, and replay of the logical standby database through views such as DBA_LOGSTDBY_EVENTS, V$DIAG_INCIDENT, and V$LOGSTDBY_PROGRESS on the standby database.  

##  Related Views

### DBA\_LOGSTDBY\_EVENTS

The [DBA_LOGSTDBY_EVENTS](../../Reference Manual/System Views/DBA Views/DBA_LOGSTDBY_EVENTS) view records the following information:
...
The [V$LOGSTDBY_PROGRESS](../../Reference Manual/System Views/Dynamic Performance Views/V$LOGSTDBY_PROGRESS) view records the replay progress of the logical standby database.
