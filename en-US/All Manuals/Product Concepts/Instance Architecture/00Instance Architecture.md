...
There are slight diffrences in instance architecture under YashanDB's diffrent deployment forms (Standalone(primary/standby)/YAC/Distributed) by the following description.
