...
- Adjust the [connection listener](../实例架构/应用程序与网络体系.html#Listener)'s operating mode when necessary, placing it in maintenance mode, maintaining only existing connections and blocking other new connections (except local connections initiated by sys users).
