...
- Recycle bin object flashback: Recovers accidentally dropped objects (e.g., tables) from the Recycle Bin, making deletion operations reversible and rapidly recoverable.

- UNDO data flashback: Enables querying/restoring historical data of existing tables.
...
##  Recycle Bin Object Flashback

Recycle Bin Object Flashback (FLASHBACK TABLE ... TO BEFORE) refers to restoring deleted tables/partitions and their data, i.e., restoring tables/partitions and their sub-objects in the recycle bin. It can be regarded as the reverse operation of DROP, TRUNCATE, and ALTER TABLE TRUNCATE PARTITION.  
...
UNDO data flashback enables querying historical versions of table data:
...
UNDO data flashback enables querying past data without restoring backups. The database uses timestamps/SCNs to locate historical states and applies UNDO logs to reconstruct results.
