...
YFS redundancy levels are divided into EXTERNAL, NORMAL, and HIGH, with redundancy levels increasing in order. If specified as EXTERNAL, there is no data redundancy, and data reliability depends on external capabilities, such as RAID.  

| Level of Redundancy | Number of file replicas in system DiskGroup | Number of user data replicas in data DiskGroup | Number of YFS metadata replicas in data DiskGroup |
| ---------- | ------ | ----------- | --------------- |
| EXTERNAL   | 1      | 1           | 1               |
| NORMAL     | 2 ~ 3  | 2           | 2 ~ 3           |
| HIGH       | 5      | 3           | 3 ~ 5           |
