...
- If the number of SCAN VIPs exceeds the number of database instance nodes, when performing cluster instance expansion, additional SCAN VIPs will automatically relocate to new instance nodes.
