...
| LAST_UPDATE_TIME | TIMESTAMP| The last time the view data was retrieved, i.e., the end SCN of the last occurrence of the corresponding event's wait time distribution in the current time interval. |