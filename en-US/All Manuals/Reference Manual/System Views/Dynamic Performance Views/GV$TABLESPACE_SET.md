...
| DATAFILES_COUNT        | NUMBER       | Total number of data files in this tablespace collection |
...
| DATABUCKETS_COUNT      | NUMBER       | Total number of DATABUCKET files in this tablespace collection |
