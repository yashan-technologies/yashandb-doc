...
| LAST_UPDATE_TIME | TIMESTAMP | The time of the last data retrieval for the current view, specifically the end SCN for the last time the corresponding event's wait time distribution fell within the current time interval |