...
| EVENT_TIMESTAMP          | TIMESTAMP(6)      | Event occurrence time |
| ACTION                   | INTEGER        | Audit type. The audit action name associated with an audit type can be identified by querying the database view V$AUDITABLE_SYSTEM_ACTIONS.     |
