...
| STATE                | VARCHAR(16) | Node static state, such as INVALID (invalid value), INIT (initialization), REMOVED (removed), STARTED (started), STOPPED (stopped), ISOLATED (isolated) |
...
| CREATE_TIME          | TIMESTAMP   | Node creation time                                           |
| LAST_UPDATE_TIME     | TIMESTAMP   | Last update time of node static information                  |
| STATUS_UPDATE_TIME    | TIMESTAMP   | Last update time of node dynamic information                  |