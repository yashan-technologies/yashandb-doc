...
| PRELOAD_BEGIN_TIME | TIMESTAMP | Start time of memory-mapped tablespace preloading |
| PRELOAD_END_TIME | TIMESTAMP | End time of memory-mapped tablespace preloading |
| PRELOAD_BEGIN_TIME | TIMESTAMP | Memory-mapped tablespace preload start time |
| PRELOAD_END_TIME | TIMESTAMP | Memory-mapped tablespace preload end time |