...
| LAST_ACTIVE_TIME       | TIMESTAMP(6)    | Last active time, used to determine if the thread is stuck |
| LAST_TASK_START_TIME   | TIMESTAMP(6)    | Start time of the most recent parallel task execution |
| LAST_TASK_END_TIME     | TIMESTAMP(6)    | End time of the most recent parallel task execution |
