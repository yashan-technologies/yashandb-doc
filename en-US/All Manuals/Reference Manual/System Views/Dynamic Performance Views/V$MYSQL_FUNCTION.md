This view displays the information of built-in functions that are additionally provided by the current system in mysql mode. For the detailed list, please refer to the development manual [Built-in Functions](../../../Development Guide/SQL Reference Manual/Built-in Functions (mysql Mode)/00Built-in Functions (mysql Mode)).
