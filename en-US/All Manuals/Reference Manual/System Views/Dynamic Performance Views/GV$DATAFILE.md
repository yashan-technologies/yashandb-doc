...
| NEXT_SIZE | BIGINT | Size of each extension for the Data file (unit: bytes) |
| MAX_SIZE | BIGINT | Maximum size to which the Data file can extend (unit: bytes) |
| FREE_BLOCKS | INTEGER | Number of free and available data blocks in the Data file |
| DISK_BYTES | BIGINT | Physical disk space occupied (unit: bytes) |
