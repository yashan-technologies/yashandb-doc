...
| LAST_TASK_START_TIME | TIMESTAMP(6) | Time when the worker last started executing a task after registering it |
| LAST_TASK_END_TIME | TIMESTAMP(6) | Time when the worker last finished executing a task after registering it; NULL if currently not finished |
