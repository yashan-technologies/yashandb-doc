...
| BEGIN_TIME | TIMESTAMP | Time when instance recovery started |
| END_TIME | TIMESTAMP | Time when instance recovery ended |
...
| GLOBAL_RESOURCE_AVAILABLE_TIME | TIMESTAMP | Time when global resources are available |
| COMPLETE_RECOVERY_TIME | TIMESTAMP | Time when the instance recovery is fully available |
