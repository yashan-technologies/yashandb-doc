...
| CREATE_TIME     | TIMESTAMP(6)     | Creation time of the xfmr task                                                                                |
| START_TIME      | TIMESTAMP(6)     | Start execution time of the xfmr task                                                                         |
| FINISH_TIME     | TIMESTAMP(6)     | End execution time of the xfmr task                                                                           |
