...
| BEGIN_TIME | TIMESTAMP(6) | The start time of the instance recovery |
| GLOBAL_RESOURCE_AVAILABLE_TIME | TIMESTAMP(6) | The time when global resources are available |
| COMPLETE_RECOVERY_TIME | TIMESTAMP(6) | The time when the instance recovery is fully available |
| END_TIME | TIMESTAMP(6) | The end time of the instance recovery |
