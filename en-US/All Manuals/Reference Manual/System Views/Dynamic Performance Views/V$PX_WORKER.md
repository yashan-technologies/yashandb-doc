...
| LAST_ACTIVE_TIME       | TIMESTAMP    | Last active time, used to judge if the thread is stuck |
| LAST_TASK_START_TIME  | TIMESTAMP    | Start time of the most recent parallel task executed |
| LAST_TASK_END_TIME    | TIMESTAMP    | End time of the most recent parallel task executed |
