In Standalone and YAC Deployment, this view displays the summary information of the current instance's database and the instance ID.
...
| RESTORE_TIME | TIMESTAMP | SCN of the database restore  |
