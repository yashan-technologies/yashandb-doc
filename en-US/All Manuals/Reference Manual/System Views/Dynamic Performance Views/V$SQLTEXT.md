...
| SQL_TEXT     | VARCHAR(1000) | Slice the SQL text by maximum 1000 characters width, and the corresponding text fragment sequence number is the PIECE field value          |