...
| LAST_UPDATE_TIME | TIMESTAMP | Last update time of the node static information |
| STATUS_UPDATE_TIME | TIMESTAMP | Last update time of the node dynamic information |