...
| UPDATE_RULE                 | VARCHAR(9) | The cascade update rule for the foreign key constraint (RESTRICT, CASCADE, SET NULL) |
| DELETE_RULE                 | VARCHAR(9) | The cascade delete rule for the foreign key constraint (RESTRICT, CASCADE, SET NULL) |
