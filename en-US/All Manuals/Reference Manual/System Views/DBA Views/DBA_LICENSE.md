...
| ACCREDIT_DATE         | TIMESTAMP   | Authorization time for LICENSE                               |
| DEADLINE              | TIMESTAMP   | LICENSE expiration date                                      |
| ACCREDIT_CLUSTER_TYPE  | VARCHAR(64) | Authorized cluster type<br>\*   Standalone Deployment and YAC Deployment (ALL)<br>\*   YAC Deployment (CE)<br>\*   Standalone Deployment (SE) |
