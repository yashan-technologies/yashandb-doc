...
| CHECKPOINT_TIME  | TIMESTAMP(6)       | Time point for database consistency recovery; if empty, the database has been upgraded from an old version to a new version, and this item need not be referenced |
