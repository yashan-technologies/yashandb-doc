...
| LAST_DATE    | TIMESTAMP WITH TIME ZONE | The last execution time of the JOB                      |
| LAST_SEC     | VARCHAR(8)               | Same as LAST_DATE                                       |
| THIS_DATE    | TIMESTAMP WITH TIME ZONE | If the JOB is currently executing, this is the start time of the current execution. Usually NULL |
| THIS_SEC     | VARCHAR(8)               | Same as THIS_DATE                                       |
| NEXT_DATE    | TIMESTAMP WITH TIME ZONE | The next execution time of the JOB                      |
