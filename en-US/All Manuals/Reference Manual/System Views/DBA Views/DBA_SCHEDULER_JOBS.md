...
| END_DATE            | TIMESTAMP WITH TIME ZONE     | The time when the JOB ends executing                                                       |
...
| LAST_START_DATE     | TIMESTAMP WITH TIME ZONE     | The time when the JOB was last started                                                    |
| LAST_RUN_DURATION   | INTERVAL DAY(9) TO SECOND(6) | The duration of the last execution of the JOB (in seconds)                                |
| NEXT_RUN_DATE       | TIMESTAMP WITH TIME ZONE     | The time when the JOB will next run                                                       |
