...
| STALE_STATS            | CHAR(1)     | Whether the statistics are stale, in the current version YAC/Distributed Cluster Deployment mode, the stale judgment is based only on the modifications of the current instance<br/>* Y: Stale<br/>* N: Not stale<br/>* Empty: Statistics not collected |
