...
| _COST_AGGR                                   | Operator cost, not available in the official version. |
...
| COST_INDEX_RANGE_SCAN_MIN_MAX                | Operator cost, not available in the official version.  |
| _COST_INDEX_FULL_SCAN_MIN_MAX                  | Operator cost, not available in the official version.  |
...
| _COST_SDT_WINFUNC                            | Operator cost, not available in the official version.                                           |
...
| _OPTIMIZER_ADAPTIVE_CURSOR_SHARING | Controls whether different parameter value ranges affect plan generation; default is `TRUE`. |
