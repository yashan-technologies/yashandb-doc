...
<span id="aalarm" name="aalarm" class="yaslink"></span>
...
<span id="calarm" name="calarm" class="yaslink"></span>
...
- Check the Failover conditions triggered by the primary database, fix them, restart, and determine whether to execute a switchover based on business needs.
...
<span id="dalarm" name="dalarm" class="yaslink"></span>
...
In YAC Deployment, when YCS instances and database instances are kicked out of the cluster, it will wait for in-flight IO to finish before force exiting, to avoid data corruption, and report an alarm.
...
<span id="ealarm" name="ealarm" class="yaslink"></span>
...
<span id="ialarm" name="ialarm" class="yaslink"></span>
...
- Check the alarm events and clear the related alarms.

<span id="lalarm" name="lalarm" class="yaslink"></span>
...
- Apply for a new license to update the soon-to-expire license.
...
<span id="malarm" name="malarm" class="yaslink"></span>
...
- Use the *yasboot* tool to modify the configuration parameter RESOURCE_MANAGER_PLAN to keep it globally consistent.
...
- Use an existing plan in the system.

<span id="salarm" name="salarm" class="yaslink"></span>
...
<span id="valarm" name="valarm" class="yaslink"></span>
