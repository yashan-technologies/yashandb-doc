...
### YAS-00523
**Message**: process has exited abnormally or no longer exists, pid %d, errno %d
...
### YAS-02585
**Message**：command only allowed in a CDB
...
**Action**: Please specify the correct encryption algorithm. If you need to use national cryptography algorithms, please ensure the database server has installed [OpenSSL that meets the version requirements](../Installation and Upgrade/Installation and Deployment/Pre-Installation Preparation/Preparing Dependencies.html#openssl).
...
### YAS-02894
**Message**: cannot change private parameter on the CDB root with CONTAINER=ALL
...
### YAS-02909
**Message**: CONTAINER clause may only be specified when connected to a CDB
...
### YAS-02914
**Message**: the current pluggable database is unavailable

**Action**: The current PDB is unavailable due to RESTORE failure. Please check the RESTORE environment and re-execute the RESTORE operation for this PDB.
...
**Action**: Enable the build ac feature using the ALTER TABLE statement, refer to the [enable_xfmr_clause](../Development Guide/SQL Reference Manual/SQL Statements/ALTER TABLE.html#enablexfmrclause) in the ALTER TABLE documentation.
...
**Action**: Disks under this disk group were not found. Please first check whether the disks on primary and standby nodes are correctly mounted and can read/write normally. If the issue cannot be resolved, please contact our technical support for assistance.
...
### YAS-05777
**Message**: failed to remove database/pdb, reason: %s
...
### YAS-05779
**Message**: no database configured for cluster
...
**Action**: Please correct the AUTOTRACE related option to a valid value according to the syntax introduction of [SET AUTOTRACE](../Development Guide/SQL Reference Manual/SQL Statements/SET AUTOTRACE).
...
**Action**: It is not supported in mysql mode.
...
### YAS-08427
**Message**: failed to update memory limit for container %s, because the requested value % PRIu64 is lower than the current usage % PRIu64
...
**Action**: BLOB, TEXT, GEOMETRY, or JSON columns cannot be set with DEFAULT 'XXX'.
