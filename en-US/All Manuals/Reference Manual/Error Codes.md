...
**Action**: If in an ISC Distributed Cluster Deployment environment, it indicates too many unresolved distributed transactions; please retry later. If in YAC Deployment environment, you can try switching instances to perform operations.
...
**Action**: In YAC Deployment, the master instance cannot manage redo files of an online instance; please connect directly to the online instance to operate its redo files.
...
**Action**: The YAC has not been created yet. Please create the cluster first before performing other operations.
