...
- [mysql mode](../../Reference Manual of mysql Mode/Overview of mysql Mode): In this mode, SQL statements entered by the user will be parsed according to MySQL's syntax, suitable for scenarios that require close compatibility with MySQL databases.
...
For more details, please refer to [Data Types (mysql mode)](../../Reference Manual of mysql Mode/SQL Reference/Data Types/00Data Types).
