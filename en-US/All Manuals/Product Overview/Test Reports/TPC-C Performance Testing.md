...
In practical use, you should also adjust the redo files, DATA files, and related configurations in a timely manner; for details, refer to [File Management](../../Database Administration/File Management/00File Management).
