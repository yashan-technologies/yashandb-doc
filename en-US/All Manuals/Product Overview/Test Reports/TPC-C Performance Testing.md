...
![](./image/runDBbuild.png)

3. Press **i** to enter edit mode and change that section to the following:
...
For detailed descriptions of database configuration parameters, please refer to [Configuration Parameters](../../Reference Manual/Configuration Parameters).
...
In practical use, you should also adjust the redo files, DATA files, and related configurations in a timely manner; for details, refer to [Database File Management](../../Database Administration/Storage Management/Database File Management/00Database File Management).
...
For detailed introductions to database configuration parameters and creation configuration tuning, please refer to [Database Configuration Tuning](../../Performance Tuning/Database Performance Fundamentals/Database Configuration Tuning).
