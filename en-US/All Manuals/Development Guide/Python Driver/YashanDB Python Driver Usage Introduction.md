...
When connecting to the database, use the connect() function provided by the python-yaspy module to establish a database connection. This returns a [connection object](./Python接口支持说明/连接对象).
