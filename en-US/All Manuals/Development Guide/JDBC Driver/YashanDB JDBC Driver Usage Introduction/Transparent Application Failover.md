...
Using TAF-related functions requires configuring some parameters during database connection. Please refer to [Configuring High Availability Connections](./连接数据库/配置高可用连接) for details.
