...
1. Refer to the [YashanDB Software Package List](../../Installation and Upgrade/Installation and Deployment/Pre-Installation Preparation/Downloading Software Packages) to obtain the YashanDB JDBC driver installation package yasdb-jdbc-*version*.jar, for example, yasdb-jdbc-{version_number}.jar.
