...
2. Download the YashanDB client installation package and extract it to a local path, for example, `D:\Program Files\yashandb-client-{version}`.
...
1. Refer to the [YashanDB Software Package List](../../../Installation and Upgrade/Installation and Deployment/Pre-Installation Preparation/Downloading Software Packages) to obtain the YashanDB Go driver installation package.
