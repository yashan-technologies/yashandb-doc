...
3. Enable supplemental logging in one of the following two ways:
  ...
  - [Database-level supplemental logging](../SQL参考手册/SQL语句/ALTER DATABASE.html#supplementallogclauses):
  ...
  - [Table-level supplemental logging](../SQL参考手册/SQL语句/ALTER DATABASE.html#addsupplementalloggingclause):
