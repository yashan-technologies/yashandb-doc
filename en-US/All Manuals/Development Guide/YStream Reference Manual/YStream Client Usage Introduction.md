...
Please refer to the [YashanDB Software Package List](../../安装和升级/安装部署/安装前准备/下载软件包) to obtain the YStream client installation package for YashanDB: Ystream-{version}.jar. For example, visit the Download Center [https://download.yashandb.com/download](https://download.yashandb.com/download) to download directly.
