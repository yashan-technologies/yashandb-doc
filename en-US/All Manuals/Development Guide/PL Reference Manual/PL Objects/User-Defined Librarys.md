...
Use the [CREATE LIBRARY](../../SQL Reference Manual/SQL Statements (yashan Mode)/CREATE LIBRARY) statement to create a custom library, defined by the following syntax:
...
Use the [DROP_LIBRARY](../../SQL Reference Manual/SQL Statements (yashan Mode)/DROP LIBRARY) statement to delete a custom library.