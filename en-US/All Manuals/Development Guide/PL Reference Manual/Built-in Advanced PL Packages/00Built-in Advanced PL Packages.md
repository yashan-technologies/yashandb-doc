...
- GIS data processing related

  [CREATE_PGR_CREATETOPOLOGY](CREATE_PGR_CREATETOPOLOGY)

Based on the above built-in advanced packages, users can perform real-time functionality operations in the SQL client. For specific functionality descriptions of each advanced package, refer to the relevant documentation. Users can also utilize [Package](../PL对象/自定义高级包) functionality for more customized development.
