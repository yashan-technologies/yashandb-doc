...
Global variables used within the procedure body must be explicitly declared before the BEGIN keyword.
...
Here, the data type is the same as the [regular scalar data types](../../../SQL Reference Manual/Data Types (yashan Mode)/00Data Types (yashan Mode)) defined in SQL.
