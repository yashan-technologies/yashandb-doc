...
A [SELECT](../../../SQL参考手册/SQL语句/SELECT) statement that does not allow specifying placeholders (bind parameters). This section can utilize the INTO clause for compatibility purposes, but it has no actual effect.
