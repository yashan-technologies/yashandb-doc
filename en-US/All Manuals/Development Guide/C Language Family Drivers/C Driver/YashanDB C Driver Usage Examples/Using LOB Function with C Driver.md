...
| ------------------------------------------------------------ | ------------------------------------------- |
| [yacLobDescAlloc](../YashanDB C Driver Interfaces/Deprecated Functions/yacLobDescAlloc) | Allocates space for loblocator in LOB protocol |
| [yacLobCreateTemporary](../YashanDB C Driver Interfaces/Deprecated Functions/yacLobCreateTemporary) | Notifies the server to create a temporary LOB in LOB protocol |
| [yacLobWrite](../YashanDB C Driver Interfaces/Deprecated Functions/yacLobWrite)  | Uploads data from buf and stores it in the server LOB in LOB protocol |
| [yacLobFreeTemporary](../YashanDB C Driver Interfaces/LOB Functions/yacLobFreeTemporary) | Notifies the server to release the temporary LOB in LOB protocol |
| [yacLobDescFree](../YashanDB C Driver Interfaces/Deprecated Functions/yacLobDescFree) | Releases space for loblocator in LOB protocol |
| [yacLobRead](../YashanDB C Driver Interfaces/Deprecated Functions/yacLobRead)    | Reads data from the server LOB into buf in LOB protocol |
| [yacLobDescAlloc2](../YashanDB C Driver Interfaces/LOB Functions/yacLobDescAlloc2) | Allocates space for loblocator in LOB protocol |
| [yacLobRead2](../YashanDB C Driver Interfaces/LOB Functions/yacLobRead2)          | Reads LOB data from a specific location in LOB protocol |
| [yacLobWrite2](../YashanDB C Driver Interfaces/LOB Functions/yacLobWrite2)        | Inserts data into LOB from a specific location in LOB protocol |
| [yacLobWriteAppend](../YashanDB C Driver Interfaces/LOB Functions/yacLobWriteAppend) | Appends data to the end of the LOB in LOB protocol |
| [yacLobTrim](../YashanDB C Driver Interfaces/LOB Functions/yacLobTrim)            | Trims the LOB data in LOB protocol           |
| [yacLobDescFree2](../YashanDB C Driver Interfaces/LOB Functions/yacLobDescFree2)  | Releases space for loblocator in LOB protocol |
