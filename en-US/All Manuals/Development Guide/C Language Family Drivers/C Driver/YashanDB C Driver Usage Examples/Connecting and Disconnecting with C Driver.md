...
| ------------------------------------------------------------ | ---------------------- |
| [yacAllocHandle](../YashanDB C Driver Interfaces/Handle and Descriptor Functions/yacAllocHandle) | Allocate space for handle |
| [yacFreeHandle](../YashanDB C Driver Interfaces/Handle and Descriptor Functions/yacFreeHandle) | Free handle space      |
| [yacConnect](../YashanDB C Driver Interfaces/Connection & Authorization & Initialization Functions/yacConnect) | Client initiates connection request |
| [yacDisconnect](../YashanDB C Driver Interfaces/Connection & Authorization & Initialization Functions/yacDisconnect) | Client initiates disconnection request |
