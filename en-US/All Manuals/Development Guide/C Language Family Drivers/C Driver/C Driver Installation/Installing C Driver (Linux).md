...
At this point, the YashanDB C driver has been successfully installed. For character set-related configuration adjustments, please refer to [Character Set Configuration](../../../../数据库管理/实例管理/数据库字符集配置).
