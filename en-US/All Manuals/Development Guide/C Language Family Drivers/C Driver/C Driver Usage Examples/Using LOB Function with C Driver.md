...
| ------------------------------------------------------------ | ------------------------------------------- |
| [yacLobDescAlloc](../C驱动接口说明/已弃用的函数/yacLobDescAlloc) | Allocates space for loblocator in LOB protocol |
| [yacLobCreateTemporary](../C驱动接口说明/已弃用的函数/yacLobCreateTemporary) | Notifies the server to create a temporary LOB in LOB protocol |
| [yacLobWrite](../C驱动接口说明/已弃用的函数/yacLobWrite)  | Uploads data from buf and stores it in the server LOB in LOB protocol |
| [yacLobFreeTemporary](../C驱动接口说明/LOB函数/yacLobFreeTemporary) | Notifies the server to release the temporary LOB in LOB protocol |
| [yacLobDescFree](../C驱动接口说明/已弃用的函数/yacLobDescFree) | Releases space for loblocator in LOB protocol |
| [yacLobRead](../C驱动接口说明/已弃用的函数/yacLobRead)    | Reads data from the server LOB into buf in LOB protocol |
| [yacLobDescAlloc2](../C驱动接口说明/LOB函数/yacLobDescAlloc2) | Allocates space for loblocator in LOB protocol |
| [yacLobRead2](../C驱动接口说明/LOB函数/yacLobRead2)          | Reads LOB data from a specific location in LOB protocol |
| [yacLobWrite2](../C驱动接口说明/LOB函数/yacLobWrite2)        | Inserts data into LOB from a specific location in LOB protocol |
| [yacLobWriteAppend](../C驱动接口说明/LOB函数/yacLobWriteAppend) | Appends data to the end of the LOB in LOB protocol |
| [yacLobTrim](../C驱动接口说明/LOB函数/yacLobTrim)            | Trims the LOB data in LOB protocol           |
| [yacLobDescFree2](../C驱动接口说明/LOB函数/yacLobDescFree2)  | Releases space for loblocator in LOB protocol |
