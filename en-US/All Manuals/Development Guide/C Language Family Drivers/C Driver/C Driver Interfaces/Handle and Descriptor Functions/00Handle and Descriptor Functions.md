...
In application development, the above hierarchical order should be followed for handle allocation and release. Among these, LOB descriptors, as special descriptors, must be allocated and released from the CONN handle using the [yacLobDescAlloc2](../LOB函数/yacLobDescAlloc2) function.
