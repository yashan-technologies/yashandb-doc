...
- ROWSCN cannot be used in the WHEN clauses, insert_values_clause, or subquery for [multi-table conditional inserts](../SQL Statements/INSERT.html#conditionalinsertclause).
...
- ROWID cannot be used in the WHEN clauses, insert_values_clause, or subquery for [multi-table conditional inserts](../SQL Statements/INSERT.html#conditionalinsertclause).
