...
- ROWSCN cannot be used in the WHEN clauses, insert_values_clause, or subquery for [multi-table conditional inserts](../SQL Statements (yashan Mode)/INSERT.html#conditionalinsertclause).
...
The ROWID pseudocolumn indicates the address of the row. The type of the ROWID pseudocolumn is ROWID. For usage restrictions and more information, please refer to [ROWID UROWID](../Data Types (yashan Mode)/ROWID and UROWID Types).

- This pseudocolumn is applicable only to HEAP tables.

- ROWID cannot be used in the WHEN clauses, insert_values_clause, or subquery for [multi-table conditional inserts](../SQL Statements (yashan Mode)/INSERT.html#conditionalinsertclause).
