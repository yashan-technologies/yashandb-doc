...
The CHAR_LENGTH/CHARACTER_LENGTH function counts the number of characters in [expr](../General SQL Syntax/expr) and returns a BIGINT value. CHAR_LENGTH, CHARACTER_LENGTH, and [LENGTH](LENGTH LENGTHB) functions are synonymous with each other.
