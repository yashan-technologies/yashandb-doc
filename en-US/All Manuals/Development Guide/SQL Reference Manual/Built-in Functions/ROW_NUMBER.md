...
ROW_NUMBER is a [window function](00Built-in Functions.html#WindowFunction) with a syntax and constraints consistent with the [DENSE_RANK function](DENSE_RANK) and the [RANK function](RANK), differing in how it handles ties during sorting:
