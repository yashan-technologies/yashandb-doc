...
The NVL function evaluates from left to right and returns the value of the first non-null expression among the two [expr](../General SQL Syntax/expr) parameters.
