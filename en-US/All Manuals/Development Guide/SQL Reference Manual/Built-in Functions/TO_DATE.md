...
The TO_DATE function converts the value of [expr](../General SQL Syntax/expr) to a DATE type data, and the return value is in the default format of DATE type data.
