...
The ARRAY_NDIMS function calculates the number of dimensions (nesting depth) of an array ([array variable](../../PL Reference Manual/PL Language Fundamentals/Variables/Collection Variables), [array object](../../PL Reference Manual/PL Objects/User-Defined Types), [array type](../Data Types/User-Defined Types) called array_var, returning an INT type value.
