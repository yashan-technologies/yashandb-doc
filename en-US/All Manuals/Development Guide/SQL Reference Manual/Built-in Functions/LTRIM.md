...
The LTRIM function removes characters that match trim_character from the left side of the value of [expr](../General SQL Syntax/expr), resulting in a new substring.
