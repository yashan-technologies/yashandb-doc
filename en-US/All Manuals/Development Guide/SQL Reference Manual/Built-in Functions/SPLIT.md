...
The SPLIT function divides the string represented by [expr](../General SQL Syntax/expr) into several substrings based on the specified delimiter, returning the nth substring.
