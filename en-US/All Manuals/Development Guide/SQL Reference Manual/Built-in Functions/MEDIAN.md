...
The MEDIAN function calculates the median of the given parameter [expr](../General SQL Syntax/expr). It only supports expr types of [numeric](../数据类型/数值型) or [date-time](../数据类型/日期时间型). Using other data types will result in an error.
