...
The SUBSTRING function is used to extract a substring of a specified length from a source string [expr](../General SQL Syntax/expr) starting at a specified position.
