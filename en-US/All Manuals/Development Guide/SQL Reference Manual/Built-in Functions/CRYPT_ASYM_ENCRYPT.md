...
The CRYPT_ASYM_ENCRYPT function encrypts [expr1](../General SQL Syntax/expr) using the public key [expr2](../General SQL Syntax/expr) and returns the encryption result.
