...
The CHR function converts the decimal code represented by [expr](../General SQL Syntax/expr) into the corresponding character according to the database character set, returning a result of VARCHAR type.
