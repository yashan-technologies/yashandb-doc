...
The DAYOFWEEK function is used to calculate the day of the week for the [expr](../General SQL Syntax/expr) based on the week, with Sunday as the first day, returning an INT type value.
