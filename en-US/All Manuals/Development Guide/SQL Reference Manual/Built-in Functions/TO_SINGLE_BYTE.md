...
This function will only take effect when the [character set](../../../数据库管理/实例管理/数据库字符集配置) configured in the database includes both single-byte and multi-byte characters.
