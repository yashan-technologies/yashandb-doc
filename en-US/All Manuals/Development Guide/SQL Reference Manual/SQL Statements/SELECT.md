...
```ebnf+diagram
syntax::= ((query_name|query_containers|subquery)[sample_clause][flashback_query_clause][t_alias][pivot_clause|unpivot_clause]) {"," ((query_name|query_containers|subquery) [sample_clause][flashback_query_clause][t_alias][pivot_clause|unpivot_clause])}
```
...
```ebnf+diagram
syntax::= CONTAINERS "(" ([schema"."] query_name) ")"
```
...
The table() can be used for queries, for specific descriptions of table functions, refer to  [Built-in Table Functions](../Built-in Functions/00Built-in Functions.html#tableFunc).
...
<span id="querycontainers" name="querycontainers" class="yaslink"></span>

###### 1.1.5.4. query\_containers
...
###### 1.1.5.5. flashback\_query\_clause
