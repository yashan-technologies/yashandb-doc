...
***Example*** for Standalone Deployment and YAC Deployment: Session 1—Under the sales user, execute the following statement:

```sql
SELECT area_no,area_name,DHQ FROM area WHERE area_no='01' FOR UPDATE;
```
***Example*** for Standalone Deployment and YAC Deployment: Session 2—Under the sales user, execute the following statement:
...
***Example*** for Standalone Deployment and YAC Deployment: Session 3—Under a DBA privilege user, execute the following statement:
...
This statement is used to manually clean up YAC message pool and can only be used in YAC Deployment.
