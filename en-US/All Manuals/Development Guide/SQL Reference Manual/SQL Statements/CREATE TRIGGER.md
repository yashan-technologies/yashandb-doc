...
Triggers are PL objects, and their creation must be implemented using procedural language. It must comply with all the specifications and constraints of the PL implemented by YashanDB (including variables, parameters, statements, etc.). For specific descriptions, please refer to the [PL Reference Manual](../../PL Reference Manual/00PL Reference Manual).

For a detailed description of the syntax of CREATE TRIGGER, please refer to the [Triggers](../../PL Reference Manual/PL Objects/Triggers) section of the PL Reference Manual.