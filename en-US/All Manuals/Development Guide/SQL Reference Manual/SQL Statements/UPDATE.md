...
This statement is used to specify the object to be updated, which can be a table name (including tables from local databases or [remote tables](../通用SQL语法/dblink/dblink语法说明)), partition names of tables, view names, or subqueries, and an alias can be assigned to it.
