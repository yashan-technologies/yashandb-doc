...
CREATE PROFILE is used to create a profile, which is a collection of resource limits imposed by the system on users. In YashanDB, profiles can define limitations related to [password usage policies](../../../Product Security/Identity Identification and Authentication/Password Authentication/Password Policy.html#password_policy), [session resources](../../../Product Security/Resource Control/Session Resource Control), and [connection request IPs](../../../Product Security/Connection Management/IP Blacklist and Whitelist Management).
