...
CREATE PROFILE is used to create a profile, which is a collection of resource limits imposed by the system on users. In YashanDB, profiles can define limitations related to [password usage policies](../../../产品安全/身份标识与鉴别/密码认证/密码策略.html#password_policy), [session resources](../../../产品安全/连接管理/管控会话资源), and [connection request IPs](../../../产品安全/连接管理/管理IP黑白名单).
...
Defines configurations related to [password usage policies](../../../Product Security/Identity Identification and Authentication/Password Authentication/Password Policy.html#password_policy), including password policy parameters and their values, with multiple parameters defined separated by spaces.
...
- FAILED_LOGIN_ATTEMPTS, FAILED_LOGIN_INTERVAL, and PASSWORD_LOCK_TIME work together to achieve the effect of "waiting X seconds before retrying after a password error, locking the user for Z days after Y consecutive retries (unless the user is manually [unlocked](../../../产品安全/身份标识与鉴别/管理用户.html#alteruser))."
...
Defines configurations related to [session resources](../../../产品安全/连接管理/管控会话资源), with multiple parameters defined separated by spaces.
...
Defines configurations related to [connection request IPs](../../../产品安全/连接管理/管理IP黑白名单), with multiple parameters defined separated by spaces.
