...
- Heterogeneous database link: Database link between YashanDB and Oracle, which requires [heterogeneous database link configuration](../通用SQL语法/dblink/dblink配置管理)
