...
By default, a scheduled task PMO_DEFERRED_GIDX_MAINT_JOB is created when the database is initialized, which cleans up orphan key-value pairs in all indexes at 2 AM every day. It will call the CLEANUP_GIDX_JOB in [DBMS_PART](../../PL参考手册/内置高级包/DBMS_PART).
