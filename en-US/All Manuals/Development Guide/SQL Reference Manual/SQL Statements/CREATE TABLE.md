...
- During actual query operations, the priority of parallelism is as follows:
    ...
    - When the configuration parameter [DEGREE_OF_PARALLEL](../../../Reference Manual/Configuration Parameters.html#degreeofparallel) is set to 1 (default), the parallel degree attribute of the table takes precedence over DEGREE_OF_PARALLEL.
