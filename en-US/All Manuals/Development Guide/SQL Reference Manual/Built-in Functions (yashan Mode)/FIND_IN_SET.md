...
The FIND_IN_SET function is used to find the first occurrence of the string represented by [expr](../General SQL Syntax/expr) in the string list strlist. The function returns a value of INT type.
