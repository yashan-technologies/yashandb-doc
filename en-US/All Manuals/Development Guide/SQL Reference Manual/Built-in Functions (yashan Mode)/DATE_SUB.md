...
The DATE_SUB function is used to perform date calculations by subtracting the given interval value from the value of [expr](../General SQL Syntax/expr) to obtain the result of time advance or retreat.
