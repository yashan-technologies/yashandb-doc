...
This function will only take effect when the [character set](../../../Database Administration/Basic Database Management/Character Set Configuration) configured in the database includes both single-byte and multi-byte characters.
