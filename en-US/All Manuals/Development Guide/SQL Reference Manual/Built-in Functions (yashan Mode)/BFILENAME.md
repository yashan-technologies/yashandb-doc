...
dir_expr is a character type data, and its specification refers to [DIRECTORY](../SQL Statements (yashan Mode)/CREATE DIRECTORY), with a maximum length of 64 bytes.
