...
- If expr2 is neither a datetime type nor a numeric type, it will first convert expr1 to a string type, then attempt to convert to TIME type; if that fails, it will convert to DATETIME type.

***Example*** for Standalone Deployment Heap tables

```sql
SELECT ADDTIME('2021-02-03', '11:11:11') FROM dual;

addtime('2021-02-03', '11:11:11')
---------------------------------
2021-02-03 11:11:11.000000
