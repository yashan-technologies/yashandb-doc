...
The user ID must be an integer type of data, obtained using the [USERENV](../Built-in Functions (yashan Mode)/USERENV) function or by querying the [DBA_USERS](../../../Reference Manual/System Views/DBA Views/DBA_USERS) view.
