...
The HEX function converts the input string or number to its hexadecimal representation. The function returns the hexadecimal form of the string or the hexadecimal of the numeric value.
