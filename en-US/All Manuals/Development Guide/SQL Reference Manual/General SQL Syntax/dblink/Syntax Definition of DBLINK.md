...
dblink_name refers to the remote database name created during [CREATE DATABASE LINK](../../SQL语句/CREATE DATABASE LINK).  

## Usage Instructions  

When using dblink functionality, YashanDB will initiate a [sandbox process](./yex_server沙箱进程管理) for related data operations.  
