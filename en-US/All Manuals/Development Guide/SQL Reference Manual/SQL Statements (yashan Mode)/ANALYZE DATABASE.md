...
ANALYZE DATABASE is used to collect the statistics of the database, corresponding to the GATHER_DATABASE_STATS procedure in the [DBMS_STATS](../../PL Reference Manual/Built-in Advanced PL Packages/DBMS_STATS) advanced package.
