...
CREATE USER is used to create a new database user. The system by default creates a regular user. For the user management system of YashanDB, please refer to the Product Security Manual [User Management](../../../Product Security/Identity Identification and Authentication/User/00User).
...
* Must comply with the [password strength](../../../Product Security/Identity Identification and Authentication/Password Authentication/Password Policy (yashan Mode).html#password_complexity) and [password policy](../../../Product Security/Identity Identification and Authentication/Password Authentication/Password Policy (yashan Mode).html#password_policy) requirements.
