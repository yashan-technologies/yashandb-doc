...
Specifies specific system privilege names. For details on specific privilege items, please refer to [System Privileges](../../../Product Security/Data Access Control/Privilege and Role Management (yashan Mode)/System Privileges).
