...
For meanings and limitations of stored procedures, refer to the [Stored Procedures](../../PL Reference Manual/PL Objects/Stored Procedures) section.
...
Specifies the recompilation options; refer to the [compile_clause](../General SQL Syntax/compile_clause) description for details.
