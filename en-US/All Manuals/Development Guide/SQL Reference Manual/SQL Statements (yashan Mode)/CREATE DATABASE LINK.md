...
- Heterogeneous database link: Database link between YashanDB and Oracle, which requires [heterogeneous database link configuration](../../../Database Administration/Basic Database Management/Heterogeneous Database Link Configuration)
