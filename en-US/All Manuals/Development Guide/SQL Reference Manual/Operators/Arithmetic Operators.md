...
*   Built-in functions: [MOD](../Built-in Functions (yashan Mode)/MOD), [DIV](../Built-in Functions (yashan Mode)/DIV)

**%**

Modulus operation, synonymous with the [MOD](../Built-in Functions (yashan Mode)/MOD) function.
...
Relationship between / and [DIV](../Built-in Functions (yashan Mode)/DIV):
...
| --- | --- | --- | --- | --- | --- |
| **Integer Value** | +, -, \* | (1) | NUMEBR | FLOAT | DOUBLE |
...
| --- | --- | --- | --- | --- | --- | --- |
| **Integer Value** | +, -, \*, /, %, MOD, DIV | (2) | (2) | (2) | (2) | NUMEBR |
| **NUMBER** | +, -, \*, /, %, MOD, DIV | (2) | (2) | (2) | (2) | NUMBER |
| **FLOAT** | +, -, \*, /, %, MOD, DIV | (2) | (2) | (2) | (2) | FLOAT |
| **DOUBLE** | +, -, \*, /, %, MOD, DIV | (2) | (2) | (2) | (2) | DOUBLE |
| **Character Type** | +, -, \*, /, %, MOD, DIV | NUMBER | NUMEBR | FLOAT | DOUBLE | NUMEBR |
