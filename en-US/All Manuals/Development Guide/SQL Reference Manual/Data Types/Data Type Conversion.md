...
| [TO_BLOB](../内置函数/TO_BLOB)                    | Convert other types to BLOB type.               |
...
| [JSON](../内置函数/JSON JSON_PARSE)                           | Convert string type to JSON type.                 |
| [JSON_SERIALIZE](../内置函数/JSON_SERIALIZE JSON_FORMAT)      | Convert JSON type to string type.                 |
