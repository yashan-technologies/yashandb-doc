...
- Table function table(), for detailed syntax please refer to [table_collection_expression](../SQL Statements/SELECT.html#tablecollectionexpression) in SELECT statement.
