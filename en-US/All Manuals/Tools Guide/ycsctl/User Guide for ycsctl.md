...
Among them, Cluster Management Commands provide a series of cluster configuration commands, and this configuration information will be stored in the YCR disk, which can be viewed using `ycsctl show config`.