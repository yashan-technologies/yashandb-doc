*ycsctl* is the YCS management tool for YashanDB. Users can use this tool to perform management operations on YACs, including cluster-level management and node-level management.
