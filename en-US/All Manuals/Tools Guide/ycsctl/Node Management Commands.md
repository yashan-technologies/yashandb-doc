...
> **Note**: 
>
> For detailed information on YCS OS Watcher, please refer to [Operating System Load Monitoring](../../数据库管理/运行监控/YCS OS Watcher).
...
Parameter name, derived from the allowed [configuration parameters](../../数据库管理/集群管理/集群参数配置) of YCS. The following parameters can be specified for querying:
...
Parameter name, derived from the allowed [configuration parameters](../../数据库管理/集群管理/集群参数配置) of YCS. The following parameters can be specified for setting:
...
The target parameter value, which must be within the allowed range as specified by YCS [configuration parameters](../../数据库管理/集群管理/集群参数配置).
...
For detailed descriptions of the above parameters, see the [YAC parameter configuration](../../数据库管理/集群管理/集群参数配置) section.