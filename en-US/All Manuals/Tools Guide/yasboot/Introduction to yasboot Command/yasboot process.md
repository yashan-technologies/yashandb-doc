...
- The [OS authentication](../../../产品安全/身份标识与鉴别/操作系统认证/00操作系统认证) must be enabled (it is enabled by default when following standard installation steps) to properly use the self-repair functionality.
