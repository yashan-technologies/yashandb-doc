...
> **Caution**: 
>
> - The [OS authentication](../../../产品安全/身份标识与鉴别/操作系统认证/00操作系统认证) must be enabled (default enabled during standard installation) for proper use of yasom election functionality.
