> **Caution**: 
>
> You need to enable [OS authentication](../../../Product Security/Identity Identification and Authentication/OS Authentication/00OS Authentication) (which is enabled by default when following the standard installation steps) to use the patrol functionality properly.
