...
| *--backup-reserved-space*   | Reserved capacity for the temporary backup path during offline upgrade, units can be B/KB/MB/GB/TB/PB/EB (B can be omitted, e.g., 2GB or 2G), default is 5G  |
