...
> **Caution**: 
>
> - Group configuration can only be used in the parameters configuration of the [CREATE DATABASE](../../Development Guide/SQL Reference Manual/SQL Statements (yashan Mode)/CREATE DATABASE) statement, meaning only the configurations listed below can be used, and there cannot be any database configuration parameters on the nodes.
