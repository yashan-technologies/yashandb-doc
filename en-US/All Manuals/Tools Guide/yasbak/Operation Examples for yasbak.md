...
2. Enter the installation directory and check all nodes of the database to determine if all nodes have archiving mode (ARCHIVELOG) enabled. If it is not enabled, please refer to [Archive Management](../../数据库管理/实例管理/归档管理) to enable archiving.
