...
Before executing this mode of import, ensure that the LBAC switch is enabled; otherwise, the import of LBAC related information will fail. Refer to [YLS_ENFORCEMENT](../../开发手册/PL参考手册/内置高级包/YLS_ENFORCEMENT) for LBAC switch operations.
