...
In both Standalone Deployment and YAC Deployment, the *yasrman* command and its usage are exactly the same, whereas there are slight differences in ISC Distributed Cluster Deployment.

## Standalone Deployment or YAC Deployment
