...
# When the CSV file includes both physical and virtual column data, specify the positions of physical columns C1 and C2 in the CSV file for import in BASIC import mode 
