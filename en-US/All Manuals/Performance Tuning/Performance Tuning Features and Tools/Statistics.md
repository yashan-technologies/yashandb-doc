...
Statistics locking/unlocking at the user, table, and partition level can be achieved through the LOCK/UNLOCK relevant procedures in the [DBMS_STATS](../../开发手册/PL参考手册/内置高级包/DBMS_STATS) package. Once the specified statistics are locked, all actions related to statistics collection (gather/set/delete, etc.) will no longer affect them.
