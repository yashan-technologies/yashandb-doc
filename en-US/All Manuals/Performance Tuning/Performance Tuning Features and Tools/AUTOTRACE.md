...
> 
> During the generation of AUTOTRACE, dynamic views are queried. Users enabling and using AUTOTRACE must have the privilege to query dynamic views (for example, [built-in role](../../Product Security/Data Access Control/Privilege and Role Management/Roles) SELECT_CATALOG_ROLE).
