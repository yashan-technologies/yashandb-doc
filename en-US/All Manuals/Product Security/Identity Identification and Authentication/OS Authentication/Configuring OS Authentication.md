...
- A request must be made to the OS administrator to add the target OS user to the **YASDBA user group** (usually created during the [preparation work](../../../Installation and Upgrade/Installation and Deployment/Pre-Installation Preparation/Creating an Installation User) of YashanDB installation) and the **same name user group of the database installation user** (for example, yashan).
