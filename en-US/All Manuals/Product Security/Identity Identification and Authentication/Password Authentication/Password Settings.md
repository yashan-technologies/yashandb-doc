...
- **Creating Normal Users**
    ...
    When creating normal users using the [CREATE USER](../../../Development Guide/SQL Reference Manual/SQL Statements (yashan Mode)/CREATE USER) statement, passwords can be set in plaintext or encrypted formats.
