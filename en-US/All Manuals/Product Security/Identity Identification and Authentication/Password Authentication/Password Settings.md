...
- **Password Modification for System User**
    ...
    For security reasons, it is recommended to regularly change the password for the system user. This can be done using the [yaspwd](../../../Tools Guide/yaspwd) tool, [yasboot](../../../Tools Guide/yasboot/Introduction to yasboot Command/yasboot cluster) tool, or the [ALTER USER](../../../Development Guide/SQL Reference Manual/SQL Statements/ALTER USER) statement. 
...
- **Creating Regular Users**
    ...
    When creating regular users using the [CREATE USER](../../../Development Guide/SQL Reference Manual/SQL Statements/CREATE USER) statement, passwords can be set in plaintext or encrypted formats.
