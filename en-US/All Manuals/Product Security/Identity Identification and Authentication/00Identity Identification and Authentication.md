In YashanDB, creating a database login account means creating a [User](./用户/00用户) within the database. A user is the identity of the database user, associated with the user's login password, privileges, default tablespace, and information about the resources and functionalities that can be accessed/used.
