...
- [Login to the database with dual-factor authentication using the JDBC driver](../../../Development Guide/JDBC Driver/YashanDB JDBC Driver Usage Introduction.html#UKEY)
