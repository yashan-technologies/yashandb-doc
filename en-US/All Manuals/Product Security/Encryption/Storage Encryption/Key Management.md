...
>**Caution**:
>
> - In a primary/standby Standalone Deployment or YAC Deployment, all nodes' wallets must be opened; otherwise, newly added encrypted objects may cause other nodes to fail to apply due to wallet being closed, and in primary/standby Standalone Deployment, it may also cause NEED REPAIR. In such cases, configure the wallet and restart the database as per the above operation steps.
>
