...
In Standalone/YAC/Distributed Cluster Deployment environments, some scenarios require [configuring and opening the wallet](Key Management.html#configuringwallet) first:
