...
Adding or removing masking strategies requires calling the corresponding subprogram of the DBMS_DATAMASK advanced package. Please refer to [DBMS_DATAMASK](../../开发手册/PL参考手册/内置高级包/DBMS_DATAMASK) for specific operations.