Connection listening is used to detect network attacks such as connection storms. YashanDB achieves this functionality by recording listening logs. For information on managing listening logs, please refer to [Listener Log Management](../../Database Administration/Operation Monitoring/Log Management/Listener Log Management).
