...
- Executing the [CREATE PROFILE](../../开发手册/SQL参考手册/SQL语句/CREATE PROFILE.html# res) and [ALTER PROFILE](../../开发手册/SQL参考手册/SQL语句/ALTER PROFILE.html# res) statements can configure session resource thresholds.

- Executing the [CREATE USER](../../开发手册/SQL参考手册/SQL语句/CREATE USER.html#profile) or [ALTER USER](../../开发手册/SQL参考手册/SQL语句/ALTER USER.html#profile) statements can associate users with profiles, i.e., configure the effective users for session resource threshold.
