Connection listening is used to detect network attacks such as connection storms. YashanDB achieves this functionality by recording listening logs. For information on managing listening logs, please refer to [Listener Log Management](../../数据库管理/运行监控/日志管理/监听日志管理).
