...
In Standalone or YAC Deployments, audit logs can be stored in system tables (default) or external files. Configure scheduled tasks to enable automatic archiving of audit logs, preventing excessive growth from impacting database auditing.  
...
3. Use the [DBMS_SCHEDULER](../../开发手册/PL参考手册/内置高级包/DBMS_SCHEDULER) package to create scheduled tasks for automatic log archiving.
