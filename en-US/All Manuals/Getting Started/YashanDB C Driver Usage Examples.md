...
1. Refer to [Quick Start with YashanDB](./快速体验YashanDB) to obtain the YashanDB client installation package.
...
| ------------------------------------------------------------ | ---------------------- |
| [yacAllocHandle](../开发手册/C语言系驱动/C驱动/C驱动接口说明/句柄和描述符函数/yacAllocHandle) | Allocate space for a handle |
| [yacFreeHandle](../开发手册/C语言系驱动/C驱动/C驱动接口说明/句柄和描述符函数/yacFreeHandle) | Free space for a handle   |
| [yacConnect](../开发手册/C语言系驱动/C驱动/C驱动接口说明/连接、授权和初始化函数/yacConnect) | Initiate connection request from the client |
| [yacDisconnect](../开发手册/C语言系驱动/C驱动/C驱动接口说明/连接、授权和初始化函数/yacDisconnect) | Initiate disconnect request from the client |
