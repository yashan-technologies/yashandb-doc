This chapter will introduce the basic syntax and examples related to the YashanDB database. For more SQL syntax information, please refer to the [SQL Reference Manual](../../Development Guide/SQL Reference Manual/00SQL Reference Manual).
...
2. Create the data table and insert data. You can refer to the [Sample Tables](../../Development Guide/Appx2 Sample Tables.html#mysqlSqlExam) for creating the business tables involved in this trial.
