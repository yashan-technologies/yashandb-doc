...
| ---------------- | ---- | ---- |
| Database Installation Package | YashanDB {version_number}    | yashandb-{version_number}-linux-x86_64.tar.gz<br/>yashandb-{version_number}-linux-aarch64.tar.gz<br/><br/>To deploy using Docker containers, you need to obtain the image package yashandb-image-{version_number}-linux-x86_64.tar.gz |
...
For detailed information on the user management system, you can refer to [User Management](../Product Security/Identity Identification and Authentication/Managing Users).