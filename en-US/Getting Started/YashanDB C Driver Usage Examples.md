...
| ------------------------------------------------------------ | ---------------------- |
| [yacAllocHandle](../Development Guide/C Language Family Drivers/C Driver/YashanDB C Driver Interfaces/Handle and Descriptor Functions/yacAllocHandle) | Allocate space for a handle |
| [yacFreeHandle](../Development Guide/C Language Family Drivers/C Driver/YashanDB C Driver Interfaces/Handle and Descriptor Functions/yacFreeHandle) | Free space for a handle   |
| [yacConnect](../Development Guide/C Language Family Drivers/C Driver/YashanDB C Driver Interfaces/Connection & Authorization & Initialization Functions/yacConnect) | Initiate connection request from the client |
| [yacDisconnect](../Development Guide/C Language Family Drivers/C Driver/YashanDB C Driver Interfaces/Connection & Authorization & Initialization Functions/yacDisconnect) | Initiate disconnect request from the client |
...
For more information about C interfaces and application examples, please refer to [C driver documentation](../Development Guide/C Language Family Drivers/C Driver/00C Driver).