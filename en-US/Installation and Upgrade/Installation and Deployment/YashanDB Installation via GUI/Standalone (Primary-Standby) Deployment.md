...
On the [DB creation parameters] page, you can refer to the [Standalone Deployment Configuration File](../../../Tools Guide/yasboot/Configuration Files/Standalone Deployment Configuration File) to add/delete/modify creation parameters as needed. After confirming the information is correct, click [Next step].
...
2. (Optional) Create a database user and grant permissions. For more operations, please refer to [User Management](../../../Product Security/Identity Identification and Authentication/User/00User).
