...
| CPU         | * Architecture support: General x86_64, domestic C86, ARM64, LoongArch, SW64, etc<br>\* Operating modes: Both hyper-threaded and non-hyper-threaded are supported<br>\* Environmental adaptation: Supports SMP (Symmetric Multi-Processing) and NUMA (Non-Uniform Memory Access) server topologies<br/>\* Configuration recommendations: 4 cores and above; 8 cores and above in YAC | Number of CPU cores > 2                                     |
