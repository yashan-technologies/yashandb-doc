...
>
> - Only YAC Deployment requires *mpathpersist* and *sshpass*.
>    During the installation process of YAC, the [fenceScsiCheck script](../../../YashanDB for Cluster/Yashan Cluster Service/IO Fencing/SCSI IO Fencing.html#fenceScsiCheck_usage) will automatically be invoked to check the shared storage and other devices/environments (Whether detection errors occur or not will not block the installation). This script requires *mpathpersist* and *sshpass*.
>
...
<span id="openssl" name="openssl" class="yaslink"></span>
