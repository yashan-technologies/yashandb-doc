...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| Single cluster<br>primary-standby cluster | CDB / Non-CDB <br>yashan mode / mysql mode<br>Single network segment / multiple network segments<br>SCAN and VIP |
...
| EMPTY_STRING_AS_NULL |This parameter will automatically set to FALSE when the database service is in mysql mode and connot be changed manually.|
...
```shell
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------+
| hostid   | nodeid | node_type | pdb_name | pid   | instance_status | pdb_status | pdb_role | source_node | listen_address    | 
+-----------------------------------------------------------------------------------------------------------------------------------------------------------------+
| host0001 | 1-1:1  | cdb       | cdb$root | 22573 | open            | normal     | primary  | -           | 192.168.1.2:1688  | /data/yashan/yasdb_data/ce-1-1   |
+----------+--------+-----------+----------+-------+-----------------+------------+----------+-------------+-------------------+----------------------------------+
| host0001 | 1-2:2  | cdb       | cdb$root | 16935 | open            | normal     | primary  | -           | 192.168.1.3:1688  | /data/yashan/yasdb_data/ce-1-2   |
+----------+--------+-----------+----------+-------+-----------------+------------+----------+-------------+-------------------+----------------------------------+
```
    :::
...
| host0002 | ce        | 1-2:2  | 16935 | open            | normal          | primary       | 192.168.1.3:1688  | -           | /data/yashan/yasdb_data/ce-1-2   |
+----------+-----------+--------+-------+-----------------+-----------------+---------------+-------------------+-------------+----------------------------------+
| host0003 | ce        | 2-1:3  | 19703 | open            | normal          | standby       | 192.168.10.4:1688 | 1-1:1       | /data/yashan/yasdb_data/ce-2-1   |
+----------+-----------+--------+-------+-----------------+-----------------+---------------+-------------------+-------------+----------------------------------+
| host0004 | ce        | 2-2:4  | 19651 | open            | normal          | standby       | 192.168.10.5:1688 | 1-1:1       | /data/yashan/yasdb_data/ce-2-2   |
+----------+-----------+--------+-------+-----------------+-----------------+---------------+-------------------+-------------+----------------------------------+
```
    == CDB Mode
...
| host0001 | 1-2:2  | cdb       | cdb$root | 16935 | open            | normal     | primary  | -           | 192.168.1.3:1688  | /data/yashan/yasdb_data/ce-1-2   |
+----------+--------+-----------+----------+-------+-----------------+------------+----------+-------------+-------------------+----------------------------------+
| host0003 | 2-1:3  | cdb       | cdb$root | 19703 | open            | normal     | standby  | 1-1:1       | 192.168.10.4:1688  | /data/yashan/yasdb_data/ce-2-1   |
+----------+--------+-----------+----------+-------+-----------------+------------+----------+-------------+-------------------+----------------------------------+
| host0003 | 2-2:4  | cdb       | cdb$root | 19651 | open            | normal     | standby  | 1-1:1       | 192.168.10.5:1688  | /data/yashan/yasdb_data/ce-2-2   |
+----------+--------+-----------+----------+-------+-----------------+------------+----------+-------------+-------------------+----------------------------------+
```
    :::
