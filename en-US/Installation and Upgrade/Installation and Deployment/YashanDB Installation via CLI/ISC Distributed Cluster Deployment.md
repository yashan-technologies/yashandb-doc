...
When the DN group has 1 primary 1 standby deployment, if automatic switching between primary/standby nodes in the DN group is required, it is necessary to enable the [election](../../../High Availability/Configuring Leader Election/Configuring yasom Election) based on yasom.
