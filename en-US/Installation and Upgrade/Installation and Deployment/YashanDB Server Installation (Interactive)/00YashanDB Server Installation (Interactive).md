...
| ------------------------------------------------------------ | ----------------------------------------------- |
| Standalone Deployment (Single database or Non-cascaded non-dual replication group primary-standby) | yashan mode<br>Single network segment           |
| YAC Deployment (Single cluster or primary-standby cluster)   | Single network segment                          |