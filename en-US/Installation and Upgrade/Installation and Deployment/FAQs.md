...
2. Refer to [Pre-Installation Preparation](Pre-Installation Preparation/Configuring the Installation Environment) for environment checks.
...
1. Refer to [Pre-Installation Preparation](Pre-Installation Preparation/Configuring the Installation Environment) for environment checks.
...
Both have the same effect; yasboot sql will call *yasql* but is more convenient than *yasql*. For specifics, refer to [yasboot sql](../../Tools Guide/yasboot/Introduction to yasboot Command/yasboot sql).
