...
- Initial Database
    ...
    - Listening Port: If not adjusted during the installation process, the default listening port for the yashan protocol is 1688. If deployed in mysql mode, an additional MySQL protocol listening port will also exist, defaulting to 1690 (Standalone (primary/standby) deployment) or 1691(YAC deployment).
...
- Related Processes:
  ...
  - **yascs Process**
    ...
    The yascs process is the cluster service management process of YashanDB, which will be started after deploying YAC or Distributed Cluster.
