...
Some features require additional environment variables. If you need to use [External UDF (Java)](../../../Development Guide/PL Reference Manual/PL Objects/User-Defined Functions.md#ext_udf), the following environment variables also need to be configured and take effect.
