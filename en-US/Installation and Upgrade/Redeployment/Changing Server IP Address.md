...
The following operations will be described using the example of two server IP changes in a one primary two standby environment:

|Server Name |Old IP |Role |New IP |
| -------- | --------------- | ---- | --------------- |
| Server 1    | **192.168.1.2** | Primary | **192.168.1.5** |
| Server 2    | **192.168.1.3** | Standby | **192.168.1.6** |
| Server 3    | 192.168.1.4     | Standby | 192.168.1.4   |
