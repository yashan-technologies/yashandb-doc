...
10. If any configurations have been temporarily adjusted for successful scaling out (e.g., disabling yasom election), restore the configuration as needed after scaling out is complete (e.g., re-enable [yasom election](../../../High Availability/Configuring Leader Election/Configuring yasom Election for One Primary and One Standby)).
...
7. If any configurations have been temporarily adjusted for successful scale-in (e.g., disabling yasom election), restore the configuration as needed after scale-in is complete (e.g., re-enable [yasom election](../../../High Availability/Configuring Leader Election/Configuring yasom Election for One Primary and One Standby)).
