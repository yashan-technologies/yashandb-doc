...
5. (Optional) Backup the database.
    ...
    It is recommended to [backup](../../../Database Administration/Backup and Recovery/00Backup and Recovery) the database to ensure there is a baseline backup set available for recovery after scaling down.
