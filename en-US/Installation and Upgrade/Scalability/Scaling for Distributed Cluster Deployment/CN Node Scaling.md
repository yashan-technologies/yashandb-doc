YashanDB supports online scaling out of CN nodes in Distributed Cluster Deployment through the [yasboot](../../../Tools Guide/yasboot/00yasboot) tool, and the scaling out does not affect the usage of the entire cluster.
