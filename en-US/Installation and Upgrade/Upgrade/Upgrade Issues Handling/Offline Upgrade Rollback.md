...
If certain configurations were temporarily adjusted for a successful upgrade operation (e.g., disabling arbitration), after the rollback, if no further upgrades are planned, configurations should be restored as needed (e.g., re-enabling [yasom election](../../../High Availability/Configuring Leader Election/Configuring yasom Election)).