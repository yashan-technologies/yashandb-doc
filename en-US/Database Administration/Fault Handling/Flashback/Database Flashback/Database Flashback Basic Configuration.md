...
Flashback log files are backed up as part of full database backups. For detailed steps, refer to [Backup and Recovery](../../../Backup and Recovery/00Backup and Recovery).
