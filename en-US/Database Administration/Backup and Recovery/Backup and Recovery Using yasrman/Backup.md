...
Backing up the entire database will back up its control files, data files, redo log files, and partial archive log files.
...
```shell
$ yasrman sys/********@192.168.1.2:1688 \
-c "backup tablespace user tag 'user_bak'" \
-D /home/yashan/catalog
```
...
The backup range specification and general backup attributes such as compression and encryption are consistent with full database backups.
