...
- Session-level tracing: Executing the [ALTER SESSION](../../Development Guide/SQL Reference Manual/SQL Statements/ALTER SESSION) statement allows tracing for the current session.
- Global tracing: Executing the [ALTER SYSTEM](../../Development Guide/SQL Reference Manual/SQL Statements/ALTER SYSTEM) statement enables tracing globally. Global tracing may impact system performance and is **not recommended** unless necessary.
