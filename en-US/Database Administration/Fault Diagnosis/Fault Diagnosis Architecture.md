The fault diagnosis architecture consists of multiple components, including the automatic diagnosis repository, runtime logs, and alarm logs. For runtime logs and alarm logs, please refer to the relevant descriptions in [Log Management](../Operation Monitoring/Log Management/00Log Management).
...
| blackbox           | Stores data from [automatically captured diagnostic data](Dump.md#blackbox) ("black box"). This directory does not need to be created manually and will be automatically created along with the paths and files before a database process crash.                                         |
