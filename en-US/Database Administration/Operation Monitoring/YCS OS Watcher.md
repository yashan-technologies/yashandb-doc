...
By default, OS Watcher starts when YCS starts. Users can configure the auto-start feature through the YCS configuration parameter [OSW_AUTO_START](../Cluster Management/Cluster Parameter Configuration.md#osw_auto_start) as needed.
...
OS Watcher supports specifying the maximum number of files that can be saved and the size of individual files, controlled by the YCS configuration parameters [OSW_FILE_NUM](../Cluster Management/Cluster Parameter Configuration.md#osw_file_num) and [OSW_FILE_SIZE](../Cluster Management/Cluster Parameter Configuration.md#osw_file_size).
