...
- Notes: If shared storage is mounted via multipath, please [modify the multipath configuration file](../../../Installation and Upgrade/Installation and Deployment/Pre-Installation Preparation/Configuring the Storage Devices.md#modify_multipath_conf) before configuring this method.
...
- Error Code YAS-00341: The disk is a SCSI device but retains information from none this YAC registrations or reservations. Please use caution and confirm safety before using the [ycsrootagent scsi clear command](../../../Tools Guide/ycsrootagent.md#scsi_clear) to clear residual information.
...
| *--port*                | SSH connection port for the auxiliary server; if omitted, the default port 22 is used.  |
