...
2. View cluster information to confirm whether the public network and service ports have been configured.
    ...
    ```
    The absence of Network information in the echo indicates that the public network has not been configured yet, and the absence of public service port under node host0002 indicates that the service port number has not been configured for this node yet.
