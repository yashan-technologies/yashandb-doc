...
To switch the session mode, execute the [ALTER SYSTEM SET](../../Development Guide/SQL Reference Manual/SQL Statements (yashan Mode)/ALTER SYSTEM.html#setparameterclause) statement to set the corresponding parameter value and restart to take effect.
