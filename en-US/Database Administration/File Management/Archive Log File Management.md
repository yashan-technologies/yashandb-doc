...
6. Manually clean up archive log files; for specific syntax, please refer to [ALTER DATABASE](../../Development Guide/SQL Reference Manual/SQL Statements (yashan Mode)/ALTER DATABASE.html#deletearchivelogclauses).
