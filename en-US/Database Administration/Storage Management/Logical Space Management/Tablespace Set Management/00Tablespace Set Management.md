...
A tablespace set is a logical storage unit in an ISC distributed database, used in ISC Distributed Cluster Deployment to store sharded tables, indexes built on sharded tables, and ac built on sharded tables. 
