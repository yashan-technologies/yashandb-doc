...
<span id="table" name="table" class="yaslink"></span>
Tables
-----
...
| Number of Partitions in Window Function | Maximum Value   | 1000                                           |
...
To ensure business continuity, Yashan database supports online execution of partial DDL. To minimize the impact on system operation, online DDL operations are also recommended to be executed during off-peak business hours, and attention should be paid to the functionality constraints during online execution of DDL. Please refer to [SQL Reference](../../开发手册/SQL参考手册/SQL语句（yashan模式）/00SQL语句（yashan模式）) for detailed functionality specification constraints.
