...
| PDB Count   | Maximum Value       | This specification only exists when YashanDB is deployed as a container database, and its value depends on the MAX_PDBS parameter<br/>* Standalone Deployment: [0,8190] <br/>* YAC/Distributed Cluster Deployment: [0,256]  |
