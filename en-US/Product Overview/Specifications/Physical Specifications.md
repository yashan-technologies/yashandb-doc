...
| Number of FailureGroups | Minimum Value per DiskGroup | Depends on the redundancy configuration of the DiskGroup:<br />* For redundancy level External: 1<br />\* For redundancy level Normal: 2 for data DiskGroups and 3 for system DiskGroups<br />\* For redundancy level High: 5 |
...
| Number of System Disks     | Optional Values | 1, 2, 3 or 5       |
...
|Parameter Name |Parameter Type |Parameter Value |
| ----------- | ------------- |----------------|
| ISC (Integration Storage and Compute) Distributed Cluster Deployment | Maximum Deployment Scale | 5MN 8CN 32*5DN |

## Primary/Standby High Availability

|Parameter Name |Parameter Type |Parameter Value |
| ---------------------- | ------------ |-----------------------------------------|
| Physical Standby Database  | Maximum Standby Database Count | Standalone Deployment: 32<br>YAC Deployment: 32 (Standby Cluster)<br>Distributed Cluster Deployment: 32 (Standby Cluster)<br />ISC Distributed Cluster Deployment: 32 (Standby Node in DN Group) |
| Logical Standby Database    | Maximum Standby Database Count | Standalone Deployment: 32<br>Other deployment forms: No logical standby |
| Cascade Standby              | Maximum Cascade Count | Standalone Deployment: Unlimited<br>Other deployment forms: No cascade standby |
