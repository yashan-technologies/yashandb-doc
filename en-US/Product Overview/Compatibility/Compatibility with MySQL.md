...
- [mysql mode](../../Reference Manual of mysql Mode/Overview of mysql Mode): Applicable only to Standalone Deployment. In this mode, SQL statements entered by the user will be parsed according to MySQL's syntax, suitable for scenarios that require close compatibility with MySQL databases.
