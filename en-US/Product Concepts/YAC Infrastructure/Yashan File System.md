...
The Allocation Unit (AU) is the smallest unit for YFS to allocate disk space. YFS divides disks into fixed-size allocation units for management, and all disks within the same DiskGroup use the same allocation unit size.
...
> **Note**:
> 
> The `PARTNERS` field in the [V$YFS_DISK](../../Reference Manual/System Views/Dynamic Performance Views/V$YFS_DISK) view can be used to view the partner relationships of disks.
> 
