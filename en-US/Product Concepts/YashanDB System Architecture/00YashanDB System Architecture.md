...
In addition to the standalone form, YAC Deployment adds three subsystems: Yashan Cluster Kernel (YCK), Yashan File System (YFS), and Yashan Cluster Service (YCS):
