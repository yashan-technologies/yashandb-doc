...
- The core components of YAC mainly include [Yashan Cluster Kernel (YCK)](#ClusterYCK), [Yashan Cluster Service (YCS)](#ClusterYCS), and [Yashan File System (YFS)](#ClusterYFS).
...
- The compute cluster constitutes a multi-instance active-active cluster composed of multiple compute nodes. Beyond inheriting the core infrastructure capabilities of YAC, including [Yashan Cluster Kernel (YCK)](#ClusterYCK), [Yashan Cluster Service (YCS)](#ClusterYCS), and [Yashan File System (YFS)](#ClusterYFS), it also possesses the following distributed characteristics:
...
- The storage cluster constitutes a distributed intelligent storage service cluster composed of multiple storage nodes, delivering unified distributed storage service capabilities to the compute cluster.
  - [The intelligent storage service](#SmartStor) is responsible for storage device management and monitoring, end-to-end data lifecycle management, and near-storage compute capabilities, delivering elastic scalability and high-availability services.