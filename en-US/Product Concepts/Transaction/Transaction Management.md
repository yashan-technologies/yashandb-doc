...
When the transaction starts, YashanDB allocates the resources needed during its execution, including memory, lock areas, UNDO, etc., and allocates a globally unique transaction ID.
