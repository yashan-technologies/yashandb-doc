...
- System users (Built-in users):
    ...
    - System Administrator: When the separation of duties is not enabled, acts as the super administrator responsible for database system management, with all privileges; when the [separation of duties](../../All Manuals/Reference Manual of mysql Mode/Data Access Control/Separation of Duties) is enabled, lacks audit and security management-related privileges. Username: SYS. The initial password is specified during installation, and subsequent password updates must be generated and maintained through the yaspwd tool.
...
- [Manage user privileges](../../All Manuals/Product Security/Data Access Control/Privilege and Role Management/Permission Granting and Revocation)
