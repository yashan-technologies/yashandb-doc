...
Users created under the mysql mode can be granted/revoked privileges that are the union of the privilege mechanisms of the yashan mode and mysql mode ([privileges related to mysql mode](00Privilege Management) and [privileges related to yashan mode](../../../All Manuals/Product Security/Data Access Control/Privilege and Role Management/00Privilege and Role Management), and privileges should be granted reasonably according to actual needs.
