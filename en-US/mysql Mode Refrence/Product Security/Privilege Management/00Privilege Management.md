...
For users created in mysql mode, it may be necessary to consider whether they need to be granted the corresponding [privileges in yashan mode](../../../All Manuals/Product Security/Data Access Control/Privilege and Role Management/00Privilege and Role Management).