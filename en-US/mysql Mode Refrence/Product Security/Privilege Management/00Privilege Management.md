...
For users created in mysql mode, it may be necessary to consider whether they need to be granted the corresponding [privileges in yashan mode](../../../All Manuals/产品安全/数据访问控制/特权与角色管理/00特权与角色管理).