...
1. Tinyint, Smallint, Integer, Bigint, Float, Double, and Number:
   ...
   - These types are equivalent to the namesake data types in YashanDB, including their length and value range. See [Data Type Specifications](../../../All Manuals/Product Overview/Specifications/Data Type Specifications).
