...
- As syntax keywords, they are used to delimit the positions of the SQL syntax tree; as system [reserved syntax keywords](../../../All Manuals/Reference Manual/Reserved Keywords), they cannot be used as names for database objects.
...
*   For column names, case sensitivity is not enforced when matching in scenarios such as INSERT, DELETE, UPDATE, and SELECT operations. However, query results will be displayed exactly as the column names were entered in the SQL statement.
