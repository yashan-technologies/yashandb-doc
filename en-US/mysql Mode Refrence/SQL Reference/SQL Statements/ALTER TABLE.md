...
This statement is used to define the columns of the table, including data types, default values,  [inline_constraint](../../../All Manuals/Reference Manual of mysql Mode/SQL Reference/通用SQL语法/constraint), and various column attributes such as CHARACTER SET, COLLATE, COMMENT, and AUTO_INCREMENT.
