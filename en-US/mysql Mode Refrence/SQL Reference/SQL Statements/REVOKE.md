...
REVOKE is used to revoke the privilege granted to a specific user. The revocable contents include [system privilege SYSTEM PRIVILEGE](../../../All Manuals/Reference Manual of mysql Mode/产品安全/特权管理/系统特权), [schema privilege SCHEMA PRIVILEGE](../../../All Manuals/Reference Manual of mysql Mode/产品安全/特权管理/模式特权), and [object privilege OBJECT PRIVILEGE](../../../All Manuals/Reference Manual of mysql Mode/产品安全/特权管理/对象特权).
