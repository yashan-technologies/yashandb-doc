...
CREATE USER is used to create a new database user. The default created is a regular user. For YashanDB's user management system, please refer to the Product Security Manual [User Management](../../../All Manuals/Reference Manual of mysql Mode/产品安全/管理用户).
...
*   It must comply with [Password Strength](../../../All Manuals/Reference Manual of mysql Mode/产品安全/密码策略) requirements.
...
-- Format of the password to be input when connecting via MySQL Client
