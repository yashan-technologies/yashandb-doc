...
GRANT is used to grant privileges to a user. The grantable content includes [system privilege SYSTEM PRIVILEGE](../../Product Security/Privilege Management/System Privileges), [schema privilege SCHEMA PRIVILEGE](../../Product Security/Privilege Management/Schema Privileges), and [object privilege OBJECT PRIVILEGE](../../Product Security/Privilege Management/Object Privileges).
...
The name of the system privileges to be granted, separated by commas. Please refer to the list of system privileges in [System Privileges](../../Product Security/Privilege Management/System Privileges).
...
The name of the schema privileges to be granted, separated by commas. Please refer to the list of schema privileges in [Schema Privileges](../../Product Security/Privilege Management/Schema Privileges).
...
The name of the object privileges to be granted, separated by commas. Please refer to the list of object privileges in [OBJECT PRIVILEGE](../../Product Security/Privilege Management/Object Privileges).
