...
In YashanDB (mysql mode), in addition to the concatenation operator, you can also use [CONCAT](../../../All Manuals/Reference Manual of mysql Mode/SQL Reference/内置函数/CONCAT) to implement concatenation operations.
