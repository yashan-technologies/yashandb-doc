...
> **Note**: 
>
> Comparison between character types performs a case-sensitive string comparison. Please refer to the [character type](../../../All Manuals/开发手册/SQL参考手册/数据类型/字符型) document for detailed description.
