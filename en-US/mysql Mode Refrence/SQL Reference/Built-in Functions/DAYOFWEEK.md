...
* Whether the value of expr allows zero in the year, month, or day depends on whether NO_ZERO_DATE and NO_ZERO_IN_DATE are included in [SQL_MODE](../../System Variables/List of System Variables In mysql Mode.html#sql_mode).
