...
json_value is a binary [json](../General SQL Syntax/json) data, which can be obtained through the [JSON function](../../../All Manuals/开发手册/SQL参考手册/内置函数/JSON JSON_PARSE).
