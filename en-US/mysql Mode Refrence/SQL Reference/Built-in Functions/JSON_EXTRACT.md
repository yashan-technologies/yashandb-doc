...
json_value is a binary [json](../General SQL Syntax/json) data, which can be obtained through the [JSON function](../../../All Manuals/Development Guide/SQL Reference Manual/Built-in Functions/JSON JSON_PARSE).
