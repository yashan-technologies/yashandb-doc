...
The TRUNCATE function truncates the value of [expr](../../../All Manuals/Reference Manual of mysql Mode/SQL Reference/通用SQL语法/expr) to `n` decimal places, discarding any excess digits without rounding.
