...
If the mode parameter is not specified, the default value is the DEFAULT_WEEK_FORMAT system variable. Please refer to [System Variables in mysql mode](../../../All Manuals/Reference Manual of mysql Mode/系统变量/系统变量参考).
...
When the mode parameter value is 1, 4, 5, or 8, the return value of the WEEK function always corresponds to the year specified by the date parameter. If the date specified is from the last week of the previous year, the WEEK function returns 0 instead of 52.
