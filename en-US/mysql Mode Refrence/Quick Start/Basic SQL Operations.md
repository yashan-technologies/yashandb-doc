This chapter will introduce the basic syntax and examples related to the YashanDB database. For more SQL syntax information, please refer to the [SQL Reference Manual](../../All Manuals/Reference Manual of mysql Mode/SQL参考手册/00SQL参考手册).
