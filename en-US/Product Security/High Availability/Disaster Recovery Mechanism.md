...
In a ISC Distributed Cluster Deployment, CN nodes naturally allow for active-active deployments without the concept of primary/standby, where high availability deployments apply only to the MN and DN groups.
