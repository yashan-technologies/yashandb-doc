...
- Service High Availability: Reduce the time the system cannot provide services through various technical measures to ensure business continuity. For specific configuration methods and usage steps, please refer to [High Availability](../../High Availability/Overview of YashanDB High Availability).
