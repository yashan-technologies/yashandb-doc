...
For detailed operations regarding primary/standby deployment and high availability maintenance, please refer to [High Availability](../../High Availability/Overview of YashanDB High Availability).
...
1. Enable supplemental logging for the YashanDB database ([database-level supplemental logging](../../Development Guide/SQL Reference Manual/SQL Statements (yashan Mode)/ALTER DATABASE.html#supplementallogclauses) or [table-level supplemental logging](../../Development Guide/SQL Reference Manual/SQL Statements (yashan Mode)/ALTER TABLE.html#supplementaltablelogging)).

2. Create and start the YStream service for CDC parsing of the database supplemental logs. For specific operations, please refer to [DBMS_YSTREAM_ADM](../../Development Guide/PL Reference Manual/Built-in Advanced PL Packages/DBMS_YSTREAM_ADM).
