...
#### IP Whitelist TCP.INVITED_NODES
...
#### IP Blacklist TCP.EXCLUDED_NODES
...
- Executing the [CREATE PROFILE](../../Development Guide/SQL Reference Manual/SQL Statements/CREATE PROFILE.md#ip) and [ALTER PROFILE](../../Development Guide/SQL Reference Manual/SQL Statements/ALTER PROFILE.md#ip) statements can configure the IP black/white list.

- Executing the [CREATE USER](../../Development Guide/SQL Reference Manual/SQL Statements/CREATE USER.md#profile) or [ALTER USER](../../Development Guide/SQL Reference Manual/SQL Statements/ALTER USER.md#profile) statements can associate users with profiles, i.e., configured users for the IP black/white list to take effect.

### IP Whitelist INVITED_NODES
