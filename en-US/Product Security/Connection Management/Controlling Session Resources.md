...
- Executing the [CREATE PROFILE](../../Development Guide/SQL Reference Manual/SQL Statements/CREATE PROFILE.md# res) and [ALTER PROFILE](../../Development Guide/SQL Reference Manual/SQL Statements/ALTER PROFILE.md# res) statements can configure session resource thresholds.

- Executing the [CREATE USER](../../Development Guide/SQL Reference Manual/SQL Statements/CREATE USER.md#profile) or [ALTER USER](../../Development Guide/SQL Reference Manual/SQL Statements/ALTER USER.md#profile) statements can associate users with profiles, i.e., configure the effective users for session resource threshold.

## Parallel Session Count SESSIONS_PER_USER
...
### Idle Session Retention Time IDLE_TIME
...
##  Configure Session Resource Control
