...
- Using SQL statements: The backup set must be stored on the database server.
    ...
    - Backup: [BACKUP DATABASE](../../开发手册/SQL参考手册/SQL语句（yashan模式）/BACKUP DATABASE) statement		
	- Restore: [RESTORE DATABASE](../../开发手册/SQL参考手册/SQL语句（yashan模式）/RESTORE DATABASE) and [RECOVER DATABASE](../../开发手册/SQL参考手册/SQL语句（yashan模式）/RECOVER DATABASE) statements
