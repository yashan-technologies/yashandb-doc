...
Up to 512 audit policies can be created. All audit policies can be viewed through the [AUDIT_UNIFIED_POLICIES](../../Reference Manual/System Views/DBA Views/AUDIT_UNIFIED_POLICIES) view.
...
<span id="noaudit" name="noaudit"></span>
