...
YashanDB provides the following cleanup strategies through the [DBMS_AUDIT_MGMT](../../Development Guide/PL Reference Manual/Built-in Advanced PL Packages/DBMS_AUDIT_MGMT) advanced package for users to choose from:
