...
- [Login to the database with dual-factor authentication using the JDBC driver](../../../Development Guide/JDBC Driver/YashanDB JDBC Advanced Configuration/Configuring Secure Connections.md#UKEY)

- [Login to the database with dual-factor authentication using the C driver](../../../Development Guide/C Language Family Drivers/C Driver/YashanDB C Drive Advanced Features/UKEY Authentication Login)
