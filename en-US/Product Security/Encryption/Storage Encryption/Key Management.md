...
<span id="configuringwallet" name="configuringwallet"></span>
...
1. Configure the wallet root directory [WALLET_ROOT](../../../Reference Manual/Configuration Parameters.md#wallet) parameter for a node in the database (such as the primary database in a standalone primary/standby deployment or any instance in a YAC/Distributed Cluster Deployment).
...
4. Execute the following statement to create the wallet. For syntax details, refer to the [create_keystore](../../../Development Guide/SQL Reference Manual/SQL Statements/ADMINISTER KEY MANAGEMENT.md#createkeystore) clause in the ADMINISTER KEY MANAGEMENT statement.
...
5. Execute the following statement to open the wallet. For syntax details, refer to the [open_keystore](../../../Development Guide/SQL Reference Manual/SQL Statements/ADMINISTER KEY MANAGEMENT.md#openkeystore) clause in the ADMINISTER KEY MANAGEMENT statement.

    ```sql
    ADMINISTER KEY MANAGEMENT SET KEYSTORE OPEN IDENTIFIED BY Your_keystore_password;
    ```

6. Execute the following statement to create and activate the master key. For syntax details, refer to the [set_key](../../../Development Guide/SQL Reference Manual/SQL Statements/ADMINISTER KEY MANAGEMENT.md#setkey) clause in the ADMINISTER KEY MANAGEMENT statement.
...
7. Configure and open the wallet for all standby databases in primary/standby deployments and other instances in YAC/Distributed Cluster Deployment:
    ...
    1. Configure the wallet root directory [WALLET_ROOT](../../../Reference Manual/Configuration Parameters.md#wallet) parameter for the other nodes in the database sequentially.
...
1. Configure the key management method (parameter [TDE_CONFIGURATION](../../../Reference Manual/Configuration Parameters.md#TDE_CONFIGURATION)) and the wallet root directory (parameter [WALLET_ROOT](../../../Reference Manual/Configuration Parameters.md#wallet)) for a node in the database (such as the primary database in a standalone high availability deployment or any instance in a YAC Deployment).
...
<span id="openwallet" name="openwallet"></span>
...
Perform a backup of the wallet using the [backup_keystore](../../../Development Guide/SQL Reference Manual/SQL Statements/ADMINISTER KEY MANAGEMENT.md#backupkeystore) clause of the `ADMINISTER KEY MANAGEMENT` statement.
