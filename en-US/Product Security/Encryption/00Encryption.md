...
- [Trusted Channel](Trusted Channel): Ensures the confidentiality and integrity of data during transmission based on trusted channels between the database client and server, as well as among the various nodes of the database.
