<span id="getCert" name="getCert"></span>

## Generate Certificates

<span id="getSSLCert" name="getSSLCert"></span>

###  SSL Related Certificates

The certificate file list for configuring SSL trusted channels ([Client<->Server SSL Trusted Channel](./Configuring Trusted Channel.md#ssl), [Primary-Standby Replication Network Trusted Channel](./Configuring Trusted Channel.md#hassl), or [DIN Trusted Channel](./Configuring Trusted Channel.md#dinssl)) is as follows. The corresponding filenames and paths need to be recorded.
...
<span id="getTLCPCert" name="getTLCPCert"></span>

###  TLCP Related Certificates

Certificate file list for configuring [Client <-> Server TLCP Trusted Channel](./Configuring Trusted Channel.md#tlcp) is as follows. The corresponding filenames and paths need to be recorded.
...
<span id="expire" name="expire"></span>
