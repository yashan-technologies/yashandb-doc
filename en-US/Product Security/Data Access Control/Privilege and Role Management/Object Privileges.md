...
YashanDB supports object privileges including various object operation permissions based on tables and certain [PL objects](../../../Development Guide/PL Reference Manual/PL Objects/00PL Objects) (including stored procedures, advanced packages, UDFs, and UDTs).
...
| **Sequences**: |  |
| SELECT | Allows querying the sequence |