...
For users created in mysql mode, it may also be necessary to consider whether they need to be granted the corresponding privileges in [yashan mode](../特权与角色管理（yashan模式）/00特权与角色管理（yashan模式）).
