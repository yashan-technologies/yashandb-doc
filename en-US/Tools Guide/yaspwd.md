...
A string composed of user-input characters, which must comply with the [Password Strength](../Product Security/Identity Identification and Authentication/Password Authentication/Password Policy.md#password_complexity) requirements.
