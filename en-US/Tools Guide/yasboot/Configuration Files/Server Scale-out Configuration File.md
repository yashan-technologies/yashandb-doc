The server scale-out configuration file lists the physical information of the newly added servers for the YashanDB server.
...
[[host]]
  ...
  path = "/data/yashan/yasdb_home" # Product installation path, ensure this path is empty; changes after scale-out will not take effect unless reinstalled
