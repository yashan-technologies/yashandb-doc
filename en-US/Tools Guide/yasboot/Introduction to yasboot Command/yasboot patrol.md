> **Caution**: 
>
> You need to enable [OS authentication](../../../Database Administration/Basic Database Management/OS Authentication Configuration) (which is enabled by default when following the standard installation steps) to use the patrol functionality properly.
