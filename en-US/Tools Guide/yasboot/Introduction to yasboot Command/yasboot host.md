...
This command is used to create a database resource management cgroup directory in the Standalone Deployment (non-cascade standby) and ISC Distributed Cluster Deployment environments of YashanDB.
...
Applicable only to Standalone Deployment (non-cascade standby) and ISC Distributed Cluster Deployment environments of YashanDB.
...
This command is used to enable operating system authentication for the current user.
...
This command is used to remove passwordless login for the operating system user on all deployed servers.
