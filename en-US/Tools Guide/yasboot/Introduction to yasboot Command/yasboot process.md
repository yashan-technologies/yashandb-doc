...
| --------------- | :------------------------------------------------------ |
| *-c, --cluster*   | The cluster name of YashanDB (mandatory parameter)                                |
| *-n, --node-id*   | Stop a single node on this server by specifying the ID of the target node (e.g., `1-2`. You can view the database information via the `yasboot cluster status` command and take the numeric string before the colon of `nodeid`) |
...
| ------------------ | :------------------------------------------------------ |
| *-c, --cluster*      | The cluster name of YashanDB (mandatory parameter)                                |
| *-n, --node-id*      | Start a single node on the local server by specifying the ID of the target node (e.g., `1-2`. You can view the database information via the `yasboot cluster status` command and take the numeric string before the colon of `nodeid`)  |
...
| ------------------ | :------------------------------------------------------ |
| *-c, --cluster*      | The cluster name of YashanDB (mandatory parameter)                                |
| *-n, --node-id*      | Restart a single node on the local server by specifying the ID of the target node (e.g., `1-2`. You can view the database information via the `yasboot cluster status` command and take the numeric string before the colon of `nodeid`)  |
