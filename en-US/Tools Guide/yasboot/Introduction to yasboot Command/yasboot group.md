...
| *-g, --group-id*  | Group ID (can be viewed via the `yasboot cluster status` command; the value before the hyphen in nodeid is the group-id, for example, the group ID for `1-1:1` is 1) (mandatory parameter) |
...
| ------------------ | ----------------------------------- |
| *-c, --cluster*      | The cluster name of YashanDB (mandatory parameter)  |
| *-g, --group-id*     | Group ID (can be viewed via the `yasboot cluster status` command; the value before the hyphen in nodeid is the group-id, for example, the group ID for `1-1:1` is 1) |
