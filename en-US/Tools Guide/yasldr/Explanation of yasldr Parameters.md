...
| MODE                           | [BASIC,BATCH]                      | Controls the import mode, supporting BASIC and BATCH modes, with the default value being BATCH.<br>* BASIC: Executes with INSERT INTO bound parameters; only supports importing views, GIS columns, interval partition tables, and duplicated tables in ISC Distributed Cluster Deployment.<br>* BATCH: Executes using BATCH INSERT protocol; currently cannot import range interval partition tables.                                                      |
