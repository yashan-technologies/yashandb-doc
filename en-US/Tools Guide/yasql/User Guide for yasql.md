...
- Method 4: Connection without URL, i.e., using [UDS local connection](../../Product Security/Connection Management/00Connection Management), indicating connection to the local database instance corresponding to the $YASDB_DATA environment variable. Using this connection method is a high privilege operation and should be used judiciously.
