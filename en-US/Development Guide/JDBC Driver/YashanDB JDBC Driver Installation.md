...
After successfully downloading and installing the aforementioned JDK version through the official Java path (www.oracle.com), you also need to configure the following environment variables (using Windows 10 as an example):
...
### Method 2: Offline Installation of YashanDB JDBC Driver
