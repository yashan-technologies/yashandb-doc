...
| **YashanDB Data Types** | **mysql Data Types** | get<br>String | get<br/>Object | get<br/>Boolean | get<br/>Int | get<br/>Byte | get<br/>Short | get<br/>Long |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| **YashanDB Data Types** | **mysql Data Types** | get<br/>Bytes | get<br/>Float | get<br/>Double | getBig<br/>Decimal | get<br/>Date | get<br/>Time | get<br/>Timestamp |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CHAR | CHAR | Y | Y | Y | Y | Y | Y | Y |
| VARCHAR | VARCHAR | Y | Y | Y | Y | Y | Y | Y |
| NCHAR | NCHAR | Y | Y | Y | Y | Y | Y | Y |
...
| **YashanDB Data Types** | **mysql Data Types** | get<br/>Blob | get<br/>Clob | get<br/>NClob | getAscii Stream | get<br/>Character Stream | get<br/>Unicode Stream |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| **YashanDB Data Types** | **mysql Data Types** | get<br/>Binary Stream | get<br/>RowId | get<br/>NCharacter Stream | get<br/>NString | get<br/>Array | get<br/>SQLXML | get<br/>Ref | get<br/>URL |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
