...
The YashanDB JDBC driver supports the CLOB interface functionality (Standalone Deployment / YAC Deployment):
...
Unsupported functionality (Standalone Deployment / YAC Deployment):
