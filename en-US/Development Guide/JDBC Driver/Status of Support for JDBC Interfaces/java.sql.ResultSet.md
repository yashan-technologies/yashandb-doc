The ResultSet interface represents the result set obtained after executing an SQL query. It can be retrieved through the executeQuery method of the Statement or the getResultSet method. This interface is used to iterate over the query results.

YashanDB JDBC driver supports the following functionalities for the ResultSet interface:
