...
Using TAF-related functions requires configuring some parameters during database connection. Please refer to [Configuring High Availability Connections](./Connect to YashanDB/Configuring High Availability Connections) for details.
