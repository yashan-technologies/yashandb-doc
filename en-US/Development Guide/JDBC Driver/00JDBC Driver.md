...
For a simple process of connecting and operating YashanDB in Java applications, refer to [YashanDB JDBC Driver Usage Introduction](YashanDB JDBC Driver Usage Introduction).
...
- Transparent application failover functionality, allowing the client to automatically reconnect to other configured nodes after a failure occurs in the current connection node; see the description in [JDBC Transparent Application Failover](JDBC Advanced Features/Transparent Application Failover).
