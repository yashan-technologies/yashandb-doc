YashanDB ADO.NET driver will convert between YashanDB data types and C# data types, as follows:

- C# to YashanDB mapping

  |C# Data Type |YasTypes |YashanDB Data Type |
  | --------------- | -------------------------- | ---------------- |
...
- YashanDB to C# mapping

  |YashanDB Data Type |YasTypes |C# Data Type |
  | ---------------- | ---------------------------- | --------------- |
