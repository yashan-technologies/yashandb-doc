FastLoader performs type conversions between YashanDB data types and Java data types. The conversion mapping is shown in the table below:
...
| INTERVAL YEAR TO MONTH | YasTypes.YM\_INTERVAL | java.sql.Types.OTHER                         | \--                                  | Y     |
| INTERVAL DAY TO SECOND | YasTypes.DS\_INTERVAL | java.sql.Types.OTHER                         | \--                                  | Y     |
| \--                    |                       | java.sql.Types.<br>TIMESTAMP\_WITH\_TIMEZONE | \--                                  | Y     |
| \--                    |                       | java.sql.Types.<br>TIME\_WITH\_TIMEZONE      | \--                                  | Y     |
| BIT                    | YasTypes.BIT          | java.sql.Types.BIT                           | BIT(1):boolean<br>BIT(2~64):byte\[\] | Y     |
| CURSOR                 | YasTypes.CURSOR       | java.sql.Types.REF_CURSOR                   | java.sql.ResultSet                   | N     |
| CURSOR                 | YasTypes.REF_CURSOR   | java.sql.Types.REF_CURSOR                   | java.sql.ResultSet                   | N     |
