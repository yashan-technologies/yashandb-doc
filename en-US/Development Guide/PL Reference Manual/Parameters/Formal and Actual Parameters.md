...
For OUT and IN OUT parameter types, the NOCOPY keyword can be specified simultaneously. This keyword is for syntax compatibility and has no practical meaning.
