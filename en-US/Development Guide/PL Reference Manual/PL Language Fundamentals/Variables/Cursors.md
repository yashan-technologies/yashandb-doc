...
*Parameter Name [Parameter type] Data Type  [Default Value]*

There are three parameter types: IN, OUT, and IN OUT. A type can be explicitly specified for each formal parameter or can be left unspecified to use the default IN type.
