...
User-defined types defined in PL [UDT](../../PL Objects/User-Defined Types) and ordinary scalar data types defined in SQL [Data Types](../../../SQL Reference Manual/Data Types/00Data Types). When the data type is a character type, its Size attribute must also be specified, for example, VARCHAR(10), but input CHAR defaults to CHAR(1); the maximum Size that can be specified is 65534.
