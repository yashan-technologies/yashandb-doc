...
- Assignment to the array can also be performed using built-in functions related to arrays, such as [STRING_TO_ARRAY](../../../SQL Reference Manual/Built-in Functions (yashan Mode)/STRING_TO_ARRAY), [ARRAY_APPEND](../../../SQL Reference Manual/Built-in Functions (yashan Mode)/ARRAY_APPEND), [ARRAY_REMOVE](../../../SQL Reference Manual/Built-in Functions (yashan Mode)/ARRAY_REMOVE), [ARRAY_REPLACE](../../../SQL Reference Manual/Built-in Functions (yashan Mode)/ARRAY_REPLACE), etc.
