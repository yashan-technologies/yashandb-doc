...
For PL objects created using SQL statements like [CREATE PROCEDURE](../../SQL Reference Manual/SQL Statements/CREATE PROCEDURE) and [CREATE FUNCTION](../../SQL Reference Manual/SQL Statements/CREATE FUNCTION), they will be stored in the database upon creation, achieving persistence.
...
For PL objects that are no longer in use, they can be deleted from the database using SQL statements such as [DROP PROCEDURE](../../SQL Reference Manual/SQL Statements/DROP PROCEDURE) and [DROP FUNCTION](../../SQL Reference Manual/SQL Statements/DROP FUNCTION).

## Recompiling PL Objects

Using SQL statements like [ALTER FUNCTION](../../SQL Reference Manual/SQL Statements/ALTER FUNCTION), [ALTER PACKAGE](../../SQL Reference Manual/SQL Statements/ALTER PACKAGE), [ALTER PROCEDURE](../../SQL Reference Manual/SQL Statements/ALTER PROCEDURE), and [ALTER TRIGGER](../../SQL Reference Manual/SQL Statements/ALTER TRIGGER), UDFs, packages, stored procedures, and triggers can be recompiled.
...
YashanDB uses a system privilege mechanism (please refer to [System Privilege](../../../Product Security/Data Access Control/Privilege and Role Management/System Privileges)) to control the security of the creation and use of PL objects, specifically including the following privileges:
...
<span id="invoker" name="invoker"></span>
