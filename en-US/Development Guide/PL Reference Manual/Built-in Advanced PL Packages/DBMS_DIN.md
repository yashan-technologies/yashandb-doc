...
> - The DBMS_DIN advanced package only supports the ISC Distributed Cluster Deployment form; executing it in a standalone or YAC form will result in an error.
...
- NODE_ID, LINK_LEVEL, and LINK_ID can be referenced based on the query results from the views [V\$DIN_LINK](../../../Reference Manual/System Views/Dynamic Performance Views/V$DIN_LINK) and [GV$DIN_LINK](../../../Reference Manual/System Views/Dynamic Performance Views/GV$DIN_LINK).
