...
_CONTINUE \[label\_name\] \[WHEN condition\];_

Here, label\_name is optional and identifies the current or outer loop that needs to skip the iteration; WHEN condition is optional, and condition is an expression that generates a boolean result.
