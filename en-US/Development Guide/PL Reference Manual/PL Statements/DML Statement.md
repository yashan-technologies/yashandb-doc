...
Under this usage, the INSERT statement can only use the [insert_values_clause](../../SQL Reference Manual/SQL Statements/INSERT) syntax, not for multi-row or subquery inserts.

In this usage, the [returning_clause](../../SQL Reference Manual/SQL Statements/INSERT) syntax cannot return variables.
...
In this usage, the [returning_clause](../../SQL Reference Manual/SQL Statements/UPDATE.md#returningclause) syntax cannot return variables.
