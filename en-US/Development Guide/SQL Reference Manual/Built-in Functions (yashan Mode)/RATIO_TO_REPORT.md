...
RATIO_TO_REPORT is a [window function](00Built-in Functions (yashan Mode).html#WindowFunction) used to calculate the ratio of a value to the total sum of all values within a group.
