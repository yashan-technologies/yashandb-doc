...
This function will only take effect when the character set configured for the database simultaneously includes both single-byte and multi-byte characters.
