...
expr1, expr2, and expr3 are all [general expressions](../General SQL Syntax/expr) recognized by YashanDB.
...
* If both expr2 and expr3 are not null and their data types are different, the function will first perform [data type conversion](../Data Types (yashan Mode)/Data Type Conversion) and return the converted data type; if the two data types cannot be converted, a type conversion error will be returned. When both data types support conversion, the conversion rules are as follows:
