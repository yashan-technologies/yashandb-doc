...
json_value is a binary [json](../General SQL Syntax/json) data, which can be obtained using the [JSON](./JSON JSON_PARSE) function. When json_value is NULL, the function returns NULL.
...
A path expression, which is a constant string; its format is defined in the [json](../General SQL Syntax/json) documentation.
