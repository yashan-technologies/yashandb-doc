...
The LAST_DAY function returns the last day of the month for the date value represented by [expr](../General SQL Syntax/expr), with a return type of DATE, consistent with the format specified by the DATE_FORMAT parameter.
