...
The BIN_TO_NUM function is used to convert binary to decimal. It converts a binary bit vector string represented by one or more [expr](../General SQL Syntax/expr) combinations into its equivalent numeric value, returning a NUMBER type data.
