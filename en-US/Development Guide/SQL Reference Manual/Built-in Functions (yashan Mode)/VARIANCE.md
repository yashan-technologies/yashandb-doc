...
The syntax for the KEEP aggregate function is generic; for details refer to [KEEP aggregate function](00Built-in Functions (yashan Mode).html#KeepAggregateFunction).
