...
[General Expression](../General SQL Syntax/expr), which must be of character type or other types that can be implicitly converted to character type. If split_string is NULL, there will be no delimiter in the concatenation.

**replace_string**

[General Expression](../General SQL Syntax/expr), which must be of character type or other types that can be implicitly converted to character type.
