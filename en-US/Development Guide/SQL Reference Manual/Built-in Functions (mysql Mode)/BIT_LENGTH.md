...
The value of expr must be of character type, BIT type, or other types that are not floating-point and can be converted to character type.
...
- When expr is of BIT type, the function counts the total number of bits occupied by the BIT digit.
