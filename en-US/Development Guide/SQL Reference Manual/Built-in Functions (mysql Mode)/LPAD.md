...
- The return value type being LOB depends on whether pad_length exceeds 65534.
...
Specifies the final length after padding. pad_length is a general expression that must be convertible to BIGINT, with a value range of [-9223372036854775808,9223372036854775807].
