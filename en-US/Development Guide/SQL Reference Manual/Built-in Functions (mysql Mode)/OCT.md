...
The OCT function will perform octal conversion on the input string or number. The function returns the octal form of the number after converting the string or directly returns the octal of the number.
