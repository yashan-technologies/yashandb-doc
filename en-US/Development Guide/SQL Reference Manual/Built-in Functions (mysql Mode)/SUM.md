...
When the OVER keyword is specified, SUM acts as a [window function](../Built-in Functions (yashan Mode)/00Built-in Functions (yashan Mode).html#WindowFunction), supporting a sliding window and returning the sum of multiple rows.

**analytic_clause**

The general syntax for window functions; for more details, please refer to [window function](../Built-in Functions (yashan Mode)/00Built-in Functions (yashan Mode).html#WindowFunction).
