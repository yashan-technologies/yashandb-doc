...
Specifies the final length after padding. pad_length is a generic expression that must be of a type that can be converted to BIGINT, with a value range of [-9223372036854775808, 9223372036854775807].
