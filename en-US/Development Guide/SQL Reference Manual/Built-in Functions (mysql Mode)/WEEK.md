...
If the mode parameter is not specified, the default value is the DEFAULT_WEEK_FORMAT system variable. Please refer to [System Variables (mysql Mode)](../../../参考手册/系统变量（mysql模式）).
