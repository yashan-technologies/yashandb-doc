...
The NUMTODSINTERVAL function converts the numeric data represented by [expr](../General SQL Syntax/expr), excluding BIT, into an INTERVAL DAY TO SECOND value with units of DAY|HOUR|MINUTE|SECOND.
