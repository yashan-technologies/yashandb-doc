...
| SID                        | Session ID                                                   |
| CON_ID                     | The current container ID that the session is connected to (only meaningful when YashanDB is deployed as a CDB)                |
| CON_NAME                   | The current container name that the session is connected to (only meaningful when YashanDB is deployed as a CDB)               |
