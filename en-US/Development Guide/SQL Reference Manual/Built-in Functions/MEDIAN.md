...
The MEDIAN function calculates the median of the given parameter [expr](../General SQL Syntax/expr). It only supports expr types of [numeric](../Data Types/Numeric Types) or [date-time](../Data Types/Date-Time Types). Using other data types will result in an error.
