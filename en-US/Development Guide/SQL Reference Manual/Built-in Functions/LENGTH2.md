...
```
The LENGTH2 function counts the length of the value of [expr](../General SQL Syntax/expr), supporting length calculation with UTF16 encoding and returning a BIGINT value.
...
A general expression whose value must be of character type or other types that can be converted to character type, excluding BIT and LOB types.
