...
When the OVER keyword is specified, MIN will act as a [window function](00Built-in Functions.md#WindowFunction) and supports sliding windows, returning the minimum value across multiple rows.
...
KEEP aggregate function general syntax, please refer to [KEEP aggregate function](00Built-in Functions.md#KeepAggregateFunction).

When using the KEEP clause, the MIN function cannot use DISTINCT|UNIQUE.
