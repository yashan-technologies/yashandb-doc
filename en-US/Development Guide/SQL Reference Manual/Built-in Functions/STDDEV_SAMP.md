...
The STDDEV\_SAMP function calculates the sample standard deviation of the value of [expr](../General SQL Syntax/expr).

When the given parameter contains only one row of data, the result of the STDDEV\_SAMP function is NULL.

The return value type of the STDDEV\_SAMP function can be one of the following cases:
