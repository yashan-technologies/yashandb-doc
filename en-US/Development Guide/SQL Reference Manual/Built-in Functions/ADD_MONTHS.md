...
The value of date_expr must be of DATE, TIMESTAMP, or character data type, as recognized by YashanDB's [general expression](../General SQL Syntax/expr).
...
The value of integer_expr must be of NUMBER type or convertible to NUMBER character type, as recognized by YashanDB's [general expression](../General SQL Syntax/expr).
