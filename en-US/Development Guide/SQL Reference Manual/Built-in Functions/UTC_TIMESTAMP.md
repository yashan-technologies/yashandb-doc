...
When the UTC_TIMESTAMP function is involved in calculations, its calculation rules are consistent with the TIMESTAMP type, as described in the [Arithmetic Operators](../Operators/Arithmetic Operators) section.
