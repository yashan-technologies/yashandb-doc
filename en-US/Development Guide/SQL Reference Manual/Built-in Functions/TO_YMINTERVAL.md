...
The TO\_YMINTERVAL function converts the value of [expr](../General SQL Syntax/expr) to a value of the INTERVAL YEAR TO MONTH type.

When the value of expr is NULL, the function returns NULL.

The value of expr should be of character type; otherwise, it returns unsupported type. The string must comply with the ym\_sql\_format format; otherwise, it returns a format conversion error.
