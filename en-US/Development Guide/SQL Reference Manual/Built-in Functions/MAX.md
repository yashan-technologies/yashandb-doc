...
When the OVER keyword is specified, MAX acts as a [window function](00Built-in Functions.md#WindowFunction) and supports sliding windows, returning the maximum value of multiple rows.
...
KEEP aggregate function general syntax, for details please refer to [KEEP aggregate function](00Built-in Functions.md#KeepAggregateFunction).

When using the KEEP clause, the MAX function cannot use DISTINCT|UNIQUE.
