...
The DATE_FORMAT function extracts the given parameter [expr](../General SQL Syntax/expr) according to the format defined by format, returning a VARCHAR type string.
