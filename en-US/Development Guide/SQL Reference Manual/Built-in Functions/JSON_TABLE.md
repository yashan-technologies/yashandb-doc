...
expr is a data type that can be converted into binary [json](../General SQL Syntax/json) data, including JSON, RAW, CLOB, BLOB, NCLOB, CHAR, NCHAR, VARCHAR, NVARCHAR.
...
A path expression, which is a constant string. For its format definition, please refer to [json](../General SQL Syntax/json). 
