...
When the OVER keyword is specified, COUNT will act as a [window function](00Built-in Functions.md#WindowFunction) and supports sliding windows, returning the count of multiple rows.
...
General syntax for KEEP aggregate functions. For more details, see [KEEP aggregate function](00Built-in Functions.md#KeepAggregateFunction).
