...
The return value of CURRENT_DATE may vary depending on the time zone configuration (via the [TIME_ZONE](../../../Reference Manual/Configuration Parameters.md#time_zone) parameter).
