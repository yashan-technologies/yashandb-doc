...
The GET_TYPE_NAME function takes [expr](../General SQL Syntax/expr) as the data type ID to query the name of the type and returns the result as a VARCHAR type string.
