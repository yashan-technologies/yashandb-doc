...
The TO\_NUMBER function converts the value of [expr](../General SQL Syntax/expr) to NUMBER type data according to the format.
...
*   CLOB or NCLOB (Only for HEAP tables).
