...
RPAD pads the string represented by [expr](../General SQL Syntax/expr) with a specified character to a specified length from the right, producing a new string.
