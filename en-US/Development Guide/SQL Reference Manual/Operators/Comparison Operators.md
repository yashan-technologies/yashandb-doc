...
| IS [NOT] EMPTY | Unary  | Is the number of nested table members [not] zero | IS EMPTY: <br />* Nested Table is NULL: Result is NULL <br />* The number of nested table members is 0: Result is TRUE <br />* The number of nested table members is not 0: Result is FALSE <br />IS NOT EMPTY: <br />* Nested Table is NULL: Result is NULL <br />* The number of nested table members is 0: Result is FALSE <br />* The number of nested table members is not 0: Result is TRUE |
...
> **Note**: 
>
> Comparison between character types performs a case-sensitive string comparison. Please refer to the [character type](../Data Types/Character Types) document for detailed description.
...
| **YM\_<br/>INTERVAL** | \-- | YM\_<br/>INTERVAL | \-- | \-- | \-- | \-- | \-- | YM\_<br/>INTERVAL | \-- | \-- |
| **DS\_<br/>INTERVAL** | \-- | DS\_<br/>INTERVAL | \-- | \-- | \-- | \-- | \-- | \-- | DS\_<br/>INTERVAL | DS\_<br/>INTERVAL |
| **TIME** | \-- | TIME | \-- | \-- | \-- | \-- | \-- | \-- | DS\_<br/>INTERVAL | TIME |
