...
In a ISC Distributed Cluster Deployment, when executing this statement, the system will check for any unhandled DDL statements. If any exist, an error will be raised, and this statement must wait until the corresponding DDL is successfully recovered before it can be executed.
