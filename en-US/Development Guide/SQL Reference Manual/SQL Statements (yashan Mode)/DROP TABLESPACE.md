...
In the event of node failures while deleting a tablespace in ISC Distributed Cluster Deployment, recovery measures can be found in the [User Tablespace Management](../../../Database Administration/Tablespace Management/General Tablespace Management) section.
