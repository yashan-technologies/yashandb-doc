...
CREATE ROLE is used to create a role. Role management is part of the privilege system. For the role management system of YashanDB, please refer to the product security manual [Role Management](../../../Product Security/Data Access Control/Privilege and Role Management (yashan Mode)/Roles).
