...
- FORCE: if conditions are met, prefer fast refresh; if fast refresh is not available, use full refresh

At most one refresh type can be specified; if omitted, the default is FORCE.
