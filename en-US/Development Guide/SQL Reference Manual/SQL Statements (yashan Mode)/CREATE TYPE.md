...
For a detailed description of the syntax of CREATE TYPE, please refer to the [UDT](../../PL Reference Manual/PL Objects/User-Defined Types) section of the PL Reference Manual.