...
In addition to custom tablespace creation on demand, YashanDB has a built-in set of basic tablespaces. For related information, please refer to the [tablespace_clause](CREATE DATABASE.md#tablespaceclause) of CREATE DATABASE or [Tablespace Management](../../../Database Administration/Storage Management/Logical Space Management/Tablespace Management/00Tablespace Management.md#build-in).
...
>
> If a node failure occurs during the execution of this statement in ISC Distributed Cluster Deployment, please refer to [User Tablespace Management](../../../Database Administration/Storage Management/Logical Space Management/Tablespace Management/General Tablespace Management).
