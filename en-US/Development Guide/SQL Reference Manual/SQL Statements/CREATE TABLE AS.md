...
```ebnf
= "(" (out_of_line_constraint|column_name [DEFAULT default_expr] [inline_constraint])      {"," (out_of_line_constraint|column_name [DEFAULT default_expr] [inline_constraint])} ")".
```
