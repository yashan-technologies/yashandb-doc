...
This statement is used to specify the name of the context being created. It is mandatory and must comply with YashanDB's [object naming convention](../Basic SQL Elements/Identifiers).
