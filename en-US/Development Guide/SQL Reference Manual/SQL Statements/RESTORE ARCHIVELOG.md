...
For detailed instructions on backup and recovery operations, please refer to [Backup and Recovery](../../../Database Administration/Backup and Recovery/00Backup and Recovery).
...
```ebnf
= RESTORE archivelog archivelogRangeSpecifier [DECRYPTION  password] [PARALLELISM integer] FROM (SEARCHDIR|BACKUPSET) 'archdirpath' [TO 'destpath'].
```
