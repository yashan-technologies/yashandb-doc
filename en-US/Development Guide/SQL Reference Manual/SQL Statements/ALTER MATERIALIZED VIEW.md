...
```ebnf
= ALTER MATERIALIZED VIEW [schema"."] materialized_view_name (alter_mv_refresh_properties |  alter_query_rewrite_clause ) .
```
...
- ON DEMAND: Manual refresh, i.e., refresh via the [DBMS_MVIEW](../../PL Reference Manual/Built-in Advanced PL Packages/DBMS_MVIEW) advanced package
