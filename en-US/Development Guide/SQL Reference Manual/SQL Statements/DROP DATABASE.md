...
This statement is only applicable to a CDB (with configuration parameter ENABLE_PLUGGABLE_DATABASE=TRUE), determining whether to retain metadata of the executing container (the CDB root or a PDB). The default is not to retain. 
