...
[**size\_clause/maxsize\_clause**](size_clause)

The storage_clause is used to describe the attributes of a segment and can be used when creating objects such as tables or indexes. However, this statement has no practical meaning in YashanDB and is only used for syntax compatibility.
