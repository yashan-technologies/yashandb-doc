...
- The BULKLOAD hint cannot be used simultaneously with [SAVEPOINT](../SQL Statements (yashan Mode)/SAVEPOINT) functionality.
- The BULKLOAD hint cannot be used in [INSERT ON DUPLICATE UPDATE](../SQL Statements (yashan Mode)/INSERT) statements.
...
- Insertion operations using the BULKLOAD hint will block ALTER TABLE/COMPACT operations until the BULKLOAD insertion transaction is committed.
...
### MAX\_WORKERS\_PER\_EXEC Hint Item
