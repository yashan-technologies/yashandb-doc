...
- Using array functions, such as [ARRAY_TO_STRING](../Built-in Functions (yashan Mode)/ARRAY_TO_STRING).
- Using the table() method, for syntax details see the table_collection_clause description in the [SELECT](../SQL Statements (yashan Mode)/SELECT) statement.
...
The declaration method for Nested Table types can be found in the nested_table_clause description in [CREATE TABLE](../SQL Statements (yashan Mode)/CREATE TABLE).
