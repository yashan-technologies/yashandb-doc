...
1. Allows the following values to be inserted into Boolean fields (case insensitive).
...
2. Allows conversion between Boolean type and integer values, where non-zero integers can convert to true, but true can only convert to integer 1.

3. Allows comparison between Boolean type and integer values.
