...
This example uses the YashanDB JDBC driver client program to insert a record containing an image into customer_img. The example refers to the getConnection method in the [YashanDB JDBC driver usage examples](../../JDBC Driver/YashanDB JDBC Driver Usage Examples).
