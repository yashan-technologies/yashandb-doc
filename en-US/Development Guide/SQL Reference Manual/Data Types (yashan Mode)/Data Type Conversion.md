...
|------------------------------------------------|---------------------------------|
| [BIN](../Built-in Functions (yashan Mode)/BIN)                             | Convert other types to BIT type (the result is hosted as VARCHAR type).                   |
| [CAST](../Built-in Functions (yashan Mode)/CAST)                           | Specify conversion to any type.                      |
| [NUMTODSINTERVAL](../Built-in Functions (yashan Mode)/NUMTODSINTERVAL)     | Convert numeric types to INTERVAL DAY TO SECOND type. |
| [NUMTOYMINTERVAL](../Built-in Functions (yashan Mode)/NUMTOYMINTERVAL)     | Convert numeric types to INTERVAL YEAR TO MONTH type. |
| [ROWIDTOCHAR](../Built-in Functions (yashan Mode)/ROWIDTOCHAR)             | Convert ROWID type to VARCHAR type.                      |
| [SCN_TO_TIMESTAMP](../Built-in Functions (yashan Mode)/SCN_TO_TIMESTAMP) | Convert BIGINT type to TIMESTAMP type.         |
| [TIMESTAMP_TO_SCN](../Built-in Functions (yashan Mode)/TIMESTAMP_TO_SCN) | Convert TIMESTAMP type to BIGINT type.         |
| [TO_CHAR](../Built-in Functions (yashan Mode)/TO_CHAR)                    | Convert other types to VARCHAR type.               |
| [TO_DATE](../Built-in Functions (yashan Mode)/TO_DATE)                | Convert other types to DATE type.                |
| [TO_DSINTERVAL](../Built-in Functions (yashan Mode)/TO_DATE)                    | Convert other types to INTERVAL DAY TO SECOND type.                  |
| [TO_NUMBER](../Built-in Functions (yashan Mode)/TO_NUMBER)                | Convert other types to NUMBER type.                |
| [TO_TIMESTAMP](../Built-in Functions (yashan Mode)/TO_TIMESTAMP)          | Convert other types to TIMESTAMP type.             |
| [TO_TIMESTAMP_TZ](../Built-in Functions (yashan Mode)/TO_TIMESTAMP_TZ)   | Convert other types to TIMESTAMP WITH TIME ZONE type.|
| [TO_YMINTERVAL](../Built-in Functions (yashan Mode)/TO_YMINTERVAL)        | Convert other types to INTERVAL YEAR TO MONTH type. |
| [JSON](../内置函数（yashan模式）/JSON JSON_PARSE)                           | Convert string type to JSON type.                 |
| [JSON_SERIALIZE](../内置函数（yashan模式）/JSON_SERIALIZE JSON_FORMAT)      | Convert JSON type to string type.                 |