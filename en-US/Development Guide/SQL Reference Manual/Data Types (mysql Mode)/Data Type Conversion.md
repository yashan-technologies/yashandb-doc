...
|------------------------------------------------|---------------------------------|
| [BIN](../Built-in Functions (mysql Mode)/BIN)                             | Converts other types to BIT type (the result is returned in VARCHAR type containing the BIT value).                   |
| [CAST](../Built-in Functions (mysql Mode)/CAST)                           | Converts to the specified type.                      |
| [CONVERT](../Built-in Functions (mysql Mode)/CONVERT)                           | Converts to the specified type or character set.                      |
