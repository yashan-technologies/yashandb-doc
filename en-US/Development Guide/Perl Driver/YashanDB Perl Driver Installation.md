...
The Perl driver does not have a driver package. Once you have completed the installation of perl, the Perl DB modules, and the YashanDB ODBC driver, you can use perl to operate on the YashanDB.