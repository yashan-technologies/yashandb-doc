...
The order of space allocation must follow the [handle hierarchy](./00Handle and Descriptor Functions), with the upper-level handle serving as the input handle when allocating space for this handle. 
