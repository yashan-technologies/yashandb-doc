The table below shows all supported YashanDB external data types:

|External Data Type Identifier |External Data Type Definition |Actual External Data Type Definition Structure |
|------------------------|---------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
...
| YAC_SQLT_CLOB                 | YacLobLocator                | Internal Structure                                                                                                                                                          |
| YAC_SQLT_BLOB                 | YacLobLocator                | Internal Structure                                                                                                                                                          |
| YAC_SQLT_NCLOB                | YacLobLocator                | Internal Structure                                                                                                                                                          |
...
| YAC_SQLT_JSON                 | YacLobLocator                | Internal Structure                                                                                                                                                          |
|YAC_SQLT_VECTOR| YacVector| Internal Structure      |
| YAC_SQLT_CHAR2         | YacChar*      | char*                                                                                                                                           |
| YAC_SQLT_VARCHAR2      | YacChar*      | char*                                                                                                                                           |
| YAC_SQLT_BINARY2       | YacChar*      | char*                                                                                                                                           |
| YAC_SQLT_CURSOR        | YacHandle     | void*                                                                                                                                           |
| YAC_SQLT_OBJSTRING            | YacString                    | Internal Structure                                                                                                                                                          |
| YAC_SQLT_OBJRAW               | YacRaw                       | Internal Structure                                                                                                                                                          |