...
| ------------------------------------------------------------ | ---------------------- |
| [yacAllocHandle](../C Driver Interfaces/Handle and Descriptor Functions/yacAllocHandle) | Allocate space for handle |
| [yacFreeHandle](../C Driver Interfaces/Handle and Descriptor Functions/yacFreeHandle) | Free handle space      |
| [yacConnect](../C Driver Interfaces/Connection & Authorization & Initialization Functions/yacConnect) | Client initiates connection request |
| [yacDisconnect](../C Driver Interfaces/Connection & Authorization & Initialization Functions/yacDisconnect) | Client initiates disconnection request |
