...
The format and configuration of the url is the same as the url (IN) parameter of the [yacConnect](../YashanDB C Driver Interfaces/Connection & Authorization & Initialization Functions/yacConnect) function.
