...
| bindp (IN/OUT)      | The address of the binding handle that is implicitly allocated by this call. The binding handle maintains all binding information for this specific input value. When the statement handle is released, this handle is implicitly released. |
