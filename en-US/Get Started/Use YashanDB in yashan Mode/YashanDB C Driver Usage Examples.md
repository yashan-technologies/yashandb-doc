...
| ------------------------------------------------------------ | ---------------------- |
| [yacAllocHandle](../../All Manuals/Development Guide/C Language Family Drivers/C Driver/C Driver Interfaces/Handle and Descriptor Functions/yacAllocHandle) | Allocate space for a handle |
| [yacFreeHandle](../../All Manuals/Development Guide/C Language Family Drivers/C Driver/C Driver Interfaces/Handle and Descriptor Functions/yacFreeHandle) | Free space for a handle   |
| [yacConnect](../../All Manuals/Development Guide/C Language Family Drivers/C Driver/C Driver Interfaces/Connection & Authorization & Initialization Functions/yacConnect) | Initiate connection request from the client |
| [yacDisconnect](../../All Manuals/Development Guide/C Language Family Drivers/C Driver/C Driver Interfaces/Connection & Authorization & Initialization Functions/yacDisconnect) | Initiate disconnect request from the client |
