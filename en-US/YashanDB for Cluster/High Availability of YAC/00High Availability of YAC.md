...
- [Transparent Application Failover](Transparent Application Failover) implements the ability for clients to automatically switch to active instances in the cluster.