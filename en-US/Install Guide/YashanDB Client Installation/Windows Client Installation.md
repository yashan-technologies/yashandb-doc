...
- Character Set Configuration: The default character set for Windows client is GBK. To adjust this, please refer to [Modifying Client Character Set](../../All Manuals/Database Administration/Instance Management/Database Character Set Configuration.html#Client).
