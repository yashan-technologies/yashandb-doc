...
The client supports installation on both Windows and Linux platforms. For specific installation procedures, please refer to [Windows Client Installation](../../All Manuals/Installation and Upgrade/Installation and Deployment/YashanDB Client Installation/Windows客户端安装) and [Linux Client Installation](../../All Manuals/Installation and Upgrade/Installation and Deployment/YashanDB Client Installation/Linux客户端安装).