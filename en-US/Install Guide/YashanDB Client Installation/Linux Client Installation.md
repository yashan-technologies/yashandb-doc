...
- [Script Installation](#ScriptInstall): Suitable for all Linux platforms, corresponding uninstallation method is [Uninstalling YashanDB Client Installed via Script](../../All Manuals/Installation and Upgrade/卸载/卸载YashanDB客户端.html#ScriptUninstall).

- [RPM Installation](#RPMInstall): Only suitable for CentOS Linux platforms, corresponding uninstallation method is [Uninstalling YashanDB Client Installed via RPM](../../All Manuals/Installation and Upgrade/卸载/卸载YashanDB客户端.html#RPMUninstall).
...
- Character Set Configuration: The default character set for Windows clients is GBK. To adjust this, please refer to [Modifying Client Character Set](../../All Manuals/数据库管理/基本数据库管理/字符集配置.html#Client).

- Trusted Channel: Database client \<-> server trusted channel is disabled by default. If encrypted communication is required, please refer to [Trusted Channel](../../All Manuals/数据库管理/基本数据库管理/SSL可信信道配置/数据库服务端SSL可信信道).
