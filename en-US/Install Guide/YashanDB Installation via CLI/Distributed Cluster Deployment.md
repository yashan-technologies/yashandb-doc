...
Based on the deployment scale of the database, the parameters that need to be specified when generating the configuration file may vary slightly, as shown in the table below. For a complete list of parameters, please refer to the [yasboot package ce gen command](../../All Manuals/Tools Guide/yasboot/Introduction to yasboot Command/yasboot package.html#ce).
