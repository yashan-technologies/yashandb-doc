...
>
>       During the installation process of YAC and Distributed Cluster, the [fenceScsiCheck script](../../All Manuals/YashanDB for Cluster/Yashan Cluster Service/IO Fencing/SCSI IO Fencing.html#fenceScsiCheck_usage) will automatically be invoked to check the storage and other devices/environments (Whether detection errors occur or not will not block the installation). This script requires *mpathpersist* and *sshpass*.
>
