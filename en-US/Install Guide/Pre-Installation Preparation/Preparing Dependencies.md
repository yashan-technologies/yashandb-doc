...
>
>       During the installation process of YAC and Distributed Cluster, the [fenceScsiCheck script](../../All Manuals/数据库管理/集群管理/IO Fencing/基于SCSI持久预留的IO Fencing.html#fenceScsiCheck_usage) will automatically be invoked to check the storage and other devices/environments (Whether detection errors occur or not will not block the installation). This script requires *mpathpersist* and *sshpass*.
>
