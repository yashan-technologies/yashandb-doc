...
Some features require additional environment variables. If you need to use [External UDF (Java)](../../All Manuals/Development Guide/PL Reference Manual/PL Objects/User-Defined Functions.html#ext_udf), the following environment variables also need to be configured and take effect.
