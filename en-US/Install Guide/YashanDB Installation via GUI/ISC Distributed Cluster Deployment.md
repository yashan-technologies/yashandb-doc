...
2. (Optional) Create database users and grant permissions; for more operations, please refer to [User Management](../../All Manuals/Product Security/Identity Identification and Authentication/User/00User).
