...
6. 执行表空间全量备份。
    ...
    ```shell
    $ yasrman sys/sys@192.168.1.2:1688 -c "backup tablespace TPS_TEST_SPC_BAK tag 'spc_full_1' format 'spc_full_bak1'" -D /home/yashan/catalog
    backup successfully
    ```
...
9. RESTORE目标表空间。
    ...
    $ yasrman sys/sys@192.168.1.2:1688 -c "restore tablespace TPS_TEST_SPC_BAK from tag 'spc_full_1'  clean file" -D /home/yashan/catalog 
...
10. RECOVER目标表空间。
    ...
    $ yasrman sys/sys@192.168.1.2:1688 -c "recover tablespace TPS_TEST_SPC_BAK" -D /home/yashan/catalog 
