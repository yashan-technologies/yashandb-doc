...
2. 执行[CREATE USER](../../../开发手册/SQL参考手册/SQL语句（yashan模式）/CREATE USER)语句创建用户，并按需为新用户指定密码、默认表空间（集）等属性。
...
- 用户配置文件管理：[CREATE PROFILE](../../../开发手册/SQL参考手册/SQL语句（yashan模式）/CREATE PROFILE)、[ALTER PROFILE](../../../开发手册/SQL参考手册/SQL语句（yashan模式）/ALTER PROFILE)、[DROP PROFILE](../../../开发手册/SQL参考手册/SQL语句（yashan模式）/DROP PROFILE)
...
2. 执行[ALTER USER](../../../开发手册/SQL参考手册/SQL语句（yashan模式）/ALTER USER)语句调整用户的属性信息，包括修改密码、默认表空间（集）等。
...
2. 执行[DROP USER](../../../开发手册/SQL参考手册/SQL语句（yashan模式）/DROP USER)语句删除目标用户。
