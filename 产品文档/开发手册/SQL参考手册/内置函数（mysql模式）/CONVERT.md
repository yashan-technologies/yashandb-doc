...
SELECT HEX(CONVERT('中国画' ,CHAR(9) ascii));

hex(convert('中国画' ,char(9) ascii))                            
---------------------------------------------------------------- 
3F3F3F202020202020                                              

SELECT HEX(CONVERT('中' USING gbk));

hex(convert('中' using gbk))  
----------------------------- 
D6D0                         

SELECT HEX(CONVERT('中国画' ,CHAR(9) CHARACTER SET gbk));

hex(convert('中国画' ,char(9) character set gbk))                
---------------------------------------------------------------- 
D6D0B9FABBAD202020202020                                        
