...
该语句用于指定要创建的视图的名称，不可省略，且需符合YashanDB的[对象命名规范](../基本SQL元素/标识符)。

### 5. alias

该语句用于指定视图列字段的别名，可省略，且需符合YashanDB的[对象命名规范](../基本SQL元素/标识符)，不可用于更改列字段的数据类型。
...
INSERT INTO v_area_check_option VALUES('02', '华西', 'Chengdu');
