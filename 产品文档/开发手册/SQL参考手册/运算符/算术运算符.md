...
| --- |----| --- | --- | --- | --- | --- |-----|----- |-----|-----|
| **数值型** | +  | （3） | （3） | \-- | DATE | DATE | DATE | DATE | \-- | \-- |
|                  | \- | （3）        | （3）        | \-- | \--   | \-- | \--          | \--           | \-- | \-- |
|                  | \* | （3）        | （3）        | \-- | \--   | \-- | \--              | \--           | YM  | DS  |
|                  | \/ | （3）        | （3）        | \-- | \--   | \-- | \--              | \--           | \-- | \-- |
| **字符型** | + | （3） | （3） | \-- | DATE | DATE | DATE | DATE | \-- | \-- |
|                  | \- | （3） | （3） | \-- |  \-- |  \-- |  \-- |  \-- | \-- | \-- | 
|                  | \*、/  | （3）        | （3）        | \-- | \--      | \-- | \--       | \--           | YM   |DS|
| **TIME** | + | \-- | \-- | \-- | TS | TS | \-- | TIME |
|                  | \-     | \--         | \--         | DS | \-- | \--  | \--              |TIME|
...
| 数据类型 | NUMBER | TIME | DS | YM | DATE | TS | LTZ | TZ |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| TIME | N/A | 支持运算：-<br>返回类型：DS | 支持运算：+-<br>返回类型：TIME | N/A | 支持运算：+<br>返回类型：TS | 支持运算：+<br>返回类型：TS | 支持运算：+<br>返回类型：LTZ | 支持运算：+<br>返回类型：TZ |
| DS | 支持运算：\*/ <br>返回类型：DS | 支持运算：+ <br>返回类型：TIME | 支持运算：+-<br>返回类型：DS | N/A | 支持运算：+<br>返回类型：DATE | 支持运算：+<br>返回类型：TS | 支持运算：+<br>返回类型：LTZ | 支持运算：+<br>返回类型：TZ |
| YM | 支持运算：\*/ <br>返回类型：YM | N/A | N/A | 支持运算：+-<br>返回类型：YM | 支持运算：+<br>返回类型：DATE | 支持运算：+<br>返回类型：TS | 支持运算：+<br>返回类型：LTZ | 支持运算：+<br>返回类型：TZ |
| DATE | 支持运算：+-<br>返回类型：DATE | 支持运算：+-<br>返回类型：TS | 支持运算：+-<br>返回类型：DATE | 支持运算：+-<br>返回类型：DATE | 支持运算：-<br>返回类型：NUMBER | 支持运算：-<br>返回类型：DS | 支持运算：-<br>返回类型：DS | 支持运算：-<br>返回类型：DS |
| TS | 支持运算：+-<br>返回类型：DATE | 支持运算：+-<br>返回类型：TS | 支持运算：+-<br>返回类型：TS | 支持运算：+-<br>返回类型：TS | 支持运算：-<br>返回类型：DS | 支持运算：-<br>返回类型：DS | 支持运算：-<br>返回类型：DS | 支持运算：-<br>返回类型：DS |
| LTZ | 支持运算：+-<br>返回类型：DATE | 支持运算：+-<br>返回类型：LTZ | 支持运算：+-<br>返回类型：LTZ | 支持运算：+-<br>返回类型：LTZ | 支持运算：-<br>返回类型：DS | 支持运算：-<br>返回类型：DS | 支持运算：-<br>返回类型：DS | 支持运算：-<br>返回类型：DS |
| TZ | 支持运算：+-<br>返回类型：DATE | 支持运算：+-<br>返回类型：TZ | 支持运算：+-<br>返回类型：TZ | 支持运算：+-<br>返回类型：TZ | 支持运算：-<br>返回类型：DS | 支持运算：-<br>返回类型：DS | 支持运算：-<br>返回类型：DS | 支持运算：-<br>返回类型：DS |
