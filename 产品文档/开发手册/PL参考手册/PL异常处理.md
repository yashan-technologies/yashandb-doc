...
其中，系统预定义的错误见参考手册[错误码](../../参考手册/错误码)文档说明。
...
#### DBMS\_DESCRIBE 自定义异常

| 错误码          | 错误内容                                                      | 解释                                     |
| :------------- | :------------------------------------------------------------ | :--------------------------------------- |
| YAS-30007      | cannot describe a non-existent procedure    | 指定的过程不存在，无法描述         |
| YAS-30008      | cannot describe an invalid procedure        | 指定的过程无效，无法描述           |
